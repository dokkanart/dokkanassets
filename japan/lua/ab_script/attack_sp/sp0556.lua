...
setEffScaleKey( spep_0 + 16, shuchusen1, 1.2, 1.7 );
setEffScaleKey( spep_0 + 148, shuchusen1, 1.2, 1.7 );
...
ctgogo = entryEffectLife( spep_0 + 64,  190006,72, 0x100, -1, 0, -8.5, 515.5 ); --ゴゴゴ
setEffShake( spep_0 + 64, ctgogo, 64, 10 );

setEffMoveKey( spep_0 + 64, ctgogo, -9.9, 521.8 , 0 );
...
setEffRotateKey( spep_0 + 64, ctgogo, 0 );
...
-- ** 雪山背景 ** --
haikei = entryEffect( spep_4 + 0, 153495, 0x80, -1, 0, 0, 0 );  --雪山背景
