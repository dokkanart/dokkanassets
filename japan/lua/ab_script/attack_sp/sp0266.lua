...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  0,  150);   -- 手のカメハメ波部
...
-- 書き文字エントリー
ct = entryEffectLife( 90, 10008, 39, 0x100, -1, 0, 140, 200);    -- ゴゴゴ・・・
...
kamehame_beam = entryEffect( 260, SP_02, 0x40,  0,  300, 120,  110);   -- 伸びるかめはめ波
playSe( 260, SE_07);
