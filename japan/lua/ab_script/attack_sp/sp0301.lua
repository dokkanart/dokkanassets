...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  0,  130);   -- 手のカメハメ波部
...
kamehame_beam = entryEffect( 260, SP_02, 0x40,  0,  300, 220, 110);   -- 伸びるかめはめ波
playSe( 260, SE_07);
setEffMoveKey(  287,  kamehame_beam,  200, 90);
setEffMoveKey(  292,  kamehame_beam,  200, 90);
setEffMoveKey(  303,  kamehame_beam,  100, 50);
