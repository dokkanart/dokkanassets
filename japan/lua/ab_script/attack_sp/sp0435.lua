...
entryFade( 61, 5, 5, 8, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
kame_hand = entryEffect( 70, SP_01, 0x100,   -1,  0,  20,  100);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);

entryFade( 163, 3, 3, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
aura2 = entryEffectLife(  70,   311, 99, 0x40,  0,  1,  0,  -100); -- オーラ
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  0,  320,  120);   -- 伸びるかめはめ波
...
shuchusen3 = entryEffectLife( 260, 906, 49, 0x00,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( 260, shuchusen3, 1.0, 1.0);
setEffScaleKey( 300, shuchusen3, 1.0, 1.0);
setEffScaleKey( 309, shuchusen3, 2.0, 2.0);
...
-- 書き文字エントリー
ct3 = entryEffectLife( 268, 10012, 32, 0, -1, 0, 200, 300); -- ズオッ
setEffShake(268, ct3, 32, 5);
setEffAlphaKey(268, ct3, 255);
setEffAlphaKey(290, ct3, 255);
setEffAlphaKey(300, ct3, 0);
setEffScaleKey(268, ct3, 0.0, 0.0);
setEffScaleKey(272, ct3, 1.3, 1.3);
setEffScaleKey(292, ct3, 1.3, 1.3);
setEffScaleKey(300, ct3, 6.0, 6.0);
playSe( 300, SE_07);
...
-- 書き文字エントリー
ct4 = entryEffectLife( 370, 10014, 99, 0, -1, 0, -100, 255); -- ズドドッ
setEffShake(370, ct4, 99, 20);
setEffScaleKey( 370, ct4, 2.4, 2.4);
setEffRotateKey(370, ct4, 70);
setEffAlphaKey(370, ct4, 255);
setEffAlphaKey(430, ct4, 255);
setEffAlphaKey(450, ct4, 0);
...
-- 書き文字エントリー
ct5 = entryEffectLife( 485, 10005, 100, 0, -1, 0, -50, 230); -- ガッ
setEffShake(485, ct5, 30, 10);
setEffRotateKey( 485, ct5, -40);
setEffScaleKey( 485, ct5, 4.0, 4.0);
setEffScaleKey( 486, ct5, 2.0, 2.0);
setEffScaleKey( 487, ct5, 2.6, 2.6);
setEffScaleKey( 488, ct5, 4.0, 4.0);
setEffScaleKey( 489, ct5, 2.6, 2.6);
setEffScaleKey( 490, ct5, 3.8, 3.8);
setEffScaleKey( 580, ct5, 3.8, 3.8);
setEffAlphaKey( 485, ct5, 255);
setEffAlphaKey( 575, ct5, 255);
setEffAlphaKey( 585, ct5, 0);

playSe( 473, SE_11);
shuchusen5 = entryEffectLife( 473, 906, 120, 0x00,  -1, 0,  0,  0);   -- 集中線
...
setEffShake(370, ct4, 99, 20);
setEffScaleKey( 370, ct4, 2.4, 2.4);
setEffRotateKey(370, ct4, 20);
setEffRotateKey(450, ct4, 20);
setEffAlphaKey(370, ct4, 255);
setEffAlphaKey(430, ct4, 255);
setEffAlphaKey(450, ct4, 0);
