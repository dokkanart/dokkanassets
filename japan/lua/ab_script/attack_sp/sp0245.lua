...
-- ** エフェクト等 ** --
aura = entryEffectLife(  30,   311, 39, 0x40,  0,  1,  0,  -150); -- オーラ
...
kame_hand = entryEffect( 70, SP_01, 0x40+0x100,      0,  300,  -50,  220);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);

entryFade( 165, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
aura = entryEffectLife(  70,   311, 99, 0x40,  0,  1,  0,  -150); -- オーラ
setEffScaleKey( 30, aura, 2.0, 2.0);
...
-- カメハメハ発射(110F)
------------------------------------------------------
setScaleKey(   259,   0, 1.0, 1.0); 	--追加
setScaleKey(   369,   0, 1.0, 1.0);	--追加

changeAnime( 259, 0, 31);                                    -- かめはめ発射ポーズ

setMoveKey(  259,    0,      0,  0,   0);
setMoveKey(  260,    0,   -100,  0,   0);
setMoveKey(  261,    0,   -100,  0,   0);
setMoveKey(  270,    0,   -250,  0,   0);

kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  380,  190);  
...
playSe( 455, SE_09);
-- 敵吹っ飛ぶモーション
changeAnime( 455-20, 1, 108);
setMoveKey(  455-20, 1,  120,    0,  0);
setMoveKey(  469-20, 1,  500,    0,  0);
setScaleKey( 455-20, 1,  1.6, 1.6);
setScaleKey( 458-20, 1,  1.5, 1.5);
setScaleKey( 468-20, 1,  0.2, 0.2);
...
entryFade( 455, 6,  14, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

setMoveKey(  469, 1,  550,    0,  0);
...
kame_hand = entryEffect( SP_ATK_0, SP_01, 0x40+0x100,      0,  300,  -50,  220);   -- 手のカメハメ波部
setEffScaleKey( SP_ATK_0, kame_hand, 0.5, 0.5);

-- ** エフェクト等 ** --
aura = entryEffectLife( SP_ATK_0,   311, 39, 0x40,  0,  1,  0,  0); -- オーラ
...
setScaleKey(   SP_ATK_1,   0, 1.5, 1.5); 	--追加
...
entryFade( SP_ATK_1+45, 3, 15, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- カメハメハ発射(110F)
------------------------------------------------------
setScaleKey(   SP_ATK_2-5,   0, 1.5, 1.5); 	--追加


setScaleKey(   SP_ATK_2-1,   0, 1.0, 1.0); 	--追加
setScaleKey(   SP_ATK_3-1,   0, 1.0, 1.0);	--追加
...
setMoveKey(  SP_ATK_2+5,    0,      -100,  0,   0);
setMoveKey(  SP_ATK_2+10,   0,   -100,  0,   0);

kamehame_beam = entryEffectLife( SP_ATK_2+1, SP_02, 90, 0x40,  0,  300,  550,  140);   -- 伸びるかめはめ波
...
setMoveKey(  SP_ATK_2+33,    0,   -1000,  0,   0);

setMoveKey(  SP_ATK_2+75,    0,   -1300,  0,   0);
setMoveKey(  SP_ATK_2+80,    0,   -1300,  0,   -50);

--entryFade( SP_ATK_2+5, 3, 2, 5, fcolor_r, fcolor_g, fcolor_b, 90);     -- white fade
...
entryFade( SP_ATK_3+25, 3, 2, 5, fcolor_r, fcolor_g, fcolor_b, 90);
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  30,   311, 39, 0x40,  0,  1,  -30,  -150); -- オーラ
setEffScaleKey( 30, aura, 2.0, 2.0);
setShakeChara( 30, 0, 19, 5);
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  70,   311, 99, 0x40,  0,  1,  -30,  -150); -- オーラ
setEffScaleKey( 30, aura, 2.0, 2.0);
setShakeChara( 70, 0, 49, 5);
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  550,  130);  
