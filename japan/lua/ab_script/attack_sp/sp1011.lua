...
--entryFlashBg( (SP_ATK01+35), 1, fcolor_r, 0, 0, 200);
...
--entryFlashBg( (SP_ATK01+50+diff01), 1,fcolor_r, 0, 0, 200);
...
--entryFlashBg( (SP_ATK01+72+diff01), 1, fcolor_r, 0, 0, 200);
...
--entryFlashBg( (SP_ATK01+80+diff01), 1, fcolor_r, 0, 0, 200);
...
setScaleKey( SP_ATK_2+49,0,1.8,1.8);
