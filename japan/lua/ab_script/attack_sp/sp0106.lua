...
-- 書き文字エントリー
--ct = entryEffectLife( 90, 10008, 39, 0x100, -1, 0, 190, 270);    -- ゴゴゴ・・・
ct = entryEffectLife( 80 + 16, 190006, 39, 0x100, -1, 0, 100.9, 515.5);    -- ゴゴゴ・・・
setEffShake( 16 + 80, ct, 64, 10 );

setEffMoveKey( 16 + 80, ct, 100.9, 515.5 , 0 );
setEffMoveKey( 80 + 80, ct, 100.9, 515.5 , 0 );
...
playSe( 170, SE_05);
speff = entryEffect( 170, 1120, 0, -1, 0, 0, 0); -- カード差し替え
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  0,  300);   -- 伸びるかめはめ波
setEffMoveKey(288,kamehame_beam,0,  155,  0);

setEffMoveKey(290,kamehame_beam,-168,  36,  0);
setEffMoveKey(370,kamehame_beam,50,  -250,  0);
--[[
