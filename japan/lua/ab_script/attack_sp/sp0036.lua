...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x100,  -1,  0,  -250,  100);   -- 伸びるかめはめ波
setEffMoveKey( 260,kamehame_beam,  -250,  100);
setEffMoveKey( 261,kamehame_beam,  -250,  100);
setEffMoveKey( 270,kamehame_beam,  150,  100);
setEffMoveKey( 300,kamehame_beam,  150,  100);
setEffMoveKey( 308,kamehame_beam,  -750,  100);
...
SP_dodge = 415; --エンドフェイズのフレーム数を置き換える
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x80,  -1,  0,  -250,  100);   -- 伸びるかめはめ波
setEffMoveKey( 260,kamehame_beam,  -250,  100);
setEffMoveKey( 261,kamehame_beam,  -250,  100);
setEffMoveKey( 270,kamehame_beam,  150,  100);
setEffMoveKey( 300,kamehame_beam,  150,  100);
