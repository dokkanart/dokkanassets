...
--setEffScaleKey( 170, speff, 0.9, 1.0);

entryFade( 255 -2, 3, 2+4, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
setMoveKey(  256,    0,    -600,  0,   0);
setMoveKey(  260,    0,   -600,  0,   0);
setMoveKey(  261,    0,   -600,  0,   0);
setMoveKey(  270,    0,   -100,  0,   0);

kamehame_beam = entryEffectLife( 257, SP_02, 109, 0x40,  0,  300,  90,  0);   -- 伸びるかめはめ波
...
--setEffMoveKey( 305,    kamehame_beam,   -165,  0);
--setEffMoveKey( 308,    kamehame_beam,   0,  0);

--setEffScaleKey( 308, kamehame_beam, 1.0, 1.0);
--setEffScaleKey( 305, kamehame_beam, 1.0, 1.5);
--setEffScaleKey( 308, kamehame_beam, 1.0, 1.0);
...
-- 途中からカメハメハが伸びる
setMoveKey(  290,    0,   -100,  0,   0);
setMoveKey(  300,    0,   -100,  0,   0);
setMoveKey(  305,    0,   -1100,  0,   0);
...
setEffMoveKey( SP_start+454,    kamehame_beam2,   250,  0);
...
--entryFade( SP_start+ 560, 9,  10, 1, 8, 8, 8, 255);             -- black fade
