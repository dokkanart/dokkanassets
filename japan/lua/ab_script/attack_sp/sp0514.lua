...
-- ** 黒背景 ** --
entryFadeBg( spep_0 , 0, 148, 0, 0, 0, 0, 255 );  --薄い黒　背景
...
-- ** エフェクト等 ** --
hanatsu = entryEffectLife( spep_2 + 0, SP_02, 200, 0x100, -1, 0, 0, 0 );  --放つ(ef_002)
setEffMoveKey( spep_2 + 0, hanatsu, 0, 0 , 0 );
setEffMoveKey( spep_2 + 200, hanatsu, 0, 0 , 0 );
setEffScaleKey( spep_2 + 0, hanatsu, 1.0, 1.0 );
setEffScaleKey( spep_2 + 200, hanatsu, 1.0, 1.0 );
setEffRotateKey( spep_2 + 0, hanatsu, 0 );
setEffRotateKey( spep_2 + 200, hanatsu, 0 );
setEffAlphaKey( spep_2 + 0, hanatsu, 255 );
setEffAlphaKey( spep_2 + 200, hanatsu, 255 );
...
-- ** 書き文字エントリー ** --
ctba = entryEffectLife( spep_2 + 16,  10022, 24, 0x100, -1, 0, -84.8, 382 );  --バッ
setEffShake( spep_2 + 26, ctba, 12, 20 );

setEffMoveKey( spep_2 + 16, ctba, -84.8, 382 , 0 );
setEffMoveKey( spep_2 + 18, ctba, -92.1, 386.6 , 0 );
setEffMoveKey( spep_2 + 20, ctba, -84.8, 382 , 0 );
setEffMoveKey( spep_2 + 22, ctba, -93, 387.1 , 0 );
setEffMoveKey( spep_2 + 24, ctba, -84.9, 382 , 0 );
setEffMoveKey( spep_2 + 26, ctba, -91.3, 386.6 , 0 );
setEffMoveKey( spep_2 + 38, ctba, -91.3, 386.6 , 0 );
setEffMoveKey( spep_2 + 40, ctba, -91.3, 386.6 , 0 );

setEffScaleKey( spep_2 + 16, ctba, 1.21, 1.21 );
setEffScaleKey( spep_2 + 18, ctba, 1.8, 1.8 );
setEffScaleKey( spep_2 + 20, ctba, 2.38, 2.38 );
setEffScaleKey( spep_2 + 22, ctba, 2.01, 2.01 );
setEffScaleKey( spep_2 + 24, ctba, 1.63, 1.63 );
setEffScaleKey( spep_2 + 26, ctba, 1.63, 1.63 );
setEffScaleKey( spep_2 + 28, ctba, 1.62, 1.62 );
setEffScaleKey( spep_2 + 34, ctba, 1.62, 1.62 );
setEffScaleKey( spep_2 + 36, ctba, 1.63, 1.63 );
setEffScaleKey( spep_2 + 40, ctba, 1.63, 1.63 );

setEffRotateKey( spep_2 + 16, ctba, -5.8 );
setEffRotateKey( spep_2 + 18, ctba, -9.5 );
setEffRotateKey( spep_2 + 20, ctba, -13.2 );
setEffRotateKey( spep_2 + 22, ctba, -9.5 );
setEffRotateKey( spep_2 + 24, ctba, -5.8 );
setEffRotateKey( spep_2 + 40, ctba, -5.8 );

setEffAlphaKey( spep_2 + 16, ctba, 255 );
setEffAlphaKey( spep_2 + 30, ctba, 255 );
setEffAlphaKey( spep_2 + 32, ctba, 204 );
setEffAlphaKey( spep_2 + 34, ctba, 153 );
setEffAlphaKey( spep_2 + 36, ctba, 102 );
setEffAlphaKey( spep_2 + 38, ctba, 51 );
setEffAlphaKey( spep_2 + 40, ctba, 0 );

ctzuo = entryEffectLife( spep_2 + 128,  10012, 64, 0x100, -1, 0, 9.7, 282.4 );  --ズオッ
setEffShake( spep_2 + 128, ctzuo, 64, 20 );

setEffMoveKey( spep_2 + 128, ctzuo, 9.7, 282.4 , 0 );
setEffMoveKey( spep_2 + 130, ctzuo, 33, 331.8 , 0 );
setEffMoveKey( spep_2 + 132, ctzuo, 36.6, 393.3 , 0 );
setEffMoveKey( spep_2 + 134, ctzuo, 52.6, 377.3 , 0 );
setEffMoveKey( spep_2 + 182, ctzuo, 52.6, 377.3 , 0 );
setEffMoveKey( spep_2 + 184, ctzuo, 50.8, 397.2 , 0 );
setEffMoveKey( spep_2 + 186, ctzuo, 90.5, 375.7 , 0 );
setEffMoveKey( spep_2 + 188, ctzuo, 79.1, 405.2 , 0 );
setEffMoveKey( spep_2 + 190, ctzuo, 128.3, 373.9 , 0 );
setEffMoveKey( spep_2 + 192, ctzuo, 147.3, 373.1 , 0 );

setEffScaleKey( spep_2 + 128, ctzuo, 0.34, 0.34 );
setEffScaleKey( spep_2 + 130, ctzuo, 1.54, 1.54 );
setEffScaleKey( spep_2 + 132, ctzuo, 2.73, 2.73 );
setEffScaleKey( spep_2 + 182, ctzuo, 2.73, 2.73 );
setEffScaleKey( spep_2 + 184, ctzuo, 3.55, 3.55 );
setEffScaleKey( spep_2 + 186, ctzuo, 4.37, 4.37 );
setEffScaleKey( spep_2 + 188, ctzuo, 5.19, 5.19 );
setEffScaleKey( spep_2 + 190, ctzuo, 6.01, 6.01 );
setEffScaleKey( spep_2 + 192, ctzuo, 6.82, 6.82 );

setEffRotateKey( spep_2 + 128, ctzuo, 9.6 );
setEffRotateKey( spep_2 + 130, ctzuo, 18.3 );
setEffRotateKey( spep_2 + 132, ctzuo, 27.2 );
setEffRotateKey( spep_2 + 192, ctzuo, 27.2 );

setEffAlphaKey( spep_2 + 128, ctzuo, 255 );
setEffAlphaKey( spep_2 + 182, ctzuo, 255 );
setEffAlphaKey( spep_2 + 184, ctzuo, 204 );
setEffAlphaKey( spep_2 + 186, ctzuo, 153 );
setEffAlphaKey( spep_2 + 188, ctzuo, 102 );
setEffAlphaKey( spep_2 + 190, ctzuo, 51 );
setEffAlphaKey( spep_2 + 192, ctzuo, 0 );

-- ** 黒背景 ** --
entryFadeBg( spep_2 + 0, 0, 200, 0, 0, 0, 0, 180 );  --薄い黒　背景

-- ** ホワイトフェード ** --
entryFade( spep_2 + 0, 0, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  -- white fade
entryFade( spep_2 + 16, 0, 2, 4, fcolor_r, fcolor_g, fcolor_b, 180 );  -- 薄いwhite fade
entryFade( spep_2 + 126, 0, 2, 4, fcolor_r, fcolor_g, fcolor_b, 200 );  -- 薄いwhite fade
entryFade( spep_2 + 194, 6, 2, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  -- white fade

-- ** 音 ** --
playSe( spep_2 + 16, 1013 );  --バッ
playSe(  spep_2+62,  8);  --風の音
playSe( spep_2 + 120, SE_07 );  --ズオッ
...
-- ** エフェクト等 ** --
hanatsu = entryEffectLife( spep_2 + 0, SP_02r, 200, 0x100, -1, 0, 0, 0 );  --放つ(ef_002)
setEffMoveKey( spep_2 + 0, hanatsu, 0, 0 , 0 );
setEffMoveKey( spep_2 + 200, hanatsu, 0, 0 , 0 );
setEffScaleKey( spep_2 + 0, hanatsu, 1.0, 1.0 );
setEffScaleKey( spep_2 + 200, hanatsu, 1.0, 1.0 );
