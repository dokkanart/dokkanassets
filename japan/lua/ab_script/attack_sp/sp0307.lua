...
--setEffAlphaKey( SP_ATK_1, eff01, 255);
--setEffAlphaKey( SP_ATK_1+30, eff01, 0);

--setEffAlphaKey( SP_ATK_0, eff02, 255);
--setEffAlphaKey( SP_ATK_1, eff02, 255);
--setEffAlphaKey( SP_ATK_1+30, eff02, 0);
...
-- ** エフェクト等 ** --
entryFadeBg( SP_ATK_2, 0, 140, 0, 10, 10, 10, 180);       -- ベース暗め　背景
entryFadeBg( SP_ATK_2, 0, 40, 0, 230, 230, 230, 255);    -- 最初だけ明るい　背景
entryFadeBg( SP_ATK_2+40, 0, 2, 8, 52, 140, 250, 250);     -- 青い　背景
...
--entryFadeBg( SP_ATK_3, 0, 50, 0, 10, 10, 10, 180);       -- ベース暗め　背景
