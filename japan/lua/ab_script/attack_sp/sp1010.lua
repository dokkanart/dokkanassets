...
setEffRotateKey(SP_ATK01+35, eff01,-85);--角度
...
setEffRotateKey(SP_ATK01+50+diff01, eff02,60);--角度
--entryFlashBg( (SP_ATK01+50+diff01), 1, fcolor_r, fcolor_g, fcolor_b, 200);
playSe( SP_ATK01+50+diff01, SE_09);
...
setEffRotateKey(SP_ATK01+57+diff01, eff03, -110);--角度
...
setEffRotateKey(SP_ATK01+65+diff01, eff04, 88);--角度
playSe( SP_ATK01+65+diff01, SE_09);
...
setEffRotateKey(SP_ATK01+72+diff01, eff05, -75);--角度
...
setEffRotateKey(SP_ATK01+76+diff01, eff06, 145);--角度
playSe( SP_ATK01+76+diff01, SE_09);
...
playSe( SP_ATK01+80+diff01, SE_09);
...
pauseAll(SP_ATK01+92+diff01+diff02,10);
...
stopSe(SP_dodge - 14, SE0);
stopSe(SP_dodge - 14, SE1);
...
eff08 = entryEffect( SP_ATK01+91+diff01+diff02, SP_04,  0, -1,  0,  0,  0);   -- 攻撃3
setEffScaleKey( SP_ATK01+91+diff01+diff02, eff08, 0.5,4);--サイズ
setEffRotateKey(SP_ATK01+91+diff01+diff02, eff08, -105);--角度
playSe( SP_ATK01+91+diff01+diff02, SE_09);
setShake( SP_ATK01+91+diff01+diff02, 3, 14);
entryFadeBg( SP_ATK01+92+diff01+diff02, 0, 35, 0, 0, 0, 0, 255);          -- ベース暗め　背景
...
SP_dodge = 205; --エンドフェイズのフレーム数を置き換える
