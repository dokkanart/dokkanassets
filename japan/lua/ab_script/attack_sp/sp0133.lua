...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  30,  0);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);

--entryFade( 165, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
aura = entryEffectLife(  70,   311, 99, 0x40,  0,  0,  -30,  -150); -- オーラ
setEffScaleKey( 30, aura, 1.5, 1.5);
...
spep_x = 80;
-- ** 書き文字エントリー ** --
ctgogo = entryEffectLife( spep_x + 16,  190006, 68, 0x100, -1, 0, 40.9, 530.5 ); --ゴゴゴ
setEffShake( spep_x + 16, ctgogo, 68, 10 );

setEffMoveKey( spep_x + 16, ctgogo, 40.9, 530.5 , 0 );
setEffMoveKey( spep_x + 84, ctgogo, 40.9, 530.5 , 0 );
...
shuchusenkuro = entryEffectLife( 473, 1657, 120, 0x80,  -1, 0,  0,  0);   -- 集中線黒
