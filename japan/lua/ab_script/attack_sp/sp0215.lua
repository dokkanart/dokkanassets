...
kame_hand = entryEffect( SP_start+ 70, SP_01, 0x40+0x100,      0,  300,  -18,  250);   -- 手のカメハメ波部
setEffScaleKey( SP_start+ 70, kame_hand, 0.5, 0.5);

shuchusen = entryEffectLife( SP_start+ 70, 906, 100, 0x00,  -1, 0,  0,  0);   -- 集中線
...
setEffScaleKey( SP_start+ 30, aura, 1.8, 1.8);
...
kamehame_beam = entryEffectLife( SP_start+ 260, SP_02, 109, 0x40,  0,  300,  450,  100);   -- 伸びるかめはめ波
...
setEffScaleKey( SP_start+454-20, kamehame_beam2, 2.5, 2.5);
setDamage( SP_start+ 452-20, 1, 0);  -- ダメージ振動等


playSe( SP_start+ 455-20, SE_09);
-- 敵吹っ飛ぶモーション
changeAnime( SP_start+ 455-22, 1, 108);
setMoveKey( SP_start+  455-22, 1,  120,    0,  0);
setMoveKey( SP_start+  469-22, 1,  400,    0,  0);
setScaleKey( SP_start+ 455-22, 1,  1.6, 1.6);
setScaleKey( SP_start+ 458-22, 1,  1.5, 1.5);
setScaleKey( SP_start+ 468-22, 1,  0.2, 0.2);
...
setEffAlphaKey( SP_start+430-22, ct, 255);
setEffAlphaKey( SP_start+450-22, ct, 0);
...
kame_hand = entryEffect( SP_start+ 70, SP_01, 0x40+0x100,      0,  300,  -13,  250);   -- 手のカメハメ波部
setEffScaleKey( SP_start+ 70, kame_hand, 0.5, 0.5);
