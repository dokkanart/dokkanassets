...
setMoveKey(   1,   0,    -149.4, 0,   0);
setMoveKey(   2,   0,    -148.8, 0,   0);
setMoveKey(   3,   0,    -148.2, 0,   0);
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  0,   311, 117, 0x40+0x100,  0,  300,  0,  0); -- オーラ
setEffMoveKey(   0,   aura,    40,  -150,   0);
setEffMoveKey(  117,   aura,    40,  -300,  0);
setEffScaleKey( 0, aura, 1, 1);
--setEffScaleKey( 40, aura, 1, 1);
setEffScaleKey( 117, aura, 1.5, 1.5);

kame_hand = entryEffect( 0, SP_01, 0x40+0x100, 0,  300,  0,  0);   -- 手のカメハメ波部 50end
...
SE02 = playSe( spep_4+48, 1024);

entryFade( spep_4+91, 5, 11, 6, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
explosion=entryEffect( spep_5, SP_04, 0,  -1,  0,  0,  0);  
