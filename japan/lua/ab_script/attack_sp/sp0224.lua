...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  -110,  -80);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 1, 1);
kame_hand2 = entryEffect( 70, SP_02, 0x40,      0,  300,  120,  90);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand2, 1, 1);

entryFade( 165, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
aura = entryEffectLife(  70,   311, 99, 0x40,  0,  1,  0,  -100); -- オーラ
setEffScaleKey( 30, aura, 1, 1);
...
kamehame_beam = entryEffectLife( 260, SP_03, 109, 0x40,  0,  300,  0,  0);   -- 伸びるかめはめ波
...
kamehame_beam2 = entryEffect( 370, SP_04,   0, -1,  0,  30,  0);   -- 迫るかめはめ波
setEffScaleKey(370, kamehame_beam2, 1, 1);
setEffScaleKey(452-SP_TM, kamehame_beam2, 1, 1);
setEffScaleKey(454-SP_TM, kamehame_beam2, 2.5, 2.5);
setDamage( 452-SP_TM, 1, 0);  -- ダメージ振動等
...
playSe( 455-SP_TM, SE_09);
-- 敵吹っ飛ぶモーション
changeAnime( 455-SP_TM, 1, 108);
setMoveKey(  455-SP_TM, 1,  120,    0,  0);
setMoveKey(  469-SP_TM, 1,  400,    0,  0);
setScaleKey( 455-SP_TM, 1,  1.6, 1.6);
setScaleKey( 458-SP_TM, 1,  1.5, 1.5);
setScaleKey( 468-SP_TM, 1,  0.2, 0.2);

-- ** エフェクト等 ** --
setShakeChara( 370, 1, 99, 20);

entryFadeBg( 370, 0, 99-25, 0, 10, 10, 10, 150);          -- ベース暗め　背景

entryEffectLife( 370, 921, 99-25, 0x80,  -1,  0,  0,  0); -- 流線斜め
...
setEffAlphaKey(430-SP_TM, ct, 255);
setEffAlphaKey(450-SP_TM, ct, 0);

entryFade( 462-SP_TM, 6,  7, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- 爆発 (110F)
------------------------------------------------------
setDisp( 469-SP_TM, 1, 1);
setMoveKey(  469-SP_TM,    1,  100,  0,   0);
setScaleKey( 469-SP_TM,    1,  1.0, 1.0);
setMoveKey(  470-SP_TM,    1,    0,   0,   128);
setScaleKey( 470-SP_TM,    1,  0.1, 0.1);

changeAnime( 470-SP_TM, 1, 107);                         -- 手前ダメージ
entryEffect( 478-SP_TM, 1509,  0x80,  -1,  0,  0,  0);   -- 爆発
playSe( 478-SP_TM, SE_10);

setMoveKey(  478-SP_TM,   1,    0,   0,   128);
setMoveKey(  485-SP_TM,   1,  -60,  -200,  -100);
--setMoveKey(  486,   1,  -60,  -200,  -100);
setDamage( 486-SP_TM, 1, 0);  -- ダメージ振動等
setShake(477-SP_TM,6,15);
setShake(483-SP_TM,15,10);

setRotateKey( 470-SP_TM,  1,  30 );
setRotateKey( 472-SP_TM,  1,  80 );
setRotateKey( 474-SP_TM,  1, 120 );
setRotateKey( 476-SP_TM,  1, 160 );
setRotateKey( 478-SP_TM,  1, 200 );
setRotateKey( 480-SP_TM,  1, 260 );
setRotateKey( 482-SP_TM,  1, 320 );
setRotateKey( 484-SP_TM,  1,   0 );

setShakeChara( 485-SP_TM, 1, 5,  10);
setShakeChara( 490-SP_TM, 1, 10, 20);

-- 書き文字エントリー
ct = entryEffectLife( 485-SP_TM, 10005, 100, 0, -1, 0, -50, 230); -- ガッ
setEffShake(485-SP_TM, ct, 30, 10);
setEffRotateKey( 485-SP_TM, ct, -40);
setEffScaleKey( 485-SP_TM, ct, 4.0, 4.0);
setEffScaleKey( 486-SP_TM, ct, 2.0, 2.0);
setEffScaleKey( 487-SP_TM, ct, 2.6, 2.6);
setEffScaleKey( 488-SP_TM, ct, 4.0, 4.0);
setEffScaleKey( 489-SP_TM, ct, 2.6, 2.6);
setEffScaleKey( 490-SP_TM, ct, 3.8, 3.8);
setEffScaleKey( 580-SP_TM, ct, 3.8, 3.8);
setEffAlphaKey( 485-SP_TM, ct, 255);
setEffAlphaKey( 575-SP_TM, ct, 255);
setEffAlphaKey( 585-SP_TM, ct, 0);

playSe( 473-SP_TM, SE_11);
shuchusen = entryEffectLife( 473-SP_TM, 906, 120, 0x00,  -1, 0,  0,  0);   -- 集中線
entryEffect( 473-SP_TM, 1600,  0x00,  -1,  0,30, -130);   -- ひび割れ

-- ダメージ表示
dealDamage(486-SP_TM);

--entryFade( 570-SP_TM, 9,  10, 1, 8, 8, 8, 255);             -- black fade
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  70,   311, 99, 0x40,  0,  1,  0,  -80); -- オーラ
setEffScaleKey( 30, aura, 1, 1);
setShakeChara( 70, 0, 49, 5);
