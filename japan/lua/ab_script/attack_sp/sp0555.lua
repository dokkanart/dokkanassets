--超サイヤ人孫悟飯(青年期)＆超サイヤ人孫悟天(幼年期)_親子三大かめはめ波(敵側)
...
-- ** ボイス ** --
--波ぁー！！
playSe( spep_0 + 58, 1100 );
setSeVolume( spep_0 + 58, 1100, 250 );
...
-- ** ボイス ** --
--おめえたちが持ってる
playSe( spep_1 + 14, 1101 );
setSeVolume( spep_1 + 14, 1101, 250 );

--かめはめ
playSe( spep_1 + 194, 1102 );
setSeVolume( spep_1 + 194, 1102, 250 );

--波ぁー！！！
SE_ha = playSe( spep_1 + 272, 1103 );
setSeVolume( spep_1 + 272, 1103, 250 );
...
-- ** エフェクト等 ** --
kamehame = entryEffectLife( spep_0 + 0, SP_01r, 148, 0x100, -1, 0, 0, 0 );  --溜め〜発射(ef_001)
setEffMoveKey( spep_0 + 0, kamehame, 0, 0 , 0 );
setEffMoveKey( spep_0 + 148, kamehame, 0, 0 , 0 );
setEffScaleKey( spep_0 + 0, kamehame, -1.0, 1.0 );
setEffScaleKey( spep_0 + 148, kamehame, -1.0, 1.0 );
...
-- ** エフェクト等 ** --
hanatsu = entryEffectLife( spep_1 + 0, SP_02r, 444, 0x100, -1, 0, 0, 0 );  --放つ(ef_002)
setEffMoveKey( spep_1 + 0, hanatsu, 0, 0 , 0 );
setEffMoveKey( spep_1 + 444, hanatsu, 0, 0 , 0 );
setEffScaleKey( spep_1 + 0, hanatsu, -1.0, 1.0 );
setEffScaleKey( spep_1 + 444, hanatsu, -1.0, 1.0 );
...
playSe( spep_1 + 40, 43 );  --瞬間移動
playSe( spep_1 + 104, 1035 );  --気溜め
SE2 = playSe( spep_1 + 194, 17 );  --溜め
stopSe( spep_1+ 260, SE2, 10 );
SE3 = playSe( spep_1 + 272, 1022 );  --発射
