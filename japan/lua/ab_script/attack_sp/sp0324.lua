...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  120,  60);   -- 手のカメハメ波部
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  230,  180);   -- 伸びるかめはめ波
...
kame_hand = entryEffectLife( SP_ATK_0+2, SP_01, 70, 0x40, 0,  300,  100,  60);   -- 手のカメハメ波部
...
kamehame_beam_st = entryEffectLife( SP_ATK_2+2, SP_02, 4, 0x40,  0,  300,  50,  100);   -- 

kamehame_beam = entryEffectLife( SP_ATK_2+2, SP_02, 90, 0x40,  0,  300,  120,  120);   -- 伸びるかめはめ波
