...
SP_01e = 150290;--ef_101
SP_02e = 150291;--ef_102
--SP_teki = 150305;--ef_103 
SP_05e = 150292;--ef_105 
...
--kamae = entryEffect(  spep_1+4,   SP_03e,   0,  -1,  0,  0,  0);   -- 
...
aurakamae = entryEffect(  spep_3,   SP_02,   0,  -1,  0,  0,  0);   -- 
setEffScaleKey( spep_3, aurakamae, 1.0, 1.0);
...
gyan=entryEffectLife(  spep_6,  190001,  60, 0,  -1,  0,  0,  0);   
...
shuchusenkakyuu9 = entryEffectLife( spep_9, 906, 110, 0x100,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( spep_9, shuchusenkakyuu9, 1.5, 1.5);
setEffAlphaKey( spep_9, shuchusenkakyuu9, 255);
...
aurakamae = entryEffect(  spep_3,   SP_02e,   0,  -1,  0,  0,  0);   -- 
setEffScaleKey( spep_3, aurakamae, 1.0, 1.0);
setEffAlphaKey( spep_3, aurakamae, 255);
...
hassya = entryEffect(  spep_4,   150305,   0,  -1,  0,  0,  0);   -- 
--hassya = entryEffect(  spep_4,   SP_03,   0,  -1,  0,  0,  0);   -- 
setEffScaleKey( spep_4, hassya, 1.0, 1.0);
setEffAlphaKey( spep_4, hassya, 255);
playSe( spep_4+0, SE_06);
...
crater = entryEffect(  spep_9-5,   SP_05e,   0,  -1,  0,  0,  0);   -- 
setEffScaleKey( spep_9-5, crater, 1.0, 1.0);
setEffAlphaKey( spep_9-5, crater, 255);
