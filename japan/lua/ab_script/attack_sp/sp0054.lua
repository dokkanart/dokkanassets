...
entryFade( 155, 3, 13, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
kamehame_beam = entryEffectLife( 257, SP_02, 109, 0x40,  0,  300,  0,  100);   -- 伸びるかめはめ波
...
entryFade( SP_ATK_1, 3, 6, 4, fcolor_r, fcolor_g, fcolor_b, 90);     -- white fade
...
kamehame_beam = entryEffectLife( SP_ATK_2+1, SP_02, 90, 0x40,  0,  300,  0,  100);   -- 伸びるかめはめ波
