...
entryEffect(  30,   1500,   0,    -1,  0,  0,  0);    -- eff_001ライフは使用しない
entryEffectLife(  30,  1501, 38,  0x80, -1,  0,  0,  0);    -- eff_002ライフで対応
playSe( 30, SE_01);

entryFade( 62, 2, 6, 2, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade
...
entryFade( 164, 2, 6, 2, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade
...
------------------------------------------------------
playSe( 265, SE_06);
entryFade( 254, 2, 8, 2, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  100,  0);   -- 伸びるかめはめ波
...
entryFade( 365, 2, 6, 2, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
