...
-- ** エフェクト等 ** --
aura = entryEffectLife(  0,   358, 69, 0x40+0x80,  0,  1,  0,  0); -- オーラ
setEffScaleKey( 0, aura, 1.9, 1.9);
setEffMoveKey(  0,    aura,   0,  -194,   0);
setEffMoveKey(  30,    aura,   0,  -194,   0);
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  70,   358, 99, 0x40+0x80,  0,  1,  0,  0); -- オーラ
setEffScaleKey( 70, aura, 1.9, 1.9);
setEffMoveKey(  70,    aura,   0,  -60,   0);
...
aura = entryEffectLife(  260,   358, 99, 0x40+0x80,  0,  1,  0,  -100); -- オーラ
setEffScaleKey( 260, aura, 4.0, 4.0);
...
-- ** エフェクト等 ** --
aura = entryEffectLife(5,   358, 39, 0x40+0x80,  0,  1,  0,  0); -- オーラ
setEffScaleKey(5, aura, 1.9, 1.9);
...
kame_hand = entryEffect( 10, SP_01, 0x40,   0,  300,  0,  0);   -- 手のカメハメ波部
--setEffScaleKey( tyo+71, kame_hand, 0.5, 0.5);
--entryFade( tyo+165, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
aura = entryEffectLife( tyo+70,   358, 99, 0x40+0x80,  0,  1,  0,  0); -- オーラ
setEffScaleKey( tyo+30, aura, 1.9, 1.9);
...
aura = entryEffectLife(  tyo2+260,   358, 99, 0x40+0x80,  0,  1,  0,  -100); -- オーラ
setEffScaleKey( tyo2+260, aura, 4.0, 4.0);
...
setMoveKey(tyo2+305,    0,   -550,  0,   80);
--setMoveKey(tyo2+308,    0,   -1100,  0,   0);
