...
setScaleKey( SP_ATK_3-1,   0, 2.0, 2.0);
setScaleKey( SP_ATK_3,   0, 1.5, 1.5);
setScaleKey( SP_ATK_3+10,   0, 1.5, 1.5);

--changeAnime( SP_ATK_3, 0, 3);
setScaleKey( SP_ATK_3+11,   0, 0.5, 0.5);
setScaleKey( SP_ATK_3+49,   0, 0.5, 0.5);
...
setScaleKey( SP_ATK_3+40,   1,   1.6,  1.6);
changeAnime( SP_ATK_3, 1, 104);      
changeAnime( SP_ATK_3+11, 1, 106);			-- ダメージ


setMoveKey(  SP_ATK_3-1,    1,  235,  0,   0);
setMoveKey(  SP_ATK_3,    1,  700,  0,   0);
setMoveKey(  SP_ATK_3+6,    1,  150,  0,   0);
setMoveKey(  SP_ATK_3+40,    1,   160,  0,   0);

setScaleKey( SP_ATK_3+44, 1,  1.6, 1.6);
setScaleKey( SP_ATK_3+50, 1,  0.1, 0.1);
changeAnime( SP_ATK_3+38, 1, 108);

setMoveKey(  SP_ATK_3+44, 1,  280,    0,  0);
setMoveKey(  SP_ATK_3+55, 1,  700,    -150,  120);
...
--殴りエフェクト
hassyuken = entryEffectLife( SP_ATK_3+11, SP_01, 26, 0x40,  0,  0,  0,  0);   -- 伸びるかめはめ波
setEffScaleKey( SP_ATK_3+11, hassyuken, 0.5, 0.5);

entryEffect( SP_ATK_3+34,  3,  0,  -1,  0,  150, 0);--HIT
entryEffect( SP_ATK_3+34,  906,  0,  -1,  0,  150, 0);
entryEffect(  SP_ATK_3+34,  908,  0,  -1,  0,  150,  0);

playSe( SP_ATK_3+12, SE_13);
playSe( SP_ATK_3+16, SE_13);
playSe( SP_ATK_3+21, SE_13);
playSe( SP_ATK_3+26, SE_13);
playSe( SP_ATK_3+34, SE_09);

setDamage( SP_ATK_3+16,  1,  0);--ダメージ振動等
setDamage( SP_ATK_3+21,  1,  0);--ダメージ振動等
setDamage( SP_ATK_3+26,  1,  0);--ダメージ振動等
setDamage( SP_ATK_3+34,  1,  0);--ダメージ振動等
...
entryEffectLife( SP_ATK_3+45, 906, 35, 0x00,  -1, 0,  0,  0);   -- 集中線
--entryEffectLife( SP_ATK_3+40, 920, 35, 0x80,  -1,  0,  0,  0); -- 流線
entryFade( SP_ATK_3+45, 4,  5, 1, 255, 255, 255, 255);     -- white fade
...
setMoveKey(  SP_ATK_4, 1,  700,    -150,  120);
...
--殴りエフェクト
hassyuken = entryEffectLife( SP_ATK_3+11, SP_01, 26, 0x40+0x80,  0,  0,  0,  0);   -- 伸びるかめはめ波
setEffScaleKey( SP_ATK_3+11, hassyuken, 0.5, 0.5);
...
-- 書き文字エントリー
ct = entryEffectLife( SP_ATK_3, 10014, 99, 0, -1, 0, -180, 355); -- ズドドッ
setEffShake(SP_ATK_3, ct, 99, 20);
setEffScaleKey( SP_ATK_3, ct, 2.4, 2.4);
setEffRotateKey(SP_ATK_3, ct, -70);
setEffAlphaKey(SP_ATK_3, ct, 255);
...
SP_dodge = 160; --エンドフェイズのフレーム数を置き換える
