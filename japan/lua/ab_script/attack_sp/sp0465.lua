...
setMoveKey( spep_1 + 40, 1, -2037.6, 140.1 , 0 );
setMoveKey( spep_1 + 42, 1, -1895.5, 131.2 , 0 );
setMoveKey( spep_1 + 44, 1, -1742.8, 121.6 , 0 );
setMoveKey( spep_1 + 46, 1, -1579.4, 111.3 , 0 );
setMoveKey( spep_1 + 48, 1, -1405.3, 100.4 , 0 );
setMoveKey( spep_1 + 50, 1, -1220.6, 88.7 , 0 );
setMoveKey( spep_1 + 52, 1, -1025.2, 76.5 , 0 );
setMoveKey( spep_1 + 54, 1, -819.1, 63.5 , 0 );
setMoveKey( spep_1 + 56, 1, -602.3, 49.9 , 0 );
setMoveKey( spep_1 + 58, 1, -374.9, 35.6 , 0 );
setMoveKey( spep_1 + 60, 1, -136.7, 20.7 , 0 );
setMoveKey( spep_1 + 62, 1, 112.1, 5 , 0 );
setMoveKey( spep_1 + 64, 1, 123.5, 5.6 , 0 );
setMoveKey( spep_1 + 66, 1, 134.8, 6.2 , 0 );
setMoveKey( spep_1 + 68, 1, 145.9, 6.7 , 0 );
setMoveKey( spep_1 + 70, 1, 157, 7.2 , 0 );
setMoveKey( spep_1 + 72, 1, 167.9, 7.8 , 0 );
setMoveKey( spep_1 + 74, 1, 178.8, 8.3 , 0 );
setMoveKey( spep_1 + 76, 1, 189.5, 8.8 , 0 );
setMoveKey( spep_1 + 78, 1, 200.1, 9.4 , 0 );
setMoveKey( spep_1 + 80, 1, 210.5, 9.9 , 0 );
setMoveKey( spep_1 + 82, 1, 220.9, 10.4 , 0 );
setMoveKey( spep_1 + 84, 1, 231.1, 10.9 , 0 );
setMoveKey( spep_1 + 86, 1, 241.3, 11.4 , 0 );
setMoveKey( spep_1 + 88, 1, 251.3, 11.9 , 0 );
setMoveKey( spep_1 + 90, 1, 261.2, 12.4 , 0 );
setMoveKey( spep_1 + 92, 1, 271, 12.9 , 0 );
setMoveKey( spep_1 + 94, 1, 280.6, 13.3 , 0 );
setMoveKey( spep_1 + 96, 1, 290.2, 13.8 , 0 );
setMoveKey( spep_1 + 98, 1, 299.6, 14.3 , 0 );
...
setScaleKey( spep_1 + 40, 1, 9.83, 9.83 );
setScaleKey( spep_1 + 42, 1, 9.27, 9.27 );
setScaleKey( spep_1 + 44, 1, 8.67, 8.67 );
setScaleKey( spep_1 + 46, 1, 8.03, 8.03 );
setScaleKey( spep_1 + 48, 1, 7.35, 7.35 );
setScaleKey( spep_1 + 50, 1, 6.62, 6.62 );
setScaleKey( spep_1 + 52, 1, 5.85, 5.85 );
setScaleKey( spep_1 + 54, 1, 5.05, 5.05 );
setScaleKey( spep_1 + 56, 1, 4.19, 4.19 );
setScaleKey( spep_1 + 58, 1, 3.3, 3.3 );
setScaleKey( spep_1 + 60, 1, 2.37, 2.37 );
setScaleKey( spep_1 + 62, 1, 1.39, 1.39 );
setScaleKey( spep_1 + 64, 1, 1.35, 1.35 );
setScaleKey( spep_1 + 66, 1, 1.3, 1.3 );
setScaleKey( spep_1 + 68, 1, 1.26, 1.26 );
setScaleKey( spep_1 + 70, 1, 1.22, 1.22 );
setScaleKey( spep_1 + 72, 1, 1.18, 1.18 );
setScaleKey( spep_1 + 74, 1, 1.13, 1.13 );
setScaleKey( spep_1 + 76, 1, 1.09, 1.09 );
setScaleKey( spep_1 + 78, 1, 1.05, 1.05 );
setScaleKey( spep_1 + 80, 1, 1.01, 1.01 );
setScaleKey( spep_1 + 82, 1, 0.97, 0.97 );
setScaleKey( spep_1 + 84, 1, 0.93, 0.93 );
setScaleKey( spep_1 + 86, 1, 0.89, 0.89 );
setScaleKey( spep_1 + 88, 1, 0.86, 0.86 );
setScaleKey( spep_1 + 90, 1, 0.82, 0.82 );
setScaleKey( spep_1 + 92, 1, 0.78, 0.78 );
setScaleKey( spep_1 + 94, 1, 0.74, 0.74 );
setScaleKey( spep_1 + 96, 1, 0.71, 0.71 );
setScaleKey( spep_1 + 98, 1, 0.67, 0.67 );
