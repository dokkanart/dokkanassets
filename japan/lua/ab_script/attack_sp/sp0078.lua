...
-- 書き文字エントリー
ct = entryEffectLife( 90, 190006,78, 0x100, -1, 0 , 0+100, 500);    -- ゴゴゴ・・・
setEffShake(90, ct, 78, 8);
setEffScaleKey(90, ct,0.8,0.8);

entryFade(160,6,4,6,255,255,255,255);--追加2018/5/17
------------------------------------------------------
-- カードカットイン(90F)
------------------------------------------------------
...
entryFade(252,6,4,6,255,255,255,255);--追加2018/5/17
------------------------------------------------------
-- カメハメハ発射(110F)
------------------------------------------------------
...
SP_dodge=387; --エンドフェイズのフレーム数を置き換える
...
-- 書き文字エントリー
ct = entryEffectLife( 90, 190006,78, 0x100, -1, 0, 0, 500);    -- ゴゴゴ・・・
setEffShake(90, ct, 78, 8);
setEffScaleKey(90, ct,-0.8,0.8);
