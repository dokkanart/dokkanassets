...
setEffMoveKey(450, kamehame_beam2, 0, 0,0);
setEffMoveKey(454, kamehame_beam2, -30, 0,0);
...
--entryFlash( (460), 1, fcolor_r, fcolor_g, fcolor_b, 200);
...
entryFade( 462, 6,  7, 4, fcolor_r, 0, 0, 255);     -- white fade
...
setMoveKey(  SP_ATK_3+25+5, 1,  120,    0,  0);
...
--entryFlash( (SP_ATK_3+30), 1, fcolor_r, fcolor_g, fcolor_b, 200);
...
playSe( SP_ATK_3+20+5, SE_09);



entryFade( SP_ATK_3+20+5, 6,  7, 4, fcolor_r, 0, 0, 255);     -- white fade

------------------------------------------------------
-- 爆発 (110F)
------------------------------------------------------
setDisp( SP_ATK_4, 1, 1);
setMoveKey(  SP_ATK_4,    1,  1000,    0,  0);
