...
setEffMoveKey(  spep_2,   kamehame_beam,   0,  0,  0);
...
-- 最後のふっとばし演出(110F)　
------------------------------------------------------
--entryFade( spep_4-5, 4, 6, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
