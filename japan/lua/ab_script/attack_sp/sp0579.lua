...
SP_03=	153863	;--	構え
SP_04=	153865	;--	横撃ち
SP_05=	153867	;--	気弾が敵に迫る

--敵側
SP_01x=	153860	;--	アイドリング	(敵)
SP_02x=	153862	;--	気溜	(敵)
SP_03x=	153864	;--	構え	(敵)
SP_04x=	153866	;--	横撃ち	(敵)
SP_05x=	153867	;--	気弾が敵に迫る	
...
--エフェクト(気)
ki_b = entryEffect(  spep_1,   1501,   0x80, -1,  0,  0,  0);    -- eff_002

setEffMoveKey( spep_1, ki_b, 0, 0 , 0 );
setEffMoveKey( spep_1 + 36, ki_b, 0, 0 , 0 );
setEffScaleKey( spep_1, ki_b, 1.0, 1.0 );
setEffScaleKey( spep_1 + 36, ki_b, 1.0, 1.0 );
setEffRotateKey( spep_1, ki_b, 0 );
setEffRotateKey( spep_1 + 36, ki_b, 0 );
setEffAlphaKey( spep_1, ki_b, 255 );
setEffAlphaKey( spep_1 + 36, ki_b, 255 );
...
-- ** エフェクト等 ** --
aura_b = entryEffectLife( spep_2 + 0,   1503, 98, 0x80,  -1,  1,  0,  0); -- オーラ

setEffMoveKey( spep_2 + 0, aura_b, 0, 0 , 0 );
setEffMoveKey( spep_2 + 98, aura_b,0, 0 , 0 );

setEffScaleKey(  spep_2 + 0, aura_b, 1.0, 1.0);
setEffScaleKey(  spep_2 + 98, aura_b, 1.0, 1.0);

setEffRotateKey( spep_2 + 0, aura_b, 0 );
setEffRotateKey( spep_2 + 98, aura_b, 0 );

setEffAlphaKey( spep_2 + 0, aura_b, 255 );
setEffAlphaKey( spep_2 + 98, aura_b, 255 );
...
-- ** エフェクト等 ** --
hassha = entryEffectLife( spep_4 + 0, SP_04, 82, 0x100, -1, 0, 0, 0 );  --横撃ち(ef_004)
setEffMoveKey( spep_4 + 0, hassha, 0, 0 , 0 );
setEffMoveKey( spep_4 + 82, hassha, 0, 0 , 0 );
setEffScaleKey( spep_4 + 0, hassha, 1.0, 1.0 );
setEffScaleKey( spep_4 + 82, hassha, 1.0, 1.0 );
setEffRotateKey( spep_4 + 0, hassha, 0 );
setEffRotateKey( spep_4 + 82, hassha, 0 );
setEffAlphaKey( spep_4 + 0, hassha, 255 );
setEffAlphaKey( spep_4 + 82, hassha, 255 );

-- ** 流線 ** --
ryusen1 = entryEffectLife( spep_4 + 0,  907, 16, 0x80, -1, 0, 0, 0 );  --流線
setEffMoveKey( spep_4 + 0, ryusen1, 0, 0 , 0 );
setEffMoveKey( spep_4 + 16, ryusen1, 0, 0 , 0 );

setEffScaleKey( spep_4 + 0, ryusen1, 1, 1 );
setEffScaleKey( spep_4 + 16, ryusen1, 1, 1 );

setEffRotateKey( spep_4 + 0, ryusen1, 180 );
setEffRotateKey( spep_4 + 16, ryusen1, 180 );

setEffAlphaKey( spep_4 + 0, ryusen1, 255 );
setEffAlphaKey( spep_4 + 14, ryusen1, 255 );
setEffAlphaKey( spep_4 + 15, ryusen1, 255 );
setEffAlphaKey( spep_4 + 16, ryusen1, 0 );

-- ** 流線 ** --
ryusen2 = entryEffectLife( spep_4 + 16,  914, 66, 0x80, -1, 0, 0, 0 );  --流線
setEffMoveKey( spep_4 + 16, ryusen2, 0, 0 , 0 );
setEffMoveKey( spep_4 + 82, ryusen2, 0, 0 , 0 );

setEffScaleKey( spep_4 + 16, ryusen2, 1, 1 );
setEffScaleKey( spep_4 + 82, ryusen2, 1, 1 );

setEffRotateKey( spep_4 + 16, ryusen2, 180 );
setEffRotateKey( spep_4 + 82, ryusen2, 180 );

setEffAlphaKey( spep_4 + 16, ryusen2, 0 );
setEffAlphaKey( spep_4 + 18, ryusen2, 255 );
setEffAlphaKey( spep_4 + 82, ryusen2, 255 );

-- ** 書き文字エントリー ** --
ctzuo = entryEffectLife( spep_4 + 16 - 3,  10012, 16, 0x100, -1, 0, 76, 259.9 );

setEffMoveKey( spep_4 + 16 - 3, ctzuo, 76, 259.9 , 0 );
setEffMoveKey( spep_4 + 18 - 3, ctzuo, 88.8, 275.1 , 0 );
setEffMoveKey( spep_4 + 20 - 3, ctzuo, 92, 299.9 , 0 );
setEffMoveKey( spep_4 + 22 - 3, ctzuo, 110.3, 309.4 , 0 );
setEffMoveKey( spep_4 + 24 - 3, ctzuo, 108, 339.9 , 0 );
setEffMoveKey( spep_4 + 26 - 3, ctzuo, 132, 343.9 , 0 );
setEffMoveKey( spep_4 + 28 - 3, ctzuo, 129.3, 359.9 , 0 );
setEffMoveKey( spep_4 + 30 - 3, ctzuo, 174.6, 327.9 , 0 );
setEffMoveKey( spep_4 + 32 - 3, ctzuo, 196, 319.9 , 0 );

setEffScaleKey( spep_4 + 16 -3, ctzuo, 0.3, 0.3 );
setEffScaleKey( spep_4 + 18 -3, ctzuo, 0.87, 0.87 );
setEffScaleKey( spep_4 + 20 -3, ctzuo, 2.64, 2.64 );
setEffScaleKey( spep_4 + 22 -3, ctzuo, 2.91, 2.91 );
setEffScaleKey( spep_4 + 24 -3, ctzuo, 3.19, 3.19 );
setEffScaleKey( spep_4 + 28 -3, ctzuo, 4.46, 4.46 );
setEffScaleKey( spep_4 + 30 -3, ctzuo, 5.73, 5.73 );
setEffScaleKey( spep_4 + 32 -3, ctzuo, 6.2 , 6.2 );

setEffRotateKey( spep_4 + 16 - 3, ctzuo, 20 );
setEffRotateKey( spep_4 + 32 - 3, ctzuo, 20 );

setEffAlphaKey( spep_4 + 16 - 3, ctzuo, 255 );
setEffAlphaKey( spep_4 + 26 - 3, ctzuo, 255 );
setEffAlphaKey( spep_4 + 28 - 3, ctzuo, 170 );
setEffAlphaKey( spep_4 + 30 - 3, ctzuo, 85 );
setEffAlphaKey( spep_4 + 32 - 3, ctzuo, 0 );

--集中線
shuchusen1 = entryEffectLife( spep_4  + 0,  906, 28 - 3, 0x100, -1, 0,0, 0 );

setEffMoveKey( spep_4  + 0, shuchusen1, 285.5 - 285.5, 0 , 0 );
setEffMoveKey( spep_4 - 3 + 18, shuchusen1, 285.5 - 285.5, 0 , 0 );
setEffMoveKey( spep_4 - 3 + 20, shuchusen1, 300.8 - 285.5, 0 , 0 );
setEffMoveKey( spep_4 - 3 + 22, shuchusen1, 346.8 - 285.5, 0 , 0 );
setEffMoveKey( spep_4 - 3 + 24, shuchusen1, 423.4 - 285.5, 0 , 0 );
setEffMoveKey( spep_4 - 3 + 26, shuchusen1, 530.6 - 285.5, 0 , 0 );
setEffMoveKey( spep_4 - 3 + 28, shuchusen1, 668.5 - 285.5, 0 , 0 );

setEffScaleKey( spep_4  + 0, shuchusen1, 1.5, 1.5 );
setEffScaleKey( spep_4 - 3 + 18, shuchusen1, 1.5, 1.5 );
setEffScaleKey( spep_4 - 3 + 20, shuchusen1, 1.54, 1.54 );
setEffScaleKey( spep_4 - 3 + 22, shuchusen1, 1.66, 1.66 );
setEffScaleKey( spep_4 - 3 + 24, shuchusen1, 1.86, 1.86 );
setEffScaleKey( spep_4 - 3 + 26, shuchusen1, 2.14, 2.14 );
setEffScaleKey( spep_4 - 3 + 28, shuchusen1, 2.5, 2.5 );

setEffRotateKey( spep_4  + 0, shuchusen1, 180 );
setEffRotateKey( spep_4 - 3 + 28, shuchusen1, 180 );

setEffAlphaKey( spep_4  + 0, shuchusen1, 255 );
setEffAlphaKey( spep_4 - 3 + 28, shuchusen1, 255 );

-- ** 音 ** --
SE1 = playSe( spep_4 + 16, 1022 );  --発射

-- ** 黒背景 ** --
entryFadeBg( spep_4 + 0, 0, 16, 0, 255, 255, 255, 255 );  --薄い黒　背景
entryFadeBg( spep_4 + 16, 0, 2, 8, 0, 255, 255, 255 );  --青　背景
entryFadeBg( spep_4 + 18, 8, 64, 0, 0, 0, 0, 180 );  --薄い黒　背景
...
-- ** 白フェード ** --
entryFade( spep_4 + 74, 6, 2, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
setEffAlphaKey( spep_5 + 98, hidan, 255 );

-- ** 流線 ** --
ryusen3 = entryEffectLife( spep_5 + 0,  921, 98, 0x80, -1, 0, 0, 0 );  --流線
setEffMoveKey( spep_5 + 0, ryusen3, 0, 0 , 0 );
setEffMoveKey( spep_5 + 98, ryusen3, 0, 0 , 0 );

setEffScaleKey( spep_5 + 0, ryusen3, 1, 1.1 );
setEffScaleKey( spep_5 + 98, ryusen3, 1, 1.1 );

setEffRotateKey( spep_5 + 0, ryusen3, 0 );
setEffRotateKey( spep_5 + 98, ryusen3, 0 );

setEffAlphaKey( spep_5 + 0, ryusen3, 255 );
setEffAlphaKey( spep_5 + 98, ryusen3, 255 );
...
setEffAlphaKey( spep_5 + 98, ctzudo, 255 );
...
entryFade( spep_5 + 74, 20, 6, 2, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
-- ** 集中線 ** --
shuchusen2 = entryEffectLife( spep_6 + 14,  906, 32, 0x100, -1, 0, 0, 0 );
setEffShake( spep_6 + 14, shuchusen2, 32, 25 );

setEffMoveKey( spep_6 + 14, shuchusen2, 0, 0 , 0 );
setEffMoveKey( spep_6 + 46, shuchusen2, 0, 0 , 0 );

setEffScaleKey( spep_6 + 14, shuchusen2, 1, 1 );
setEffScaleKey( spep_6 + 46, shuchusen2, 1, 1 );

setEffRotateKey( spep_6 + 14, shuchusen2, 0 );
setEffRotateKey( spep_6 + 46, shuchusen2, 0 );

setEffAlphaKey( spep_6 + 14, shuchusen2, 255 );
setEffAlphaKey( spep_6 + 28, shuchusen2, 255 );
setEffAlphaKey( spep_6 + 30, shuchusen2, 252 );
setEffAlphaKey( spep_6 + 32, shuchusen2, 242 );
setEffAlphaKey( spep_6 + 34, shuchusen2, 227 );
setEffAlphaKey( spep_6 + 36, shuchusen2, 205 );
setEffAlphaKey( spep_6 + 38, shuchusen2, 176 );
setEffAlphaKey( spep_6 + 40, shuchusen2, 142 );
setEffAlphaKey( spep_6 + 42, shuchusen2, 101 );
setEffAlphaKey( spep_6 + 44, shuchusen2, 54 );
setEffAlphaKey( spep_6 + 46, shuchusen2, 0 );
...
-- ** エフェクト等 ** --
hassha = entryEffectLife( spep_4 + 0, SP_04x, 82, 0x100, -1, 0, 0, 0 );  --横撃ち(ef_004)
setEffMoveKey( spep_4 + 0, hassha, 0, 0 , 0 );
setEffMoveKey( spep_4 + 82, hassha, 0, 0 , 0 );
setEffScaleKey( spep_4 + 0, hassha, 1.0, 1.0 );
setEffScaleKey( spep_4 + 82, hassha, 1.0, 1.0 );
...
-- ** エフェクト等 ** --
hidan = entryEffectLife( spep_5 + 0, SP_05x, 98, 0x100, -1, 0, 0, 0 );  --被弾(ef_005)
setEffMoveKey( spep_5 + 0, hidan, 0, 0 , 0 );
setEffMoveKey( spep_5 + 98, hidan, 0, 0 , 0 );
setEffScaleKey( spep_5 + 0, hidan, 1.0, 1.0 );
setEffScaleKey( spep_5 + 98, hidan, 1.0, 1.0 );
