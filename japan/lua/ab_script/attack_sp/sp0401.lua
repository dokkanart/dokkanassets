...
kitame=entryEffect( spep1, SP_01, 0x100, 0,  -50,  40,  0);   -- 手のカメハメ波部
setEffMoveKey( spep1, kitame,  -50,  40,  0);
setEffScaleKey(spep1, kitame, 0.4,0.4);
setEffAlphaKey(spep1, kitame, 255);
setEffRotateKey(spep1, kitame, 0);

setEffShake(spep1, kitame, 100,10);
...
setEffMoveKey( spep1, kitame,  -40,  30,  0);
setEffScaleKey(spep1, kitame, 0.4,0.4);
setEffAlphaKey(spep1, kitame, 255);
setEffRotateKey(spep1, kitame, 0);
