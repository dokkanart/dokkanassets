...
-- ** エフェクト等 ** --
aura = entryEffectLife(  30,   311, 39, 0x80,  -1,  0,  0,  -220); -- オーラ
...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  -20,  15);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);

--entryFade( 165, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
aura2 = entryEffectLife(  70,   311, 99, 0x80,  -1,  0,  0,  -220); -- オーラ
...
-- カードカットイン(90F)
------------------------------------------------------
entryFade( 164, 3, 3, 3, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryFade( 255, 3, 4, 3, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
tyousei = 70;
kamehame_beam = entryEffectLife( 260, SP_02, 110, 0x100,  0,  -1,  200,  0+tyousei);   -- 伸びるかめはめ波
setEffMoveKey( 270, kamehame_beam, 200, 0+tyousei);
setEffMoveKey( 290, kamehame_beam, 170, 0+tyousei, 20);
setEffMoveKey( 300, kamehame_beam,  20, 0+tyousei, 50);
setEffMoveKey( 305, kamehame_beam, -450, 0+tyousei, 80);
