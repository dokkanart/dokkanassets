...
shuchusen = entryEffectLife( 258, 906, 49, 0x00,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( 260, shuchusen, 1.0, 1.0);
setEffScaleKey( 300, shuchusen, 1.0, 1.0);
setEffScaleKey( 309, shuchusen, 2.0, 2.0);

entryEffectLife( 258, 920, 109, 0x80,  -1,  0,  0,  0); -- 流線

kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x80,  0,  300,  300,  0);   -- 伸びるかめはめ波
