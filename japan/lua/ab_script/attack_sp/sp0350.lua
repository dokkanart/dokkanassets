...
-- 書き文字エントリー
ctzun = entryEffectLife( 30, 10013, 39, 0, -1, 0, 0, 200); -- ズズンッ
setEffShake(30, ctzun, 40, 7);
setEffAlphaKey(30, ctzun, 255);
setEffAlphaKey(50, ctzun, 255);
setEffAlphaKey(70, ctzun, 0);
setEffScaleKey( 30, ctzun, 0.1, 0.1);
setEffScaleKey( 40, ctzun, 2.0, 2.0);
playSe( 30, SE_02);
...
kame_hand = entryEffect( 70, SP_01, 0x100,      -1,  -30,  200,  0);   -- 手のカメハメ波部
setEffMoveKey(70, kame_hand, -30, 200,0);
setEffScaleKey( 70, kame_hand, 0.5, 0.5);
setEffAlphaKey(70, kame_hand, 255);
setEffAlphaKey(169, kame_hand, 255);
setEffAlphaKey(170, kame_hand, 0);

entryFade( 165-8, 3, 2+8, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- 書き文字エントリー
ctgogo = entryEffectLife( 90, 190006, 70, 0x100, -1, 0, 0, 510);    -- ゴゴゴ・・・
setEffShake(90, ctgogo, 70, 8);
...
setEffAlphaKey(430, ctzudodo, 255);
setEffAlphaKey(450, ctzudodo, 0);
...
-- 書き文字エントリー
ctga = entryEffectLife( 485, 10005, 100, 0, -1, 0, -50, 230); -- ガッ
setEffShake(485, ctga, 30, 10);
setEffRotateKey( 485, ctga, -40);
setEffScaleKey( 485, ctga, 4.0, 4.0);
setEffScaleKey( 486, ctga, 2.0, 2.0);
setEffScaleKey( 487, ctga, 2.6, 2.6);
setEffScaleKey( 488, ctga, 4.0, 4.0);
setEffScaleKey( 489, ctga, 2.6, 2.6);
setEffScaleKey( 490, ctga, 3.8, 3.8);
setEffScaleKey( 580, ctga, 3.8, 3.8);
setEffAlphaKey( 485, ctga, 255);
setEffAlphaKey( 575, ctga, 255);
setEffAlphaKey( 585, ctga, 0);

playSe( 473, SE_11);
shuchusen2 = entryEffectLife( 473, 906, 120, 0x00,  -1, 0,  0,  0);   -- 集中線
...
-- ** エフェクト等 ** --
aura2 = entryEffectLife(  70,   311, 99, 0x80,  -1,  1,  0,  -200); -- オーラ
setEffScaleKey( 70, aura2, 1.5, 1.5);
setShakeChara( 70, 0, 49, 5);

kame_hand = entryEffect( 70, SP_01, 0x80,      -1,  -20,  200,  0);   -- 手のカメハメ波部
setEffMoveKey(70, kame_hand, -20, 200,0);
setEffScaleKey( 70, kame_hand, 0.5, 0.5);
setEffAlphaKey(70, kame_hand, 255);
setEffAlphaKey(169, kame_hand, 255);
setEffAlphaKey(170, kame_hand, 0);
...
--kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x80,  -1,  300,  0,  0);   -- 伸びるかめはめ波
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  0,  0);   -- 伸びるかめはめ波
...
setEffShake(370, ctzudodo, 99, 20);
setEffScaleKey( 370, ctzudodo, 2.4, 2.4);
setEffRotateKey(370, ctzudodo, 0);
setEffAlphaKey(370, ctzudodo, 255);
setEffAlphaKey(430, ctzudodo, 255);
setEffAlphaKey(450, ctzudodo, 0);
