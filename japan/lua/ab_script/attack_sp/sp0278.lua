...
--aura = entryEffectLife(  0,   358, 69, 0x40+0x80,  0,  1,  0,  -100); -- オーラ
--setEffScaleKey( 0, aura, 1.9, 1.9);
--setEffMoveKey(  0,    aura,   0,  0,   0);
--setEffMoveKey(  30,    aura,   0,  0,   0);
--setEffMoveKey(  31,    aura,   0,  0,   0);

kame_hand = entryEffect(SP_start+ 69, SP_01, 0x40+0x80, 0,  300,  80,  120);   -- 手のカメハメ波部
...
-- 書き文字エントリー
ct = entryEffectLife(SP_start+ 90, 10008, 39, 0x100, -1, 0, -220, 280);    -- ゴゴゴ・・・
...
--aura = entryEffectLife(  SP_start+260,   358, 99, 0x40+0x80,  0,  1,  0,  0); -- オーラ
--setEffScaleKey( SP_start+260, aura, 3.0, 3.0);

kamehame_beam = entryEffectLife(SP_start+ 260, SP_02, 109, 0x40,  0,  300,  190,  50);   -- 伸びるかめはめ波
playSe(SP_start+ 260, SE_07);

setEffMoveKey(SP_start+ 290,kamehame_beam,150,50 );
setEffMoveKey(SP_start+ 300,kamehame_beam,105,50 );
setEffMoveKey(SP_start+ 305,kamehame_beam,10,50 );
...
kame_hand = entryEffect(SP_start+ 69, SP_01, 0x40,0,  300,  -50,  120);   -- 手のカメハメ波部
setEffScaleKey(SP_start+ 69, kame_hand, 0.5, 0.5);
--setEffMoveKey(SP_start+ 69, kame_hand,20,20);
...
kamehame_beam = entryEffectLife(SP_start+ 260, SP_02, 109, 0x40,  0,  300,  160,  50);   -- 伸びるかめはめ波
playSe(SP_start+ 260, SE_07);

setEffMoveKey(SP_start+ 290,kamehame_beam,120,50 );
setEffMoveKey(SP_start+ 300,kamehame_beam,75,50 );
setEffMoveKey(SP_start+ 305,kamehame_beam,0,50 );
