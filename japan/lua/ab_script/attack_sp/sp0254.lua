...
setScaleKey(   30,   0, 2.0, 2.0);


setMoveKey(   0,   0,  0, -80,   0);
setMoveKey(   15,   0,  0, -80,   0);
setMoveKey(  117,   0,  0, -80,   0);
...
kame_hand = entryEffect( 30, SP_01, 0x40+0x80, 0, 300,  0, 80);   -- 手のカメハメ波部 50end
...
kamehame_beam_st = entryEffectLife( spep_3, SP_02, 94, 0x40+0x100,  0,  300,  90,  -30);   -- 伸びるかめはめ波

kamehame_beam = entryEffectLife( spep_3, SP_02, 108, 0x40+0x80,  0,  300,  90,  -30);   -- 伸びるかめはめ波
...
kame_hand = entryEffect( 30, SP_01, 0x40+0x80, 0, 300,  0, 80);   -- 手のカメハメ波部 50end
setEffScaleKey( 30, kame_hand, -1.0, 1.0);
...
kamehame_beam_st = entryEffectLife( spep_3, SP_02e, 94, 0x40+0x100,  0,  300,  90,  -30);   -- 伸びるかめはめ波

--setEffScaleKey( spep_3, kamehame_beam_st, -1.0, 1.0);

kamehame_beam = entryEffectLife( spep_3, SP_02e, 108, 0x40+0x80,  0,  300,  90,  -30);   -- 伸びるかめはめ波
