...
-- 書き文字エントリー
ct = entryEffectLife( SP_start+ 90, 10008, 80, 0x100, -1, 0, 190, 210);    -- ゴゴゴ・・・
...
entryFade( SP_start+ 450, 6,  13, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
--entryFade( SP_start+SP_ATK_4+100 -10, 9,  10, 1, 8, 8, 8, 255);             -- black fade

--endPhase( SP_start+580);
endPhase( SP_start+SP_ATK_4+100 -10);
else
...
entryEffect( tyo+70,   1503,   0x80,  -1,  0,  0,  40);   -- eff_004 ( tyo2+気)
entryEffect( tyo+70,   1502,   0,     -1,  0,  0,  40);   -- eff_003 ( tyo2+気)
...
entryFade( tyo2+ 450, 6,  13, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
--entryFade( tyo2+SP_ATK_4+100 -10, 9,  10, 1, 8, 8, 8, 255);             -- black fade

--endPhase( tyo2+580);
endPhase( tyo2+SP_ATK_4+120 -10);
