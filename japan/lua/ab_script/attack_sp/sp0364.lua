...
-- ** エフェクト等 ** --
aura = entryEffectLife(  30,   311, 39, 0x40,  0,  1,  0,  -15); -- オーラ
...
entryEffect(  80,   1502,   0x80,     -1,  0,  0,  0);   -- eff_003 (気)
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  80,   311, 99, 0x80,  0,  1,  0,  -15); -- オーラ
setEffScaleKey( 80, aura, 1.4, 1.4);
setShakeChara( 80, 0, 100, 5);


kame_hand = entryEffect( 80, SP_01, 0x80,      0,  300,  -5,  60);   -- 手のカメハメ波部
setEffScaleKey( 80, kame_hand, 1.0, 1.0);
setEffAlphaKey(80, kame_hand, 100);
...
setEffAlphaKey(169, kame_hand, 100);
...
entryFade( 255, 3, 7, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
kamehame_beam = entryEffectLife( 260, SP_02, 110, 0x100,  0,  -1,  200,  60);   -- 伸びるかめはめ波
setEffMoveKey( 270, kamehame_beam, 200, 60);
setEffMoveKey( 290, kamehame_beam, 170, 60, 20);
setEffMoveKey( 300, kamehame_beam,  20, 60, 50);
setEffMoveKey( 305, kamehame_beam, -450, 60, 80);
...
kame_hand = entryEffect( 80, SP_01, 0x0,      0,  300,  -25,  60);   -- 手のカメハメ波部
setEffScaleKey( 80, kame_hand, 1.0, 1.0);
setEffAlphaKey(80, kame_hand, 100);
--entryFade( 165, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
setEffAlphaKey(165, kame_hand, 100);
setEffAlphaKey(166, kame_hand, 0);
