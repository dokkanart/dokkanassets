...
-- ** 次の準備 ** --
entryFade( 166 + 0, 0, 4, 6, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( 170 + 82, 6, 6, 2, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
-- 音 --
playSe( 268, 1003 );  --投げる音

a1 = 20;
--球道
playSe( 278 +a1, 9 );
setSeVolume( 278 +a1, 9, 70 );
playSe( 278 +a1, 1117 );
SE1 = playSe( 317 +a1, 1183 );
setSeVolume( 317 +a1, 1183, 100 );
setSeVolume( 358 +a1, 1183, 100 );
setSeVolume( 366 +a1, 1183, 130 );
setSeVolume( 380 +a1, 1183, 150 );
setSeVolume( 393 +a1, 1183, 180 );
stopSe( 400 +a1, SE1, 0 );
...
setRotateKey( 370,   1,  0 );
setRotateKey( 469-parX,   1,  0 );
...
-- 音 --
playSe( 455-parX, 1009 );  --ヒット
playSe( 455-parX, 1047 );  --ヒット
