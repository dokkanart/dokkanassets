...
entryFade( 60, 5, 4, 8, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade
...
kame_hand = entryEffect( 70, SP_01, 0x40+0x100,      0,  300,  0,  -50);   -- 手のカメハメ波部
setEffScaleKey( 30, kame_hand, 0.5, 0.5);
--setEffScaleKey( 70, kame_hand, 0.5, 0.5);

entryFade( 165 -4, 4, 6 +4, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- ** 集中線 ** --
shuchusen2 = entryEffectLife( 170 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( 170 + 0, shuchusen2, 90, 20 );

setEffMoveKey( 170 + 0, shuchusen2, 0, 0 , 0 );
setEffMoveKey( 170 + 90, shuchusen2, 0, 0 , 0 );

setEffScaleKey( 170 + 0, shuchusen2, 1.6, 1.6 );
setEffScaleKey( 170 + 90, shuchusen2, 1.6, 1.6 );

setEffRotateKey( 170 + 0, shuchusen2, 0 );
setEffRotateKey( 170 + 90, shuchusen2, 0 );

setEffAlphaKey( 170 + 0, shuchusen2, 255 );
setEffAlphaKey( 170 + 90, shuchusen2, 255 );
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  200,  0);   -- 伸びるかめはめ波
playSe( 260, SE_07);
...
setMoveKey(  300,    0,   -450,  0,   40);
setMoveKey(  305,    0,   -550,  0,   75);
--setMoveKey(  315,    0,   -850,  0,  90);
