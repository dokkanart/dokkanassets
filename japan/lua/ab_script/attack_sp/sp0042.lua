...
entryFade( 465, 6,  10, 4, 255, 0, 0, 255);     -- white fade



-- 敵吹っ飛ぶモーション
changeAnime( 460, 1, 108);
setMoveKey(  450, 1,  -60,    0,  -128);
...
SP_dodge = 382; --エンドフェイズのフレーム数を置き換える
...
-- 敵吹っ飛ぶモーション
changeAnime( SP_ATK_3+10, 1, 108);
setScaleKey( SP_ATK_3+10,   1,   1.6,  1.6);
setMoveKey(  SP_ATK_3+10,    1,   -120,  0,   0);
setMoveKey(  SP_ATK_3+15,    1,   -120,  0,   0);
setMoveKey(  SP_ATK_3+20+15, 1,  250,    0,  128);

entryFade( SP_ATK_3+30, 3,  15, 4, 255, 0, 0, 255);     -- white fade



--setMoveKey(  SP_ATK_3+8,    1,   120,  0,   0);
--setMoveKey(  SP_ATK_3+9, 1,  -60,    0,  -128);

--setMoveKey(  SP_ATK_3+28+5, 1,  1000,    0,  0);
--setScaleKey( SP_ATK_3+22+5, 1,  1.6, 1.6);
--setScaleKey( SP_ATK_3+24+5, 1,  1.5, 1.5);
--setScaleKey( SP_ATK_3+32+5, 1,  0.2, 0.2);

-- ** エフェクト等 ** --
setShakeChara( SP_ATK_3+20+5, 1, 99, 20);

entryFadeBg( SP_ATK_3+20+5, 0, 10, 0, 10, 10, 10, 150);          -- ベース暗め　背景
...
--entryFlash( (SP_ATK_3+30), 3, 255, 0, 0, 200);
----entryFlash( (SP_ATK_3+28), 1, fcolor_r, fcolor_g, fcolor_b, 200);

-- 書き文字エントリー
ct = entryEffectLife( SP_ATK_3, 10014, 99, 0x80, -1, 0, -100, 255); -- ズドドッ
...
--entryFlash( (SP_ATK_3+28), 4, fcolor_r, fcolor_g, fcolor_b, 200);
...
SP_dodge = 169; --エンドフェイズのフレーム数を置き換える
