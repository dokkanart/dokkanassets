...
-- かめはめ波溜め！(100F)
------------------------------------------------------
entryFadeBg( 0, 0, 101, 0, 10, 10, 10, 220);       -- ベース暗め　背景
...
kame_hand1 = entryEffect( SP_start+ 70, SP_01, 0x40,      0,  300,  -40,  220);   -- 手のカメハメ波部
...
--sentryEffect( SP_start+  160,   1502,   0,     -1,  0,  0,  0);   -- eff_003 (気)
...
kamehame_beam = entryEffectLife( SP_start+ 260, SP_02, 120, 0x40,  0,  300,  0,  0);   -- 伸びるかめはめ波
...
setEffScaleKey( SP_start+ 300, kamehame_beam, 1.0, 1.0);
setEffScaleKey( SP_start+ 308, kamehame_beam, 2.5, 2.5);

setEffMoveKey(SP_start+ 260, kamehame_beam, 0, 0, 0);
setEffMoveKey(SP_start+ 300, kamehame_beam, -50, 0, 0);
setEffMoveKey(SP_start+ 305, kamehame_beam, -150, 0, 0);

-- 途中からカメハメハが伸びる
setMoveKey( SP_start+  290,    0,   -200,  20,   50);
setMoveKey( SP_start+  305,    0,   -550,  40,   80);
setDisp( SP_start+  305, 0, 0);
setMoveKey( SP_start+  308,    0,   -550,  40,   80);
...
kamehame_beam = entryEffect( SP_start2+ SP_start+ 370+40, SP_05,   0x80, -1,  0,  0,  0);   -- ギャン
