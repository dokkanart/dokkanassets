...
SP_01=	155176	;--	気溜め
SP_02=	155178	;--	発射
SP_03=	155180	;--	気弾が敵に迫る
SP_04=	155181	;--	気弾が敵に迫る

--敵側
SP_01x=	155177	;--	気溜め	(敵)
SP_02x=	155179	;--	発射	(敵)
SP_03x=	155180	;--	気弾が敵に迫る	
SP_04x=	155181	;--	気弾が敵に迫る	
...
setEffMoveKey( spep_0 + 120, ora, 0, 0 , 0 );
setEffScaleKey( spep_0 + 17, ora, 1.0, 1.0 );
setEffScaleKey( spep_0 + 120, ora, 1.0, 1.0 );
setEffRotateKey( spep_0 + 17, ora, 0 );
setEffRotateKey( spep_0 + 120, ora, 0 );
setEffAlphaKey( spep_0 + 17, ora, 255 );
setEffAlphaKey( spep_0 + 120, ora, 255 );
...
playSe( spep_0 + 21, 1014 );
setSeVolume( spep_0 + 21, 1014, 89 );
playSe( spep_0 + 22, 1035 );
setSeVolume( spep_0 + 22, 1035, 71 );
...
SE1=playSe( spep_2 -20 + 45, 1021 );
se_1177 = playSe( spep_2 -20 + 45, 1177 );
setSeVolume( spep_2 -20 + 45, 1177, 0 );
setSeVolume( spep_2 -20 + 46, 1177, 6.36 );
setSeVolume( spep_2 -20 + 47, 1177, 12.71 );
setSeVolume( spep_2 -20 + 48, 1177, 19.07 );
setSeVolume( spep_2 -20 + 49, 1177, 25.43 );
setSeVolume( spep_2 -20 + 50, 1177, 31.79 );
setSeVolume( spep_2 -20 + 51, 1177, 38.14 );
setSeVolume( spep_2 -20 + 52, 1177, 44.50 );
setSeVolume( spep_2 -20 + 53, 1177, 50.86 );
setSeVolume( spep_2 -20 + 54, 1177, 57.21 );
setSeVolume( spep_2 -20 + 55, 1177, 63.57 );
setSeVolume( spep_2 -20 + 56, 1177, 69.93 );
setSeVolume( spep_2 -20 + 57, 1177, 76.29 );
SE2=playSe( spep_2-20 + 45, 1027 );
setSeVolume( spep_2-20 + 45, 1027, 79 );
se_1215 = playSe( spep_2-20 + 51, 1215 );
setSeVolume( spep_2-20 + 51, 1215, 56 );
------------------------------------------------------
-- 回避
------------------------------------------------------
...
------------------------------------------------------
--SE
setSeVolume( spep_2 -20 + 58, 1177, 82.64 );
setSeVolume( spep_2 -20 + 59, 1177, 89 );
--白フェード
