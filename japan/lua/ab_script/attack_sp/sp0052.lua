...
entryFade( 465, 6,  10, 4, 0, 0, 0, 255);     -- white fade
...
entryFadeBg( 370, 0, 99, 0, 154, 253, 161, 150);          -- ベース暗め　背景
entryEffectLife( 460,  1501,  30,  0x80, 1,  0,  0,  0);
...
--entryFlash( (460), 3, 154, 253, 161, 120);
...
playSe( SP_ATK_3+20, SE_09);
playSe( SP_ATK_3+25, SE_09);
playSe( SP_ATK_3+17, SE_09);
-- 敵吹っ飛ぶモーション
...
entryEffectLife( SP_ATK_3+13,  1501,  30,  0x80, 1,  0,  0,  0);
...
--entryFlash( (SP_ATK_3+34), 3, 154, 253, 161, 120);
-- 書き文字エントリー
