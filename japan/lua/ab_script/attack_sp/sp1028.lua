...
changeAnime( 260, 0, 31); 
--P移動
setMoveKey(  259,    0,      0,  0,   0);
setMoveKey(  260,    0,   -600,  200,   0);
setMoveKey(  261,    0,   -600,  200,   0);
setMoveKey(  265,    0,   -50,  200,   0);
setMoveKey(  275,    0,   -50,  200,   0);

setMoveKey(  295,    0,   -150,  200,   0);
...
setMoveKey(  305,  0, 700,  200,   0);
setMoveKey(  308,  0, 700,  200,   0);
...
setScaleKey( SP_ATK_3,    0,  0.7, 0.7);
setScaleKey( SP_ATK_3+40,    0,  0.7, 0.7);
changeAnime( SP_ATK_3, 0, 31); 
...
--setScaleKey( SP_ATK_3-1,    0,  1.0, 1.0);
--setScaleKey( SP_ATK_3,    0,  0.4, 0.4);
--setScaleKey( SP_ATK_3+1,    0,  0.4, 0.4);
...
setMoveKey(  SP_ATK_3+10,    1,  150,  0,   0);
...
setMoveKey(  SP_ATK_3+20,  0, -100,  0,   0);
setMoveKey(  SP_ATK_3+21,  0, -1700,  0,   0);

setMoveKey(  SP_ATK_3+18,    1,   100,  0,   0);
setMoveKey(  SP_ATK_3+20,    1,   100,  0,   0);
setMoveKey(  SP_ATK_3+21,    1,   700,  0,   0);
setScaleKey( SP_ATK_3+19,   1,   1.6,  1.6);
--playSe( SP_ATK_3+12, SE_01);

--entryFade( SP_ATK_3+27, 10,  3, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

playSe( SP_ATK_3+24, SE_09);
-- キャラを消す
setDisp( SP_ATK_3+20, 0, 0);
setDisp( SP_ATK_3+20, 1, 0);
entryFadeBg( SP_ATK_3+20, 0, 70, 10, 0, 0, 0, 0);     -- 黒い　背景
...
setEffAlphaKey(SP_ATK_3+20, ct, 0);
...
--エフェクト
entryEffect( SP_ATK_3+20, SP_01,  0x80,  -1,  0,  0,  0);
entryEffect( SP_ATK_3+34, SP_02,  0x100,  -1,  0,  0,  0);
-- ダメージ表示
dealDamage(SP_ATK_3+28);
endPhase(SP_ATK_3+90);
...
setMoveKey(  SP_ATK_1+1,    0,   -600,  200,   0);
...
setScaleKey( SP_ATK_2+48,    0,  1.0, 1.0);
changeAnime( SP_ATK_2, 0, 31);

setMoveKey(  SP_ATK_2,    0,   -600,  200,   0);
setMoveKey(  SP_ATK_2+5,    0,   -50,  200,   0);
setMoveKey(  SP_ATK_2+15,    0,   -50,  200,   0);

setMoveKey(  SP_ATK_2+35,  0,   -100,  200,   0);

playSe( SP_ATK_2+40, SE_06);

setMoveKey(  SP_ATK_2+45,  0,   700,  200,   0);
setMoveKey(  SP_ATK_2+48,  0,   700,  200,   0);
setMoveKey(  SP_ATK_2+49,  0,   -1700,  200,   0);
...
setMoveKey(  SP_ATK_3+10,  0, -100,  0,   0);
setMoveKey(  SP_ATK_3+20,  0, -100,  0,   0);
setMoveKey(  SP_ATK_3+21,  0, -700,  0,   0);
...
-- 書き文字エントリー
ct = entryEffectLife( SP_ATK_3, 10014, 19, 0, -1, 0, 100, 255); -- ズドドッ
setEffShake(SP_ATK_3, ct, 99, 20);
setEffScaleKey( SP_ATK_3, ct, 2.4, 2.4);
setEffRotateKey(SP_ATK_3, ct, -70);
setEffAlphaKey(SP_ATK_3, ct, 255);
