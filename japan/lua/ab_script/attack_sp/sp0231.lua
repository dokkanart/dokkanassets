...
kame_hand = entryEffect(  70, SP_01, 0x40,      0,  300,  60,  10);   -- 手のカメハメ波部
setEffScaleKey(  70, kame_hand, 0.4, 0.4);

kame_hand2 = entryEffect(  70, SP_01, 0x40,      0,  300,  -75,  10);   -- 手のカメハメ波部
setEffScaleKey(  70, kame_hand2, 0.4, 0.4);

--entryFade(  165, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
aura = entryEffectLife(   70,   311, 99, 0x40,  0,  0,  0,  -200); -- オーラ
setEffScaleKey(  70, aura, 1.3, 1.3);
setShakeChara(  70, 0, 49, 5);
setEffAlphaKey( 70, aura, 125);
...
playSe(  260, SE_07);
setEffMoveKey(    260,  kamehame_beam, 200,  100,   0);
setEffMoveKey(    299,  kamehame_beam, 200,  100,   0);
...
entryFadeBg(  300, 0, 2, 8, 10, 10, 10, 180);     -- 青い　背景
