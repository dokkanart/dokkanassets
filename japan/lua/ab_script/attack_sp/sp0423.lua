...
shuchusen2 = entryEffectLife( spep2+18, 906, 122, 0x100,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( spep2+18, shuchusen2, 1.0, 1.0);
...
-- ** エフェクト等 ** --
entryFadeBg( spep2+17, 0, 120, 0, 0, 0, 0, 255);       -- ベース暗め　背景
entryFade( spep2+15, 2, 1, 2, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade
entryFade( spep2+45, 2, 4, 2, fcolor_r, fcolor_g, fcolor_b,  190);     -- white fade
entryFade( spep2+69, 2, 4, 2, fcolor_r, fcolor_g, fcolor_b,  190);     -- white fade
...
setEffAlphaKey( spep2+18, Tame2a, 255);
setEffAlphaKey( spep2+19, Tame2a, 0);
...
setEffAlphaKey( spep2+18, Tame2b, 0);
setEffAlphaKey( spep2+19, Tame2b, 255);
...
-- ** エフェクト等 ** --
entryFadeBg( spep2+17, 0, 120, 0, 0, 0, 0, 255);       -- ベース暗め　背景
entryFade( spep2+15, 2, 3, 2, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade
entryFade( spep2+45, 2, 4, 2, fcolor_r, fcolor_g, fcolor_b,  190);     -- white fade
entryFade( spep2+69, 2, 4, 2, fcolor_r, fcolor_g, fcolor_b,  190);     -- white fade
entryFade( spep2+133, 2, 7, 4, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade
