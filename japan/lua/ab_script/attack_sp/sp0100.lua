...
setMoveKey(   0,   0,    0, -40,   0);
setMoveKey(   1,   0,    0, -40,   0);
...
kame_hand = entryEffectLife( 70, SP_01, 120, 0x40+0x100,      0,  300,  0,  0);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);

-- 書き文字エントリー
ct = entryEffectLife( 90, 10008, 69, 0x100, -1, 0, -150, 535);    -- ゴゴゴ・・・
setEffShake(90, ct, 40, 8);
setEffScaleKey(90, ct, 2.0, 1.0);
setEffRotateKey(90, ct, -10);
------------------------------------------------------
-- カードカットイン(90F)
------------------------------------------------------
setScaleKey( 169,   0, 1.2, 1.2);
...
-- カメハメハ発射(110F)
------------------------------------------------------
changeAnime( 256, 0, 31);                                    -- かめはめ発射ポーズ

setMoveKey(  256,    0,      0,  -40,   0);
setMoveKey(  257,    0,      0,  -40,   0);
...
-- 書き文字エントリー
ct = entryEffectLife( 264, 10012, 66, 0, -1, 0, 150, 420); -- ズオッ
setEffShake(264, ct, 56, 5);
setEffAlphaKey(264, ct, 255);
setEffRotateKey(264, ct, 30);
setEffAlphaKey(300, ct, 255);
setEffAlphaKey(316, ct, 0);
setEffScaleKey(264, ct, 0.0, 0.0);
setEffScaleKey(272, ct, 2.5, 2.5);
setEffScaleKey(300, ct, 2.5, 2.5);
setEffScaleKey(316, ct, 5.0, 5.0);
setEffShake(316, ct, 18, 5);
playSe( 300, SE_07);
...
setMoveKey(  400,    1,   220,  0,   0);
setScaleKey(  400,   1,   1.6,  1.6);

SE0=playSe( 390, SE_06);
...
kame_hand = entryEffect( SP_ATK_0, SP_01, 0x40+0x100, 0,  300,  0,  0);   -- 手のカメハメ波部
...
-- カメハメハ発射(110F)
------------------------------------------------------
removeAllEffect( SP_ATK_2-1);

changeAnime( SP_ATK_2-1, 0, 31); 
setScaleKey( SP_ATK_2-1,   0, 1.5, 1.5);
setScaleKey( SP_ATK_2-2,   0, 1.5, 1.5);
setScaleKey( SP_ATK_2,   0, 1.0, 1.0);
setEffScaleKey( SP_ATK_2, aura, 2.0, 3.0);

--setMoveKey(  60,    0,      0,  0,   0);
--setMoveKey(  62,    0,      -100,  0,   0);
setMoveKey(  SP_ATK_2+5,    0,      0,  0,   0);
setMoveKey(  SP_ATK_2+10,   0,   -100,  0,   0);

kamehame_beam = entryEffectLife( SP_ATK_2, SP_02, 90, 0x40,  0,  300,  0,  0);   -- 伸びるかめはめ波
--setEffScaleKey( SP_ATK_2+2, kamehame_beam, 0.8, 0.8);
setEffAlphaKey( SP_ATK_2, kamehame_beam, 0);
setEffAlphaKey( SP_ATK_2+2, kamehame_beam, 0);
setEffAlphaKey( SP_ATK_2+3, kamehame_beam, 255);
setEffAlphaKey( SP_ATK_2+4, kamehame_beam, 255);
setEffAlphaKey( SP_ATK_2+21, kamehame_beam, 255);
...
setMoveKey(  SP_ATK_2+80,    0,   -1100,  0,   -50);

entryFade( SP_ATK_2-4, 4, 8, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
SE0=playSe( SP_ATK_2+90, SE_06);

-- 書き文字エントリー
ct = entryEffectLife( SP_ATK_2+8, 10012, 32, 0, -1, 0, 170, 420); -- ズオッ
...
setEffScaleKey(SP_ATK_2+12, ct, 2.0, 2.0);
setEffScaleKey(SP_ATK_2+32, ct, 2.0, 2.0);
...
setMoveKey(  SP_ATK_3+15,    1,   220,  0,   0);
