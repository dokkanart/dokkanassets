...
kamehame_beam = entryEffect( 260, SP_02, 0x40,  0,  300,  280,  80);   -- 伸びるかめはめ波
setEffMoveKey( 291, kamehame_beam,   190, 80, 0);
setEffMoveKey( 298, kamehame_beam,   150, 80, 0);
setEffMoveKey( 303, kamehame_beam,   100, 80, 0);
setEffMoveKey( 310, kamehame_beam,   50, 80, 0);
playSe( 260, SE_07);
