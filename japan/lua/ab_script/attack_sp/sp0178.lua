...
entryFadeBg( 0, 0, 70, 0, 10, 10, 10, 155);       -- ベース暗め　背景
...
entryFadeBg( 70, 0, 100, 0, 10, 10, 10, 155);       -- ベース暗め　背景
...
SSEN = entryEffectLife( 70, 906, 100, 0,  -1,  0,  0,  0); 
setEffScaleKey( 70, SSEN, 1.5, 1.5);
...
setScaleKey( 260,   0, 0.8, 0.8);

setMoveKey(  259,    0,      -600,  0,   0);
setMoveKey(  275,    0,      -120,  0,   0);
setMoveKey(  354,    0,      -120,  0,   0);
...
setScaleKey( 350,   0, 0.8, 0.8);

entryFade( 350, 20, 5, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
entryFadeBg( 260, 0, 115, 0, 10, 10, 10, 155);       -- ベース暗め　背景

entryEffectLife( 260, 920, 115, 0x80,  -1,  0,  0,  0); -- 流線
...
setMoveKey(  SP_dodge-1,    0,      -120,  0,   0);
