...
playSe(spep_0+58,1013);--広がる
SE1=playSe(spep_0+62,15);
...
--エフェクトの再生
gyan = entryEffectLife(  spep_4,  190016,  60,  0x100,  -1,  0,  0,  0);  --ギャン
...
------------------------------------------------------
--エフェクト
explosion=entryEffect(spep_5,1928,0x100,-1,0,0,0);
