...
setMoveKey(  260,    0,   -600,  200,   -32);
setMoveKey(  261,    0,   -600,  200,   -32);
setMoveKey(  270,    0,   -100,  200,   -32);
...
-- 途中からカメハメハが伸びる
setMoveKey(  292,    0,   -100,   200,   -32);
setMoveKey(  302,    0,   -800,  300,   -32);
setDisp(  302, 0, 0);

setMoveKey(  320,    0,   -800,  300,   -32);

entryFade( 347, 3, 2, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
--setMoveKey(  369,    0,   -450,  150,   -32);
setMoveKey(  350,    0,   0,  -100,   -32);--800
removeAllEffect(351);
...
kamehame_beam = entryEffectLife( 260, SP_02, 91, 0x40+0x80,  0,  300,  0,  -70);   -- 伸びるかめはめ波
...
ct2 = entryEffectLife( SP_start+ 430, 10006, 40, 0x100, -1, 0, 0, 255); -- ギャン
setEffShake( SP_start+430, ct2, 99, 20);
setEffScaleKey( SP_start+ 430, ct2, 0.1, 0.1);
setEffScaleKey( SP_start+ 435, ct2, 2.4, 2.4);
setEffScaleKey( SP_start+ 460, ct2, 2.8, 2.8);
setEffAlphaKey( SP_start+ 430, ct2, 255);
setEffAlphaKey( SP_start+ 445, ct2, 255);
setEffAlphaKey( SP_start+ 460, ct2, 0);
...
kamehame_beam = entryEffectLife( 260, SP_02, 91, 0x40+0x80,  0,  300,  -10,  -90);   -- 伸びるかめはめ波
...
SP_dodge = 318; --エンドフェイズのフレーム数を置き換える
