...
setScaleKey(   29,   0, 1.5, 1.5);
setScaleKey(   68,   0, 1.5, 1.5);
...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  98,  63);   -- 手のカメハメ波部
...
-- 書き文字エントリー
ct = entryEffectLife( 90, 10008, 70, 0x100, -1, 0, -300, 300);    -- ゴゴゴ・・・
