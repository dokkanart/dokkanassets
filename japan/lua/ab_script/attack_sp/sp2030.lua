...
setEffShake( spep_0 + 28, shuthuse, 110, 20 );
...
setEffShake( spep_1 + 44, shuchuse2, 174, 20 );
...
setEffShake( spep_3 +  0, shuchusen9, 90, 20 );
...
setEffShake( spep_2 +  0, chuchu3, 138, 20 );
...
--文字エントリー
ctgogo=entryEffectLife(spep_2+12,190006,70,0x100,-1,-10 +120,520);--ゴゴゴ
setEffMoveKey(spep_2+12,ctgogo,-10 +120,520,0);
setEffMoveKey(spep_2+82,ctgogo,-10 +120,520,0);
...
--集中線
shuchuse4 = entryEffectLife( spep_4 + 0,  906, 258, 0x100, -1, 0, 0, 0 );   -- 集中線
setEffShake( spep_4 +  0, shuchuse4, 258, 20 );
