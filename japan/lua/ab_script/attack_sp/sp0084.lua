...
kamehame_beam = entryEffect( 257, SP_02, 0x40,  0,  300,  0,  0);   -- 伸びるかめはめ波
setEffAlphaKey(257, kamehame_beam, 0);
setEffAlphaKey(258, kamehame_beam, 0);
setEffAlphaKey( 259,  kamehame_beam, 255);

setEffMoveKey( 305, kamehame_beam, 0, 0, 0);
setEffMoveKey( 310, kamehame_beam, 1200, 0, 0);
setEffMoveKey( 320, kamehame_beam, 800, 0, 0);
setEffMoveKey( 350, kamehame_beam, 0, 0, 0);

setEffAlphaKey( 375,  kamehame_beam, 255);
setEffAlphaKey( 377,  kamehame_beam, 0);
...
entryFade( 365, 3, 4, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
setEffAlphaKey(368, kamehame_beam, 255);
setEffAlphaKey(369, kamehame_beam, 0);
removeAllEffect( 369);
...
entryEffectLife( 257, 920, 112, 0x80,  -1,  0,  0,  0); -- 流線
...
setEffAlphaKey(370, kamehame_beam2, 0);
setEffAlphaKey(371, kamehame_beam2, 0);
setEffAlphaKey(372, kamehame_beam2, 255);
...
kame_hand = entryEffect( 8, SP_01, 0x40, 0,  300,  0,  0);   -- 手のカメハメ波部
setEffScaleKey( 8, kame_hand, 0.5, 0.5);

-- ** エフェクト等 ** --
--aura = entryEffectLife( SP_ATK_0,   311, 100, 0x40+0x80,  0,  1,  0,  0); -- オーラ
...
setEffReplaceTexture(spname, 7, 4);                                  -- 技名テクスチャ差し替え
setEffAlphaKey( SP_ATK_1+10, spname, 255);
...
--[[
setEffAlphaKey( (0), kame_hand, 255);
setEffAlphaKey( (SP_ATK_1), speff, 255);
setEffAlphaKey( (SP_ATK_1+36), speff, 255);
setEffAlphaKey( (SP_ATK_2+3), speff, 0);
setEffAlphaKey( (SP_ATK_1+36), aura, 255);
setEffAlphaKey( (SP_ATK_1+64), aura, 0);
setEffAlphaKey( (SP_ATK_1+10),  kame_hand, 255);
setEffAlphaKey( (SP_ATK_1+15),  kame_hand, 0);
setEffAlphaKey( (SP_ATK_1+63),  spname, 255);
setEffAlphaKey( (SP_ATK_1+64),  spname, 0);
--]]
...
setScaleKey( SP_ATK_1+62,   0, 1.5, 1.5);
setScaleKey( SP_ATK_1+63,   0, 1.0, 1.0);
...
setEffMoveKey( 105, kamehame_beam, 0, 0, 0);
setEffMoveKey( 130, kamehame_beam, 1200, 0, 0);
setEffMoveKey( 140, kamehame_beam, 600, 0, 0);
setEffMoveKey( 155, kamehame_beam, 630, 0, 0);
setEffMoveKey( 160, kamehame_beam, 800, 0, 0);
setEffAlphaKey(SP_ATK_2+1, kamehame_beam, 0);
setEffAlphaKey(SP_ATK_2+3, kamehame_beam, 0);
setEffAlphaKey(SP_ATK_2+4, kamehame_beam, 255);

playSe(SP_ATK_2+1, SE_07);

spname = entryEffectLife( SP_ATK_2, 1508,  85, 0x100,  -1,  0,  0,  0);               -- かめはめ波文字
setEffReplaceTexture(spname, 7, 4);                                  -- 技名テクスチャ差し替え

-- 途中からカメハメハが伸びる
setMoveKey(  SP_ATK_2+21,    0,   -100,  0,   0);
setMoveKey(  SP_ATK_2+22,    0,   -100,  0,   0);
setMoveKey(  SP_ATK_2+80,    0,   -1100,  0,   0);
...
entryEffectLife( SP_ATK_2+21, 920, 90, 0x80,  -1,  0,  0,  0); -- 流線
