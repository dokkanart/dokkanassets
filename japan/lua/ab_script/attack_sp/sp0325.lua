...
kame_hand = entryEffect( 70, SP_01, 0x40+0x100,      0,  300,  120,  40);   -- 手のカメハメ波部
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  350,  0);   -- 伸びるかめはめ波
...
kame_hand = entryEffect( SP_ATK_0, SP_01, 0x40+0x100, 0,  300,  60,  20);   -- 手のカメハメ波部
...
kamehame_beam = entryEffectLife( SP_ATK_2+2, SP_02, 90, 0x40,  0,  300,  300,  0);   -- 伸びるかめはめ波
