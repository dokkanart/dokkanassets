...
aura2 = entryEffect( tyo+70,   1503,   0x80,  0,  0,  0,  0);   -- eff_004 ( tyo2+気)
aura3 = entryEffect( tyo+70,   1502,   0,     0,  0,  0,  0);   -- eff_003 ( tyo2+気)
--speff = entryEffect(80,   1504,   0,     -1,  0,  0,  0);   -- eff_005 ( tyo2+カットイン)
--setEffReplaceTexture(speff, 3, 2);                           -- カットイン差し替え
--speff = entryEffect(80,   1505,   0,     -1,  0,  0,  0);   -- eff_006 ( tyo2+セリフ)
--setEffReplaceTexture(speff, 4, 5);                           -- セリフ差し替え

setEffScaleKey( tyo+70, aura2, 1.5, 1.5);
setEffScaleKey( tyo+70, aura3, 1.5, 1.5);
...
SP_dodge = 185+175; --エンドフェイズのフレーム数を置き換える
