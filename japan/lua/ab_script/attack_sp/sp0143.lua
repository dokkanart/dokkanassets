...
setMoveKey(   0,   0,    0, -1500,   -300);
setMoveKey(   0,   1,    0, -1500,   -300);
setMoveKey(  30,   0,    0, -100,   0);
setMoveKey(  40,   0,    0, -100,   0);
setMoveKey(  117,   0,    0, -100,  0);

setScaleKey(   0,   0, 2, 2);
--setScaleKey(   1,   0, 1.5, 1.5);
setScaleKey(   30,   0, 1.5, 1.5);
setScaleKey(   117,   0, 1.5, 1.5);
...
-- ** エフェクト等 ** --
aura2 = entryEffectLife(  0,   311, 117, 0x80,  -1,  0,  -30,  -1600); -- オーラ
--aura = entryEffectLife(  0,   311, 117, 0x80,  -1,  0,  -30,  0); -- オーラ
setEffMoveKey(   0,   aura2,    -30, -1600,   0);
setEffMoveKey(   1,   aura2,    -30, -1600,   0);
setEffMoveKey(  30,   aura2,    -30, -260,   0);
setEffMoveKey(  40,   aura2,    -30, -260,   0);
setEffMoveKey(  117,   aura2,   -30, -260,  0);
setEffScaleKey( 0, aura2, 1.5, 1.5);
setEffScaleKey( 40, aura2, 1.5, 1.5);
setEffScaleKey( 117, aura2, 2, 2);

aura1 = entryEffectLife( 0 , 350 , 117 , 0x80,  -1,  0,  -30,  -1600); -- オーラ350
--aura1 = entryEffectLife( 0 , 350 , 117 , 0x80,  -1,  0,  -30,  0); -- オーラ350
setEffMoveKey(   0,   aura1,    -30, -1600,   0);
setEffMoveKey(   1,   aura1,    -30, -1600,   0);
setEffMoveKey(  30,   aura1,   -30, -260,   0);
setEffMoveKey(  40,   aura1,   -30, -260,   0);
setEffMoveKey(  117,   aura1,  -30, -260,  0);
...
setMoveKey(  spep_3+98,    0,   -900,  0,   0);
...
kamehame_beam2 = entryEffect( spep_4, SP_03,   0, -1,  0,  0,  0);   -- 迫るかめはめ波 376で画面いっぱい
...
kame_hand = entryEffect( 0, SP_01, 0x40, 0,  300,  -100,  0);   -- 手のカメハメ波部
--setEffScaleKey( 70, kame_hand, 0.5, 0.5);
setEffScaleKey( 0, kame_hand, 0.5, 0.5);
setEffScaleKey( 124, kame_hand, 0.5, 0.5);
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  0,   311, 117, 0x80,  -1,  0,  -30,  0); -- オーラ
setEffMoveKey(   0,   aura,    -30, -1600,   0);
setEffMoveKey(  30,   aura,    -30, -260,   0);
setEffMoveKey(  40,   aura,    -30, -260,   0);
setEffMoveKey(  117,   aura,   -30, -260,  0);
