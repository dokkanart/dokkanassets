--1018520:人造人間14号&15号_マーダーコンビネーション(ドッカン前)
--sp_effect_a1_00199
...
SP_02=	154449	;--	ラッシュ：上
SP_03=	154450	;--	ラッシュ：下
SP_04=	154451	;--	ラッシュ：背景
SP_05=	154452	;--	ラストシーン：背景

--敵側
SP_01x=	154448	;--	導入
SP_02x=	154453	;--	ラッシュ：上	(敵)
SP_03x=	154454	;--	ラッシュ：下	(敵)
SP_04x=	154451	;--	ラッシュ：背景
SP_05x=	154452	;--	ラストシーン：背景
------------------------------------------------------
-- テンプレ構文
------------------------------------------------------
multi_frm = 2;
...
setEffScaleKey( spep_2-3 + 100, ctga, 1.86, 1.86 );
setEffScaleKey( spep_2-3 + 110, ctga, 1.86, 1.86 );
...
--白フェード
entryFade( spep_2 + 380, 4, 6, 4, fcolor_r, fcolor_g, fcolor_b, 255 );     -- white fade
...
haikei = entryEffect( spep_3 + 0, SP_05,  0x80, -1, 0, 0, 0 );
setEffMoveKey( spep_3 + 0, haikei, 0, 0, 0 ); 
setEffMoveKey( spep_3 + 112, haikei, 0, 0, 0 ); 

setEffScaleKey( spep_3 + 0, haikei, 1.0, 1.0 );
setEffScaleKey( spep_3 + 112, haikei, 1.0, 1.0 );

setEffRotateKey( spep_3 + 0, haikei, 0 );
setEffRotateKey( spep_3 + 112, haikei, 0 );

setEffAlphaKey( spep_3 + 0, haikei, 255 );
setEffAlphaKey( spep_3 + 112, haikei, 255 );

-- ** ひび割れ ** --
hibiware = entryEffect( spep_3 + 2, 1600, 0x100, -1, 0, 70, -60 );  --ひび割れ
setEffMoveKey( spep_3 + 2, hibiware, 70, -60, 0 ); 
setEffMoveKey( spep_3 + 112, hibiware, 70, -60, 0 ); 

setEffScaleKey( spep_3 + 2, hibiware, 1.0, 1.0 );
setEffScaleKey( spep_3 + 112, hibiware, 1.0, 1.0 );

setEffRotateKey( spep_3 + 2, hibiware, 0 );
setEffRotateKey( spep_3 + 112, hibiware, 0 );

setEffAlphaKey( spep_3 + 2, hibiware, 0 );
setEffAlphaKey( spep_3 + 13, hibiware, 0 );
setEffAlphaKey( spep_3 + 14, hibiware, 255 );
setEffAlphaKey( spep_3 + 112, hibiware, 255 );

-- ** 集中線 ** --
shuchusen6 = entryEffectLife( spep_3 + 14,  906, 32, 0x100, -1, 0, 0, 0 );
setEffShake( spep_3 + 14, shuchusen6, 32, 25 );

setEffMoveKey( spep_3 + 14, shuchusen6, 0, 0 , 0 );
setEffMoveKey( spep_3 + 46, shuchusen6, 0, 0 , 0 );

setEffScaleKey( spep_3 + 14, shuchusen6, 1, 1 );
setEffScaleKey( spep_3 + 46, shuchusen6, 1, 1 );

setEffRotateKey( spep_3 + 14, shuchusen6, 0 );
setEffRotateKey( spep_3 + 46, shuchusen6, 0 );

setEffAlphaKey( spep_3 + 14, shuchusen6, 255 );
setEffAlphaKey( spep_3 + 28, shuchusen6, 255 );
setEffAlphaKey( spep_3 + 30, shuchusen6, 252 );
setEffAlphaKey( spep_3 + 32, shuchusen6, 242 );
setEffAlphaKey( spep_3 + 34, shuchusen6, 227 );
setEffAlphaKey( spep_3 + 36, shuchusen6, 205 );
setEffAlphaKey( spep_3 + 38, shuchusen6, 176 );
setEffAlphaKey( spep_3 + 40, shuchusen6, 142 );
setEffAlphaKey( spep_3 + 42, shuchusen6, 101 );
setEffAlphaKey( spep_3 + 44, shuchusen6, 54 );
setEffAlphaKey( spep_3 + 46, shuchusen6, 0 );

shuchusen7 = entryEffectLife( spep_3 + 14,  1657, 98, 0x80, -1, 0, 0, 0 );  --黒い細い集中線
setEffMoveKey( spep_3 + 14, shuchusen7, 0, 0 , 0 );
setEffMoveKey( spep_3 + 112, shuchusen7, 0, 0 , 0 );

setEffScaleKey( spep_3 + 14, shuchusen7, 1, 1 );
setEffScaleKey( spep_3 + 112, shuchusen7, 1, 1 );

setEffRotateKey( spep_3 + 14, shuchusen7, 0 );
setEffRotateKey( spep_3 + 112, shuchusen7, 0 );

setEffAlphaKey( spep_3 + 14, shuchusen7, 255 );
setEffAlphaKey( spep_3 + 112, shuchusen7, 255 );
...
setMoveKey( spep_3 + 122, 1, -45.3, -142.1 , 0 );
...
setScaleKey( spep_3 + 122, 1, 1.6, 1.6 );
...
haikei = entryEffect( spep_3 + 0, SP_05x, 0x80, -1, 0, 0, 0 );
setEffMoveKey( spep_3 + 0, haikei, 0, 0, 0 ); 
setEffMoveKey( spep_3 + 112, haikei, 0, 0, 0 ); 
