...
kamehame_beam2 = entryEffect( 370, SP_03,   0, -1,  0,  0,  120);   -- 迫るかめはめ波
--setEffScaleKey(370, kamehame_beam2, 1, 1);
setDamage( 435, 1, 0);  -- ダメージ振動等
...
playSe( 435, SE_09);
-- 敵吹っ飛ぶモーション
changeAnime( 435, 1, 108);
setMoveKey(  440, 1,  120,    0,  0);
setMoveKey(  469, 1,  400,    0,  0);
setScaleKey( 440, 1,  1.6, 1.6);
