...
-- 書き文字エントリー
ct = entryEffectLife( 90, 10008, 39, 0x100, -1, 0, -270, 300);    -- ゴゴゴ・・・
...
setEffAlphaKey(82, kamehame_beam, 0);
setEffAlphaKey(83, kamehame_beam, 255);
...
sen = entryEffectLife( SP_ATK_2, 920, 90, 0x80,  -1,  0,  0,  0); -- 流線
setEffAlphaKey(SP_ATK_2, sen, 255);
