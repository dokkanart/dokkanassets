...
-- ** エフェクト等 ** --
aura = entryEffectLife( SP_start+  70,   311, 99, 0x40,  0,  1,  0,  -30); -- オーラ
...
kamehame_beam = entryEffectLife( SP_start+ 260, SP_02, 109, 0x40,  0,  300,  250,  150);   -- 伸びるかめはめ波
...
entryFadeBg( SP_start+ 370, 0, 99, 0, 10, 10, 10, 220);          -- ベース暗め　背景
...
SP_dodge = 371; --エンドフェイズのフレーム数を置き換える
...
entryEffectLife( SP_start+ 290, 920, 79, 0x80,  -1,  0,  0,  0); -- 流線
