...
playSe( 455, SE_09);
-- 敵吹っ飛ぶモーション
changeAnime( 428, 1, 108);
setMoveKey(  428, 1,  120,    0,  0);
entryFade( 429, 0,  3, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
setMoveKey(  431,    1,   120,  40,   0);
setMoveKey(  436, 1,  240,    340,  10);
setScaleKey( 431, 1,  1.6, 1.6);
--setScaleKey( 431, 1,  1.5, 1.5);
setScaleKey( 436, 1,  0.2, 0.2);
...
entryFade( 448, 6,  15, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
bgeff = entryEffect( tyo+70,   1503,   0x80,  0,  0,  0,  0);   -- eff_004 ( tyo2+気)
setEffScaleKey( tyo+70, bgeff, 1.2, 1.2);

bgeff2 = entryEffect( tyo+70,   1502,   0,     0,  0,  0,  0);   -- eff_003 ( tyo2+気)
setEffScaleKey( tyo+70, bgeff2, 1.2, 1.2);
...
kame_hand = entryEffectLife( 1, SP_01, 120,0x40,  0, 300,  0,  0);   -- 手のカメハメ波部
...
-- ** エフェクト等 ** --
--entryFlash( tyo2+170+10, 1, fcolor_r, fcolor_g, fcolor_b, 200);
--entryFlash( tyo2+170+22, 1, fcolor_r, fcolor_g, fcolor_b, 200);
--entryFlash( tyo2+170+36, 1, fcolor_r, fcolor_g, fcolor_b, 200);
--entryFlash( tyo2+170+50, 1, fcolor_r, fcolor_g, fcolor_b, 200);
--entryFlash( tyo2+170+64, 1, fcolor_r, fcolor_g, fcolor_b, 200);
...
entryEffectLife( tyo2+260, 920, 109, 0x80,  -1,  0,  0,  0); -- 流線
...
-- 敵吹っ飛ぶモーション
changeAnime( tyo2+428, 1, 108);
setMoveKey( tyo2+428, 1,  120,    0,  0);
entryFade( tyo2+429, 0,  3, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
setMoveKey(  tyo2+431,    1,   120,  40,   0);
setMoveKey(  tyo2+436, 1,  255,    340,  10);
setScaleKey( tyo2+431, 1,  1.6, 1.6);
--setScaleKey( tyo2+431, 1,  1.5, 1.5);
setScaleKey( tyo2+436, 1,  0.2, 0.2);

-- ** エフェクト等 ** --
setShakeChara( tyo2+370, 1, 99, 20);

entryFadeBg( tyo2+370, 0, 99, 0, 10, 10, 10, 150);          -- ベース暗め　背景

entryEffectLife( tyo2+370, 921, 99, 0x80,  -1,  0,  0,  0); -- 流線斜め

--entryFlash( tyo2+370+10, 1, fcolor_r, fcolor_g, fcolor_b, 200);
--entryFlash( tyo2+370+22, 1, fcolor_r, fcolor_g, fcolor_b, 200);
--entryFlash( tyo2+370+36, 1, fcolor_r, fcolor_g, fcolor_b, 200);
--entryFlash( tyo2+370+50, 1, fcolor_r, fcolor_g, fcolor_b, 200);
--entryFlash( tyo2+370+64, 1, fcolor_r, fcolor_g, fcolor_b, 200);
--entryFlash( tyo2+370+80, 1, fcolor_r, fcolor_g, fcolor_b, 200);
...
entryFade( tyo2+448, 6,  17, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
SP_dodge = 185+200; --エンドフェイズのフレーム数を置き換える
...
setMoveKey( tyo2+469,    1,  255,    360,  50);
