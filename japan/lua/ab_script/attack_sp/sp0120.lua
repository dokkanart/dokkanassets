...
kame_hand = entryEffect( 70, SP_01, 0x40,   0,  300,  10,  20);   -- 手のカメハメ波部
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  110,  0);   -- 伸びるかめはめ波
...
kame_hand = entryEffectLife( SP_ATK_0, SP_01, 72, 0x40, 0,  300,  -10,  20);   -- 手のカメハメ波部
...
kamehame_beam_st = entryEffectLife( SP_ATK_2+1, SP_02, 4, 0x40,  0,  300,  220,  0);   
kamehame_beam = entryEffectLife( SP_ATK_2+1, SP_02, 90, 0x40,  0,  300,  110,  0);   -- 伸びるかめはめ波
