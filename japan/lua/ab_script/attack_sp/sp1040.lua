...
kintoun = entryEffectLife(  spep_6,   SP_04, 48, 0x40+0x080,  0,  1,  -145,  -97); -- キン斗雲
setEffScaleKey( spep_6, kintoun, 2.6, 1.2);

--kintoun = entryEffect(  spep_6,   SP_04,   0x80,  -1,  0,  0,  0);   -- eff_004 (気)
--setEffAlphaKey(spep_6, kintoun, 255);
--setEffScaleKey( spep_6, kintoun, 1.0, 1.0);
...
--[[
-- 書き文字エントリー
ct3 = entryEffectLife( spep_6+83, 10021, 52, 0, -1, 0, 200, 300); -- バゴォッ
setEffShake(spep_6+70, ct3, 32, 5);
setEffAlphaKey(spep_6+70, ct3, 255);
setEffAlphaKey(spep_6+76, ct3, 0);
--setEffAlphaKey(spep_6+80, ct, 0);
setEffScaleKey(spep_6+68, ct3, 0.0, 0.0);
setEffScaleKey(spep_6+72, ct3, 1.8, 1.8);
--setEffScaleKey(spep_6+70, ct, 1.8, 1.8);
setEffScaleKey(spep_6+76, ct3, 6.0, 6.0);
--]]
...
-- 書き文字エントリー
ct = entryEffectLife( spep_6+60, 150083, 52, 0, -1, 0, 30, 300); -- グー
--setEffRotateKey( spep_6+60, ct, 180);
--setEffRotateKey( spep_6+60, ct, -180);

--[[
if (_IS_PLAYER_SIDE_ == 0) then
setEffScaleKey( spep_6+60, ct, -1.8, 1.8);
else
setEffScaleKey( spep_6+60, ct, 1.8, 1.8);
end
--]]
--setEffRotateKey(spep_6+60, ct, -30);
--[[
setEffAlphaKey(spep_6+60, ct, 255);
setEffAlphaKey(spep_6+60+20, ct, 255);
setEffAlphaKey(spep_6+60+30, ct, 0);
--]]
setEffShake(spep_6+60, ct, 32, 5);
setEffAlphaKey(spep_6+60, ct, 255);
setEffAlphaKey(spep_6+72, ct, 255);
...
-- 書き文字エントリー
ct2 = entryEffectLife( spep_6+76+25, 150082, 52, 0, -1, 0, 30, 300); -- チョキ
--setEffRotateKey( spep_6+76, ct2, 180);
--setEffRotateKey( spep_6+76, ct2, -180);

--[[
if (_IS_PLAYER_SIDE_ == 0) then
setEffScaleKey( spep_6+76+25, ct2, -1.8, 1.8);
else
setEffScaleKey( spep_6+76+25, ct2, 1.8, 1.8);
end
-]]
--setEffRotateKey(spep_6+76+25, ct2, -30);
--[[
setEffAlphaKey(spep_6+76+25, ct2, 255);
setEffAlphaKey(spep_6+76+25+20, ct2, 255);
setEffAlphaKey(spep_6+76+25+30, ct2, 0);
--]]
...
-- 書き文字エントリー
ct3 = entryEffectLife( spep_6+90+50, 150081, 52, 0, -1, 0, 30, 300); -- パー
--setEffRotateKey( spep_6+90, ct3, 180);
--setEffRotateKey( spep_6+90, ct3, -180);
...
--[[
if (_IS_PLAYER_SIDE_ == 0) then
setEffScaleKey( spep_6+90+50, ct3, -1.8, 1.8);
else
setEffScaleKey( spep_6+90+50, ct3, 1.8, 1.8);
end
--]]
--[[
setEffRotateKey(spep_6+90+50, ct3, -30);
setEffAlphaKey(spep_6+90+50, ct3, 255);
setEffAlphaKey(spep_6+90+50+20, ct3, 255);
setEffAlphaKey(spep_6+90+50+30, ct3, 0);
--]]
