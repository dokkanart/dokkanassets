...
-- 途中からカメハメハが伸びる
setMoveKey(  299,    0,   -350,  0,   0);
setMoveKey(  300,    0,   -350,  0,   0);
setMoveKey(  308,    0,   -1200,  0,   0);
...
kame_hand = entryEffectLife( SP_ATK_0+1, SP_01, 72, 0x40+0x80, 0,  300,  0,  0);   -- 手のカメハメ波部


-- ** エフェクト等 ** --
aura = entryEffectLife( SP_ATK_0,   311, 100, 0x40,  0,  1,  0,  0); -- オーラ
setEffScaleKey( SP_ATK_0, aura, 1.5, 1.5);
setEffScaleKey( SP_ATK_2+2, aura, 2.2, 2.2);
...
setShakeChara( SP_ATK_2+5, 0, 27, 50);
...
-- かめはめは迫る(100F)
------------------------------------------------------
kamehame_beam3 = entryEffect( SP_ATK_3, SP_03,   0, -1,  0,  100,  0);   -- 迫るかめはめ波
