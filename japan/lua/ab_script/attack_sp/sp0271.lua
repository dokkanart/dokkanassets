...
--SP_04 = 1556; 
SP_05 = 190002; --ギャン
SP_06 = 100321; --ガッチャン敵用
SP_07 = 1581; --地球からんちゃ砲
SP_07e = 1582; --地球からんちゃ砲
SP_02e = 100338; --敵用発射
SP_03e = 100339; --敵用迫る
...
kamehame_beam_st = entryEffectLife( spep_3, SP_02, 94, 0x40+0x100,  0,  300,  110,  0);   -- 伸びるかめはめ波

kamehame_beam = entryEffectLife( spep_3, SP_02, 108, 0x40+0x80,  0,  300,  110,  0);   -- 伸びるかめはめ波
...
kamehame_beam2 = entryEffect( spep_4, SP_03,   0x80, -1,  0,  100,  0);   -- 迫るかめはめ波
...
kaihi1 = entryEffectUnpausable(  SP_dodge,   1575,  0x100,     -1,  0,  0,  300);   -- 回避の文字表示
setEffScaleKey( SP_dodge, kaihi1, 1.0, 1.0);
setEffAlphaKey( SP_dodge, kaihi1, 255);

pauseAll( SP_dodge, 67);

entryFade( SP_dodge+1, 4,  7, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
bakuhatu = entryEffect( spep_5, SP_07, 0,  -1,  0,  0,  0);  
setDisp( spep_5, 1, 0);
...
kamehame_beam_st = entryEffectLife( spep_3, SP_02e, 94, 0x40+0x100,  0,  300,  110,  0);   -- 伸びるかめはめ波

--setEffScaleKey( spep_3, kamehame_beam_st, -1.0, 1.0);

kamehame_beam = entryEffectLife( spep_3, SP_02e, 108, 0x40+0x80,  0,  300,  110,  0);   -- 伸びるかめはめ波
...
dodge = entryEffectUnpausable(  SP_dodge,   1575,  0x100,     -1,  0,  0,  300);   -- 回避の文字表示
...
bakuhatu = entryEffect( spep_5, SP_07e, 0,  -1,  0,  0,  0);  
setDisp( spep_5, 1, 0);
setEffScaleKey( spep_5, bakuhatu, 1, 1);
