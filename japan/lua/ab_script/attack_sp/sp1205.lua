...
--エフェクト
Finish = entryEffect(  spep_7, 152068, 0x80, -1,0, 0, 0);
...
--エフェクト
Kidame=entryEffectLife(spep_0,SP_01x,48,0x100,-1,0,0,0);
...
--エフェクト
HonrouF = entryEffectLife(spep_1,SP_02x,258,0x100,-1,0,0,0);
...
HonrouB = entryEffectLife(spep_1,SP_03x,258,0x80,-1,0,0,0);
