...
-- ** エフェクト等 ** --
aura = entryEffectLife(  30,   311, 39, 0x40+0x80,  0,  1,  0,  -20); -- オーラ
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  70,   311, 99, 0x40+0x80,  0,  1,  0,  -20); -- オーラ
setEffScaleKey( 30, aura, 1.5, 1.5);
...
entryFade( 252, 2, 8, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryFade(tyo2+252, 4, 8, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
