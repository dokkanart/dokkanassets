...
setScaleKey( 260,   0, 0.5, 0.5);
setScaleKey( 270,   0, 1.0, 1.0);
...
setShakeChara( 270, 0, 40, 15);

kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  -20,  50);   -- 伸びるかめはめ波
setEffScaleKey( 260, kamehame_beam, 0.5, 0.5);
setEffScaleKey( 270, kamehame_beam, 1.0, 1.0);
setEffScaleKey( 299, kamehame_beam, 1.0, 1.0);
setEffScaleKey( 300, kamehame_beam, 1.25, 1.25);
...
setMoveKey(  300,    0,   -150,  0,   0);
setMoveKey(  310,    0,   -700,  0,   80);
--setMoveKey(  308,    0,   -1100,  0,   0);
...
setMoveKey(  446, 1,  700,    0,  0);
setScaleKey( 432, 1,  1.6, 1.6);
setScaleKey( 425, 1,  1.5, 1.5);
setScaleKey( 445, 1,  0.2, 0.2);
...
-- カードカットイン(tyo2+90F)
------------------------------------------------------
setScaleKey(tyo2+169,   0, 1.0, 1.0);
...
setScaleKey( tyo2+259,   0, 1.0, 1.0);
setScaleKey( tyo2+260,   0, 0.5, 0.5);
setScaleKey( tyo2+270,   0, 1.0, 1.0);
...
setShakeChara( tyo2+270, 0, 40, 15);

kamehame_beam = entryEffectLife(tyo2+260, SP_02, 109, 0x40,  0,  300,  0,  0);   -- 伸びるかめはめ波
playSe(tyo2+260, SE_07);
setEffScaleKey( tyo2+260, kamehame_beam, 0.5, 0.5);
setEffScaleKey( tyo2+270, kamehame_beam, 1.0, 1.0);
setEffScaleKey( tyo2+299, kamehame_beam, 1.0, 1.0);
setEffScaleKey( tyo2+300, kamehame_beam, 1.25, 1.25);
...
setEffScaleKey(tyo2+260, sen2, 1.3, 1.3);
...
playSe(tyo2+432, SE_09);
-- 敵吹っ飛ぶモーション
changeAnime(tyo2+432, 1, 108);
setMoveKey(tyo2+432, 1,  120,    0,  0);
setMoveKey(tyo2+446, 1,  400,    0,  0);
setScaleKey(tyo2+432, 1,  1.6, 1.6);
setScaleKey(tyo2+435, 1,  1.5, 1.5);
setScaleKey(tyo2+445, 1,  0.2, 0.2);
