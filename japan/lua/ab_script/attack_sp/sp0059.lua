...
ct = entryEffectLife( 80 + 16, 190006, 39, 0x100, -1, 0, 100.9, 515.5 + 10);    -- ゴゴゴ・・・
setEffShake( 16 + 80, ct, 64, 10 );

setEffMoveKey( 16 + 80, ct, 100.9, 515.5 + 10 , 0 );
setEffMoveKey( 80 + 80, ct, 100.9, 515.5 + 10 , 0 );

setEffScaleKey( 16 + 80, ct, 0.7, 0.7 );
setEffScaleKey( 72 + 80, ct, 0.7, 0.7 );
setEffScaleKey( 74 + 80, ct, 1.0, 1.0 );
setEffScaleKey( 76 + 80, ct, 1.09, 1.09 );
setEffScaleKey( 78 + 80, ct, 1.39, 1.39 );
setEffScaleKey( 80 + 80, ct, 1.69, 1.69 );

setEffRotateKey( 16 + 80, ct, 0 );
setEffRotateKey( 80 + 80, ct, 0 );

setEffAlphaKey( 16 + 80, ct, 255 );
setEffAlphaKey( 80 + 80, ct, 255 );
------------------------------------------------------
-- カードカットイン(90F)
------------------------------------------------------
...
entryFade( 452, 6,  17, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade<br />
...
kame_hand = entryEffect( 6, SP_01, 0x40+0x80,   0,  300,  0,  0);   -- 手のカメハメ波部
...
ct = entryEffectLife( tyo2 +80 + 16, 190006, 39, 0x100, -1, 0, 100.9, 515.5 + 10);    -- ゴゴゴ・・・
setEffShake( tyo2 +16 + 80, ct, 64, 10 );

setEffMoveKey( tyo2 +16 + 80, ct, 100.9, 515.5 + 10 , 0 );
setEffMoveKey( tyo2 +80 + 80, ct, 100.9, 515.5 + 10 , 0 );

setEffScaleKey( tyo2 +16 + 80, ct, -0.7, 0.7 );
setEffScaleKey( tyo2 +72 + 80, ct, -0.7, 0.7 );
setEffScaleKey( tyo2 +74 + 80, ct, -1.0, 1.0 );
setEffScaleKey( tyo2 +76 + 80, ct, -1.09, 1.09 );
setEffScaleKey( tyo2 +78 + 80, ct, -1.39, 1.39 );
setEffScaleKey( tyo2 +80 + 80, ct, -1.69, 1.69 );

setEffRotateKey( tyo2 +16 + 80, ct, 0 );
setEffRotateKey( tyo2 +80 + 80, ct, 0 );

setEffAlphaKey( tyo2 +16 + 80, ct, 255 );
setEffAlphaKey( tyo2 +80 + 80, ct, 255 );
------------------------------------------------------
-- カードカットイン(tyo2+90F)
------------------------------------------------------
...
setMoveKey(tyo2+305,    0,   -600,  0,   80);
--setMoveKey(tyo2+308,    0,   -1100,  0,   0);
...
SP_dodge = 185+225; --エンドフェイズのフレーム数を置き換える
...
setEffScaleKey( tyo2+469, bom, 1.1, 1.1);
