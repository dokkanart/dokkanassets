...
entryFadeBg( SP_ATK01, 0, 36, 0,  146, 23, 142, 150);         -- ベース暗め　背景
...
setEffScaleKey( SP_ATK01+35, eff01,1,1);--サイズ
...
entryFadeBg( SP_ATK01+35, 0, 66, 0,  146, 23, 142, 255);         -- ベース暗め　背景
...
setEffScaleKey( SP_ATK01+43+diff01, eff02,1.2,1.2);--サイズ
...
setEffScaleKey( SP_ATK01+50+diff01, eff02,1.5,1.5);--サイズ
...
setEffScaleKey( SP_ATK01+57+diff01, eff03, 1.8,1.8);--サイズ
...
setEffScaleKey( SP_ATK01+65+diff01, eff04, 2,2);--サイズ
...
setEffScaleKey( SP_ATK01+72+diff01, eff05, 2.2,2.2);--サイズ
...
setEffScaleKey( SP_ATK01+76+diff01, eff06, 2.5,2.5);--サイズ
...
setEffScaleKey( SP_ATK01+80+diff01, eff07, 2.8,2.8);--サイズ
...
setEffScaleKey( SP_ATK01+91+diff01+diff02, eff08, 3,4);--サイズ
...
entryFadeBg( SP_ATK01+92+diff01+diff02, 0, 35, 0,  146, 23, 142, 255);         -- ベース暗め　背景       -- ベース暗め　背景
...
setShakeChara( SP_ATK02+16, 1, 5,  10);
setShakeChara( SP_ATK02+21, 1, 10, 20);
setShake(SP_ATK02+15,6,15);
setShake(SP_ATK02+21,15,9);
-- 書き文字エントリー
ct = entryEffectLife( SP_ATK02+16, 10005, 100, 0, -1, 0, -50, 230); -- ガッ
setEffShake(SP_ATK02+16, ct, 30, 10);
setEffRotateKey( SP_ATK02+16, ct, -40);
