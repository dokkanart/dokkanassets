...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  -70,  30);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);

entryFade( 170 -8, 2, 4, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
kamehame_beam = entryEffect( 260, SP_02, 0x40,  0,  300,  120,  0);   -- 伸びるかめはめ波
playSe( 260, SE_07);
...
kame_hand = entryEffect( tyo+71, SP_01, 0x40+0x80,   0,  300,  -40,  20);   -- 手のカメハメ波部
--setEffScaleKey( tyo+71, kame_hand, 0.5, 0.5);

entryFade( tyo2+170 -8, 2, 4, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
kamehame_beam = entryEffect(tyo2+260, SP_02, 0x40,  0,  300,  120,  0);   -- 伸びるかめはめ波
