...
setEffMoveKey( 100, kidame1, 0, 0 , 0 );
setEffScaleKey( 70, kidame1, 1, 1 );
setEffScaleKey( 100, kidame1, 1, 1 );
setEffRotateKey( 70, kidame1, 0 );
setEffRotateKey( 100, kidame1, 0 );
setEffAlphaKey( 70, kidame1, 255 );
setEffAlphaKey( 100, kidame1, 255 );

setEffMoveKey( 70, kidame2, 0, 0 , 0 );
setEffMoveKey( 100, kidame2, 0, 0 , 0 );
setEffScaleKey( 70, kidame2, 1, 1 );
setEffScaleKey( 100, kidame2, 1, 1 );
setEffRotateKey( 70, kidame2, 0 );
setEffRotateKey( 100, kidame2, 0 );
setEffAlphaKey( 70, kidame2, 255 );
setEffAlphaKey( 100, kidame2, 255 );
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  70,   311, 100, 0x40,  0,  1,  0,  0); -- オーラ
--aura = entryEffectLife(  70,   311, 95, 0x40,  0,  1,  0,  0); -- オーラ
--setEffScaleKey( 30, aura, 1.5, 1.5);
setEffMoveKey( 70, aura, 0, 0 , 0 );
setEffMoveKey( 100, aura, 0, 0 , 0 );
setEffScaleKey( 70, aura, 1.5, 1.5);
setEffScaleKey( 100, aura, 1.5, 1.5);
setEffRotateKey( 70, aura, 0 );
setEffRotateKey( 100, aura, 0 );
setEffAlphaKey( 70, aura, 255 );
setEffAlphaKey( 100, aura, 255 );
...
setEffScaleKey( SP_ATK01+35, eff01,2,2);--サイズ
...
setEffScaleKey( SP_ATK01+50+diff01, eff02,2,3);--サイズ
...
setEffScaleKey( SP_ATK01+65+diff01, eff04, 3,2);--サイズ
...
setEffScaleKey( SP_ATK01+76+diff01, eff06, 1,2);--サイズ
...
setEffScaleKey( SP_ATK01+80+diff01, eff07, 2,1.5);--サイズ
...
entryFade( SP_ATK01+100+diff01+10, 3, 5, 4, fcolor_r, fcolor_g, fcolor_b, 100); 

entryFade( SP_ATK01+115+diff01+10, 4, 12, 4, fcolor_r, fcolor_g, fcolor_b, 255); 
...
setMoveKey(  SP_ATK02,    1,  100,  0,   0);
setScaleKey( SP_ATK02,    1,  1.0, 1.0);
...
-- 書き文字エントリー
ct = entryEffectLife( SP_ATK02+15, 10005, 95, 0, -1, 0, -50, 230); -- ガッ
...
entryFade( 0, 2, 4, 8, fcolor_r, fcolor_g, fcolor_b, 100);     -- white fade
------------------------------------------------------
-- かめはめ波溜め！(100F)
------------------------------------------------------
...
--entryFade( SP_ATK_1+38, 3, 4, 4, fcolor_r, fcolor_g, fcolor_b, 100);     -- white fade
setEffScaleKey(	SP_ATK_1,cr, 1,1);
setEffScaleKey(	SP_ATK_2,cr, 1,1);
