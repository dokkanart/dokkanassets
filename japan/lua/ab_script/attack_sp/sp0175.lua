...
setEffScaleKey( 30, aura, 1.5, 1.5);
setShakeChara( 70, 0, 99, 10);
setShake( 70, 99, 5);

setEffAlphaKey( 70, aura, 150);

kame_hand = entryEffect( 70, SP_01, 0x40+0x100,      0,  300,  -20,  200);   -- 手のカメハメ波部
...
kamehame_beam2 = entryEffect( 370, SP_03,   0, -1,  0,  -130,  0);   -- 迫るかめはめ波
...
cut = entryEffect( 455, SP_04,   0, -1,  0,  0,  0);   -- 切れ痕
setEffScaleKey(370, cut, 0.8, 0.8);
setEffRotateKey(370, cut, 25);
...
kame_hand = entryEffect( 70, SP_01, 0x40+0x100,      0,  300,  0,  200);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);
...
kamehame_beam = entryEffectLife( 260, SP_05, 109, 0x40,  0,  300,  0,  0);   -- 伸びるかめはめ波
