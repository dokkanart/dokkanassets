...
SP_01 = 150124; --突進アラレちゃん
SP_02 = 150125; --走るアラレちゃん
SP_02e = 150129;
SP_03 = 150128; --BACOOM
SP_04 = 150120; --突進ガッチャン
SP_05 = 150121; --突進ガッチャン2
SP_06 = 150122; --ビリビリガッチャン
SP_07 = 150123; --ビリビリエフェクト
...
SP_ATK_0 = 260;
SP_ATK_1 = SP_ATK_0+55; --315
SP_ATK_2 = SP_ATK_1+60; --375
SP_ATK_3 = SP_ATK_2+330;
...
gacchan1 = entryEffectLife( SP_start+SP_ATK_0, SP_04, 55, 0x100,  -1,  0,  0,  -50);   -- 伸びるかめはめ波 --58
playSe( SP_start+SP_ATK_0, SE_06);

entryEffectLife( SP_start+SP_ATK_0, 906, 55, 0x00,  -1, 0,  0,  0);   -- 集中線

entryFade( SP_start+SP_ATK_0+48, 7, 5, 3, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
gacchan2 = entryEffectLife( SP_start+SP_ATK_1+2, SP_05, 57, 0x100,  -1,  0,  0,  -50);   -- 伸びるかめはめ波
playSe( SP_start+SP_ATK_1+2, SE_06);

entryFadeBg( SP_start+SP_ATK_1, 4, 50, 4, 10, 10, 10, 150);          -- ベース暗め　背景
sen2 = entryEffectLife( SP_start+SP_ATK_1, 921, 57, 0x80,  -1,  0,  0,  0); -- 流線斜め
setEffRotateKey(SP_start+SP_ATK_1, sen2, 200);
setEffScaleKey(SP_start+SP_ATK_1, sen2, 1.4, 1.4);

entryFade( SP_start+SP_ATK_1+50, 7, 10, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
setDisp( SP_start+SP_ATK_2, 1, 1);
changeAnime( SP_start+SP_ATK_2, 1, 100);                        -- 立ち
setMoveKey(  SP_start+SP_ATK_2,    1,   150,  -250,   0);
setScaleKey( SP_start+SP_ATK_2,   1,   1.5,  1.5);
changeAnime( SP_start+SP_ATK_2+58, 1, 106);
setRotateKey( SP_start+SP_ATK_2+58,  1,  -65 );
setShakeChara( SP_start+SP_ATK_2+58 ,1 ,60 ,10);
--playSe( SP_start+SP_ATK_2, SE_06);

gacchan3 = entryEffectLife( SP_start+SP_ATK_2, SP_06, 115, 0x80,  -1,  0,  0,  -50);   -- 伸びるかめはめ波

entryEffectLife( SP_start+SP_ATK_2+58, 906, 60, 0x00,  -1, 0,  0,  0);   -- 集中線

gacchan4 = entryEffectLife( SP_start+SP_ATK_2+58, SP_07, 60, 0x100,  -1,  0,  50,  -50);   -- 伸びるかめはめ波
setEffAlphaKey(SP_start+SP_ATK_2+58, gacchan4, 190);
playSe( SP_start+SP_ATK_2+58, 1049);
biribiri = playSe( SP_start+SP_ATK_2+58, 1050);

entryFade( SP_start+SP_ATK_2+110, 7, 10, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
stopSe(SP_start+SP_ATK_2+110,1050,0)


setRotateKey( SP_start+SP_ATK_2+110,  1,  -65 );



stopSe(SP_start+SP_ATK_2+110,biribiri,5);
...
setDisp( SP_start9+SP_start+SP_ATK_2+260, 1, 0);

setDisp( SP_start9+SP_start+SP_ATK_2+260, 0, 0);

setScaleKey(   SP_start9+SP_start+SP_ATK_2+260,   0, 0.7, 0.7);

changeAnime( SP_start9+SP_start+SP_ATK_2+260, 0, 31);                                    -- かめはめ発射ポーズ
...
playSe( SP_start9+SP_start+SP_ATK_2+260, SE_06);
--playSe( SP_start9+SP_start+SP_ATK_2+261, 1044);
--setScaleKey( 306,0,3,3);
--setMoveKey(  SP_start+333,  0, 1700,  0,   0);
--setMoveKey(  SP_start+334,  0, -1700,  0,   0);

setShakeChara( SP_start9+SP_start+SP_ATK_2+270, 0, 35, 30);

--entryEffectLife( SP_start+260, 920, 80, 0x80,  -1,  0,  0,  0); -- 流線

kamehame_beam = entryEffectLife( SP_start9+SP_start+SP_ATK_2+262, SP_01, 60, 0x100,  -1,  0,  0,  -50);   -- 伸びるかめはめ波
...
spname = entryEffect( SP_start9+SP_start+SP_ATK_2+260, 1508,  0,  -1,  0,  0,  0);               -- かめはめ波文字
...
shuchusen = entryEffectLife( SP_start9+SP_start+SP_ATK_2+260, 906, 60, 0x00,  -1, 0,  0,  0);   -- 集中線
...
-- 書き文字エントリー
ct = entryEffectLife( SP_start9+SP_start+SP_ATK_2+268, 10012, 32, 0, -1, 0, 200, 300); -- ズオッ
setEffShake(SP_start9+SP_start+SP_ATK_2+268, ct, 32, 5);
setEffAlphaKey(SP_start9+SP_start+SP_ATK_2+268, ct, 255);
setEffAlphaKey(SP_start9+SP_start+SP_ATK_2+290, ct, 255);
setEffAlphaKey(SP_start9+SP_start+SP_ATK_2+300, ct, 0);
setEffScaleKey(SP_start9+SP_start+SP_ATK_2+268, ct, 0.0, 0.0);
setEffScaleKey(SP_start9+SP_start+SP_ATK_2+272, ct, 1.3, 1.3);
setEffScaleKey(SP_start9+SP_start+SP_ATK_2+290, ct, 1.3, 1.3);
setEffScaleKey(SP_start9+SP_start+SP_ATK_2+300, ct, 6.0, 6.0);

setEffAlphaKey(	SP_start9+SP_start+SP_ATK_2+308,spname, 1);
--playSe( SP_start9+SP_start+SP_ATK_2+300, SE_06);
entryFade( SP_start9+SP_start+SP_ATK_2+310, 7, 10, 10, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- かめはめは迫る(100F)
------------------------------------------------------
setDisp( SP_start9+SP_start+SP_ATK_3-1, 1, 1);

setDisp( SP_start9+SP_start+SP_ATK_3-1, 0, 0);
setShakeChara( SP_start9+SP_start+SP_ATK_3-6 ,1 ,60 ,10);
--entryEffect( SP_ATK_3+20, SP_03,   0x40, 0,  0,  0,  0);   -- 迫るかめはめ波
kamehame_beam3 = entryEffectLife( SP_start9+SP_start+SP_ATK_3-6, SP_02, 85, 0x80, -1, 0, 0, -50);
--setEffScaleKey(SP_start+SP_ATK_3, kamehame_beam3, 3.0, 3.0);
--setEffRotateKey(SP_start+SP_ATK_3, kamehame_beam3, 85);
--playSe( SP_start9+SP_start+SP_ATK_3, SE_08);
...
gacchan5 = entryEffectLife( SP_start9+SP_start+SP_ATK_3-6, SP_07, 70, 0x100,  -1,  0,  50,  -50);   -- 伸びるかめはめ波
setEffAlphaKey(SP_start9+SP_start+SP_ATK_3-6, gacchan5, 180);

setDisp( SP_start9+SP_start+SP_ATK_3-7, 1, 1);
changeAnime( SP_start9+SP_start+SP_ATK_3-7, 1, 106);                        -- 立ち
setMoveKey(  SP_start9+SP_start+SP_ATK_3-7,    1,   150,  -250,   0);
setScaleKey( SP_start9+SP_start+SP_ATK_3-7,   1,   1.5,  1.5);
setRotateKey( SP_start9+SP_ATK_3+20+40,  1,  -65 );



playSe( SP_start9+SP_start+SP_ATK_3-7+47, SE_06);


--setMoveKey(  SP_start+SP_ATK_3+15,    1,   700,  0,   0);

--playSe( SP_start9+SP_start+SP_ATK_3+12, SE_06);

--entryFade( SP_ATK_3+27, 10,  3, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

--playSe( SP_start9+SP_start+SP_ATK_3+27, SE_09);
-- 敵吹っ飛ぶモーション
...
-- 書き文字エントリー
ct = entryEffectLife( SP_start9+SP_start+SP_ATK_3, 10014, 99, 0, -1, 0, -100, 255); -- ズドドッ
setEffShake(SP_start9+SP_start+SP_ATK_3, ct, 99, 20);
setEffScaleKey( SP_start9+SP_start+SP_ATK_3, ct, 2.4, 2.4);
setEffRotateKey(SP_start9+SP_start+SP_ATK_3, ct, 70);
setEffAlphaKey(SP_start9+SP_start+SP_ATK_3, ct, 255);
setEffAlphaKey(SP_start9+SP_start+SP_ATK_3+20+5, ct, 255);
setEffAlphaKey(SP_start9+SP_start+SP_ATK_3+35+5, ct, 255);
setEffAlphaKey(SP_start9+SP_start+SP_ATK_3+40+5, ct, 0);
...
setMoveKey(  SP_start9+SP_start+SP_ATK_4-10,    1,   150,  -250,   0);
setScaleKey( SP_start9+SP_start+SP_ATK_4-10,   1,   1.5,  1.5);

setShakeChara(SP_start9+SP_start+SP_ATK_3+85,0,30,14);
setShakeChara(SP_start9+SP_start+SP_ATK_3+85,1,30,11);

entryEffectLife( SP_start9+SP_start+SP_ATK_3, 906, 50, 0x00,  -1, 0,  0,  0);   -- 集中線
...
kamehame_beam4 = entryEffectLife( SP_start9+SP_ATK_3+20, SP_03, 50, 0x100, -1, 0, 0, 0);
--stopSe(SP_start9+SP_ATK_3+18,1044,1)
playSe( SP_start9+SP_ATK_3+20, SE_09);

entryFade( SP_start9+SP_ATK_3+20+40, 4,  8, 5, 255, 255, 255, 255);     -- white fade


------------------------------------------------------
-- 爆発 (110F)
------------------------------------------------------
setDisp( SP_start9+SP_start+SP_ATK_4, 1, 1);
setDisp( SP_start9+SP_start+SP_ATK_4, 0, 0);
setScaleKey( SP_start9+SP_start+SP_ATK_4, 0, 0.7, 0.7);
setScaleKey( SP_start9+SP_start+SP_ATK_4+1, 0, 1.0, 1.0);

setMoveKey(  SP_start9+SP_start+SP_ATK_4,    1,  50,    0,  -120);
setScaleKey( SP_start9+SP_start+SP_ATK_4,    1,  1.0, 1.0);
setMoveKey(  SP_start9+SP_start+SP_ATK_4+1,    1,    0,   0,   128);
setScaleKey( SP_start9+SP_start+SP_ATK_4+1,    1,  0.1, 0.1);

changeAnime( SP_start9+SP_start+SP_ATK_4+1, 1, 107);-- 手前ダメージ
entryEffect( SP_start9+SP_start+SP_ATK_4+1, 1509,  0x80,  -1,  0,  0,  0);   -- 爆発
playSe( SP_start9+SP_start+SP_ATK_4+1, SE_10);

setMoveKey(  SP_start9+SP_start+SP_ATK_4+8,    1,    0,   0,   128);
setMoveKey(  SP_start9+SP_start+SP_ATK_4+15,   1,  -60,  -200,  -100);
setMoveKey(  SP_start9+SP_start+SP_ATK_4+16,   1,  -60,  -200,  -100);

setRotateKey( SP_start9+SP_start+SP_ATK_4,  1,  30 );
setRotateKey( SP_start9+SP_start+SP_ATK_4+2,  1,  80 );
setRotateKey( SP_start9+SP_start+SP_ATK_4+4,  1, 120 );
setRotateKey( SP_start9+SP_start+SP_ATK_4+6,  1, 160 );
setRotateKey( SP_start9+SP_start+SP_ATK_4+8,  1, 200 );
setRotateKey( SP_start9+SP_start+SP_ATK_4+10,  1, 260 );
setRotateKey( SP_start9+SP_start+SP_ATK_4+12,  1, 320 );
setRotateKey( SP_start9+SP_start+SP_ATK_4+14,  1,   0 );

setShakeChara( SP_start9+SP_start+SP_ATK_4+15, 1, 5,  10);
setShakeChara( SP_start9+SP_start+SP_ATK_4+20, 1, 10, 20);
setShake(SP_start9+SP_start+SP_ATK_4+14,6,15);
setShake(SP_start9+SP_start+SP_ATK_4+20,15,10);
-- 書き文字エントリー
ct = entryEffectLife( SP_start9+SP_start+SP_ATK_4+15, 10005, 100, 0, -1, 0, -50, 230); -- ガッ
setEffShake( SP_start9+SP_start+SP_ATK_4+15, ct, 30, 10);
setEffRotateKey( SP_start9+SP_start+SP_ATK_4+15, ct, -40);
setEffScaleKey( SP_start9+SP_start+SP_ATK_4+15, ct, 4.0, 4.0);
setEffScaleKey( SP_start9+SP_start+SP_ATK_4+16, ct, 2.0, 2.0);
setEffScaleKey( SP_start9+SP_start+SP_ATK_4+17, ct, 2.6, 2.6);
setEffScaleKey( SP_start9+SP_start+SP_ATK_4+18, ct, 4.0, 4.0);
setEffScaleKey( SP_start9+SP_start+SP_ATK_4+19, ct, 2.6, 2.6);
setEffScaleKey( SP_start9+SP_start+SP_ATK_4+20, ct, 3.8, 3.8);
setEffScaleKey( SP_start9+SP_start+SP_ATK_4+110, ct, 3.8, 3.8);
setEffAlphaKey( SP_start9+SP_start+SP_ATK_4+15, ct, 255);
setEffAlphaKey( SP_start9+SP_start+SP_ATK_4+105, ct, 255);
setEffAlphaKey( SP_start9+SP_start+SP_ATK_4+115, ct, 0);

playSe( SP_start9+SP_start+SP_ATK_4+3, SE_11);
shuchusen = entryEffectLife( SP_start9+SP_start+SP_ATK_4, 906, 120, 0x00,  -1, 0,  0,  0);   -- 集中線
entryEffect( SP_start9+SP_start+SP_ATK_4+3, 1600,  0x00,  -1,  0,30, -130);   -- ひび割れ

-- ダメージ表示
dealDamage(SP_start9+SP_start+SP_ATK_4+10);

entryFade( SP_start9+SP_start+SP_ATK_4+100, 9,  10, 1, 8, 8, 8, 255);             -- black fade

endPhase(SP_start9+SP_start+SP_ATK_4+110);
...
gacchan1 = entryEffectLife( SP_start+SP_ATK_0, SP_04, 55, 0x100,  -1,  0,  0,  -50);   -- 伸びるかめはめ波 --58
setEffScaleKey(	SP_start+SP_ATK_0,gacchan1, -1.0,1.0);
playSe( SP_start+SP_ATK_0, SE_06);
...
setEffAlphaKey(SP_start+SP_ATK_2+58, gacchan4, 190);
playSe( SP_start+SP_ATK_2+58, 1049);
playSe( SP_start+SP_ATK_2+58, 1050);
...
kamehame_beam = entryEffectLife( SP_start9+SP_start+SP_ATK_2+262, SP_01, 60, 0x100,  -1,  0,  0,  -50);   -- 伸びるかめはめ波
setEffScaleKey(	SP_start9+SP_start+SP_ATK_2+262,kamehame_beam, -1.0,1.0);
--setEffScaleKey(SP_start+260,kamehame_beam,2.0,2.0);
...
setShakeChara( SP_start9+SP_start+SP_ATK_3-6 ,1 ,60 ,10);
--entryEffect( SP_ATK_3+20, SP_03,   0x40, 0,  0,  0,  0);   -- 迫るかめはめ波
kamehame_beam3 = entryEffectLife( SP_start9+SP_start+SP_ATK_3-6, SP_02e, 85, 0x80, -1, 0, 0, -50);
--setEffScaleKey(SP_start+SP_ATK_3, kamehame_beam3, 3.0, 3.0);
--setEffRotateKey(SP_start+SP_ATK_3, kamehame_beam3, 85);
--playSe( SP_start9+SP_start+SP_ATK_3, SE_08);
--setEffMoveKey(  SP_start+SP_ATK_3,  kamehame_beam3, -1700,  0,   0);
...
kamehame_beam4 = entryEffectLife( SP_start9+SP_ATK_3+20, SP_03, 50, 0x100, -1, 0, 0, 0);
setEffScaleKey(	SP_start9+SP_ATK_3+20,kamehame_beam4, -1.0,1.0);
--stopSe(SP_start9+SP_ATK_3+18,1044,1)
playSe( SP_start9+SP_ATK_3+20, SE_09);
...
endPhase(SP_start9+SP_start+SP_ATK_4+120);
