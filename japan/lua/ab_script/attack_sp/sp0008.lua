...
SP_ATK_0 = 0;
SP_ATK_1 = SP_ATK_0+170;
SP_ATK_2 = SP_ATK_1+90;
...
entryFade( 260 - 8, 6, 6, 6, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
--気を貯める
--         frame, eff, atr,tgt, tag,  x, y
changeAnime( SP_ATK_0 + 30, 0, 17);                       -- 溜め!
entryEffect( SP_ATK_0 + 30,   1501,   0x80, -1,  0,  0,  0);    -- eff_002
entryEffect( SP_ATK_0 + 30,   1500,   0,    -1,  0,  0,  0);    -- eff_001
playSe( SP_ATK_0 + 30, SE_01);

entryFade( SP_ATK_0 + 62, 5, 4, 8, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
aura = entryEffectLife( SP_ATK_0 + 30,   311, 39, 0x40,  0,  1,  0,  0); -- オーラ
setEffScaleKey( SP_ATK_0 + 30, aura, 1.5, 1.5);
setShakeChara( SP_ATK_0 + 30, 0, 19, 5);

-- 書き文字エントリー
ct = entryEffectLife( SP_ATK_0 + 30, 10013, 39, 0, -1, 0, 0, 200); -- ズズンッ
setEffShake(SP_ATK_0 + 30, ct, 40, 7);
setEffAlphaKey(SP_ATK_0 + 30, ct, 255);
setEffAlphaKey(SP_ATK_0 + 50, ct, 255);
setEffAlphaKey(SP_ATK_0 + 70, ct, 0);
setEffScaleKey( SP_ATK_0 + 30, ct, 0.1, 0.1);
setEffScaleKey( SP_ATK_0 + 40, ct, 2.0, 2.0);
playSe( SP_ATK_0 + 30, SE_02);
------------------------------------------------------
-- かめはめ波溜め！(100F)
------------------------------------------------------
...
-- ** エフェクト等 ** --
aura = entryEffectLife( SP_ATK_0,   311, 73, 0x40,  0,  1,  0,  0); -- オーラ
setEffScaleKey( SP_ATK_0, aura, 1.5, 1.5);
setShakeChara( SP_ATK_0+40, 0, 49, 5);
]]

--setVisibleUI(SP_ATK_0 + 69, 0);
changeAnime( SP_ATK_0 + 70, 0, 30);                       -- 溜め!
playSe( SP_ATK_0 + 73, SE_03);

entryEffect(  SP_ATK_0 + 70,   1503,   0x80,  -1,  0,  0,  0);   -- eff_004 (気)
entryEffect(  SP_ATK_0 + 70,   1502,   0,     -1,  0,  0,  0);   -- eff_003 (気)
--speff = entryEffect(  SP_ATK_0 + 80,   1504,   0,     -1,  0,  0,  0);   -- eff_005 (カットイン)
--setEffReplaceTexture( speff, 3, 2);                           -- カットイン差し替え
--speff = entryEffect(  SP_ATK_0 + 80,   1505,   0,     -1,  0,  0,  0);   -- eff_006 (セリフ)
--setEffReplaceTexture( speff, 4, 5);                           -- セリフ差し替え

playSe( SP_ATK_0 + 80, SE_04);

kame_hand = entryEffect( SP_ATK_0 + 70, SP_01, 0x40+0x80,      0,  300,  0,  0);   -- 手のカメハメ波部
setEffScaleKey( SP_ATK_0 + 70, kame_hand, 0.5, 0.5);

entryFade( SP_ATK_0 + 165, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
aura = entryEffectLife(  SP_ATK_0 + 70,   311, 99, 0x40,  0,  1,  0,  0); -- オーラ
setEffScaleKey( SP_ATK_0 + 30, aura, 1.5, 1.5);
setShakeChara( SP_ATK_0 + 70, 0, 49, 5);

-- 書き文字エントリー
--[[ct = entryEffectLife( SP_ATK_0 + 90, 10008, 39, 0x100, -1, 0, -190, 300);    -- ゴゴゴ・・・
setEffShake(SP_ATK_0 + 90, ct, 40, 8);
setEffScaleKey(SP_ATK_0 + 90, ct, 1.4, 1.4);]]
...
entryFade( SP_ATK_2 - 8, 6, 6, 6, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
setEffAlphaKey( (SP_ATK_2+2), kamehame_beam, 255);
