...
setMoveKey(   0,   0,    0, -84,   0);
setMoveKey(   1,   0,    0, -84,   0);
...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  0,  75);   -- 手のカメハメ波部
...
kame_hand = entryEffect( SP_ATK_0, SP_01, 0x40, 0,  300,  0,  75);   -- 手のカメハメ波部
