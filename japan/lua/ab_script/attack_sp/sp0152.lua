...
kame_hand1 = entryEffect( 70, SP_01, 0x40,      0,  300,  -175,  30);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand1, 1.2, 1.2);

kame_hand2 = entryEffect( 70, SP_01, 0x40,      0,  300,  115, 50);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand2, 1.2, 1.2);
