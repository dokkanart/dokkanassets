...
entryFade( spep2+56, 2, 4, 2, fcolor_r, fcolor_g, fcolor_b,  180);     -- white fade
entryFade( spep2+78, 2, 4, 2, fcolor_r, fcolor_g, fcolor_b,  180);     -- white fade
...
entryFadeBg( spep2+27, 0, 120, 0, 0, 0, 0, 255);       -- ベース暗め　背景
entryFade( spep2+25, 2, 3, 2, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade
entryFade( spep2+56, 2, 4, 2, fcolor_r, fcolor_g, fcolor_b,  190);     -- white fade
entryFade( spep2+78, 2, 4, 2, fcolor_r, fcolor_g, fcolor_b,  190);     -- white fade
entryFade( spep2+133, 2, 7, 4, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade
------------------------------------------------------
-- カードカットイン(90F)(170-260F)
------------------------------------------------------
...
setEffAlphaKey( spep4,spname,255);
setEffAlphaKey( spep4+26,spname,255);
setEffAlphaKey( spep4+48,spname,0);                               -- 技名テクスチャ差し替え
