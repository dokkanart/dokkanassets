...
entryFade( Card+81, 7,  13, 5, 255, 255, 255, 255);     -- white fade
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  SP_ATK_2-4,   311, 26, 0x40,  0,  1,  120,  30); -- オーラ
setEffScaleKey( SP_ATK_2-4, aura, 1.8, 1.8);
setEffRotateKey(SP_ATK_2-4, aura, -30);
...
setScaleKey( SP_ATK_2,    1,  1.5, 1.5);
...
setMoveKey( SP_dodge+6, 0,  -100, 0,   0);
setMoveKey( SP_dodge+8, 0,  -1100, 0,   0);

setMoveKey( SP_dodge+8, 1,  50,  -10,   0);
...
--	kame_hand = entryEffectLife( SP_ATK_6, SP_05, 109, 0x40,  0,  300,  -120,  -20);   -- 溜め
	...
	kame_hand = entryEffect( SP_ATK_6, SP_05, 0x40,  0,  300,  200,  -200);   -- 溜め
	setEffScaleKey( SP_ATK_6, kame_hand, 2.0, 2.0);
	kamehame_beam = entryEffectLife( SP_start+ SP_ATK_6+40, SP_02, 113, 0x40,  0,  300,  180,  -180);   -- 伸びるかめはめ波
	
		else
		
	kame_hand = entryEffect( SP_ATK_6, SP_05, 0x40,  0,  300,  250,  -220);   -- 溜め
	setEffScaleKey( SP_ATK_6, kame_hand, 2.0, 2.0);
	kamehame_beam = entryEffectLife( SP_start+ SP_ATK_6+40, SP_02, 113, 0x40,  0,  300,  220,  -200);   -- 伸びるかめはめ波
	...
	-- 爆発 (110F)
	------------------------------------------------------
	bakuhatu = entryEffect( SP_ATK_8-1, SP_04, 0,  -1,  0,  0,  0);   -- 爆発
	setEffScaleKey( SP_ATK_8-1, bakuhatu, 1.1, 1.1);
