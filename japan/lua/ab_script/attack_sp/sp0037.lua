...
kamehame_beam = entryEffectLife( 260, SP_02, 109,0x40+0x80,  1,  0,  0,  0);


seId = playSe( 263, SE_07);
...
kamehame_beam2 = entryEffect( 370, SP_03,   0x80, 0,  0,  0,  0);   -- 迫るかめはめ波
...
changeAnime(  SP_dodge, 0, 1);
setMoveKey(  SP_dodge-1,    0,   -100,  0,   0);
setMoveKey(  SP_dodge,   0,    -5000,  -5000,  0);
setMoveKey(  SP_dodge+10,   0,    -5000,  -5000,  0);
setScaleKey( SP_dodge-1,   0, 1.0, 1.0);
setScaleKey( SP_dodge,   0, 1.5, 1.5);
setScaleKey( SP_dodge+10,   0, 1.5, 1.5);

--敵の位置

setDisp( SP_dodge+8, 1, 1);

changeAnime(  SP_dodge+9,    1,  104);
