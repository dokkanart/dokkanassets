...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  70,  100);   -- 手のカメハメ波部
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  520, 200);   -- 伸びるかめはめ波
...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  45,  110);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  520, 220);   -- 伸びるかめはめ波
