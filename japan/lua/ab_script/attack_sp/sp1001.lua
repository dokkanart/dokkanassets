...
entryFadeBg( 62, 5, 4, 8, fcolor_r, fcolor_g, fcolor_b, 250);     -- white fade

-- ** エフェクト等 ** --
aura = entryEffectLife(  30,   311, 39, 0x80,  -1,  0,  0,  -150); -- オーラ
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  70,   311, 95, 0x80,  -1,  0,  0,  -150); -- オーラ
setEffScaleKey( 30, aura, 1.5, 1.5);
setShakeChara( 70, 0, 49, 5);

-- 書き文字エントリー
ct = entryEffectLife( 90, 10008, 39, 0x100, -1, 0, -230, 300);    -- ゴゴゴ・・・
...
stopSe(SP_ATK01+60+diff01,seID,5);
...
stopSe(SP_ATK01+67+diff01,SE002,5);
...
stopSe(SP_ATK01+75+diff01,SE003,5);
...
stopSe(SP_ATK01+82+diff01,SE004,5);
...
stopSe(SP_ATK01+86+diff01,SE005,5);
...
stopSe(SP_ATK01+90+diff01,SE006,5);
...
--setEffReplaceTexture( speff, 3, 2);                           -- カットイン差し替え
--speff = entryEffect(  80,   1505,   0,     -1,  0,  0,  0);   -- eff_006 (セリフ)
--etEffReplaceTexture( speff, 4, 5);                           -- セリフ差し替え
...
-- 書き文字エントリー
ct = entryEffectLife( SP_ATK01, 10014, 99, 0, -1, 0, -100, 355); -- ズドドッ
setEffShake(SP_ATK01, ct, 81, 20);
setEffScaleKey( SP_ATK01, ct, 2.4, 2.4);
