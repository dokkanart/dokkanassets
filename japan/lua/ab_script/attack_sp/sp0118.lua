...
kame_hand = entryEffect( 70, SP_01, 0x40, 0,  300,  55,  -20);   -- 手のカメハメ波部
...
setMoveKey(  300,    0,   -400,  0,   50);
setMoveKey(  305,    0,   -550,  0,   65);
--setMoveKey(  308,    0,   -1100,  0,   0);
setDisp( 305, 0, 0);
...
-- 爆発 (110F)
------------------------------------------------------
tikyuu = entryEffect( 469, SP_04, 0,  -1,  0,  0,  0);   -- 伸びるかめはめ波
setEffScaleKey( 469, tikyuu, 1.1, 1.1);
