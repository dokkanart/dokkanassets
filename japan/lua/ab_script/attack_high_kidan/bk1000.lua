...
entryFadeBg( 0, 30, 60, 10, 10, 10, 10, 180);          -- ベース暗め　背景
shuchusen = entryEffectLife( ATK_01, 906, 58, 0x00,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( ATK_01, shuchusen, 1.0, 1.0);
kaisinn = entryEffect( ATK_03+28, 1110, 0x80,      -1,  0,  0,  0);   -- 会心の最後のエフェクト
...
setMoveKey( ATK_03+25, 1, 0,  20,   0);      -- 中央位置から
