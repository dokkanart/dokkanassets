...
setScaleKey(   SP_ATK_3+5,   0, 1.0, 1.0);
setScaleKey(   SP_ATK_3+15,   0, 0.9, 0.9);
setScaleKey(   SP_ATK_3+25,   0, 0.9, 0.9);
setScaleKey(   SP_ATK_3+30,   0, 1, 1);
...
setMoveKey(  SP_ATK_3+5,  0, -300,  0,   0);
setMoveKey(  SP_ATK_3+15,  0, -250,  0,   0);
setMoveKey(  SP_ATK_3+25,  0, -250,  0,   0);
setMoveKey(  SP_ATK_3+30,  0, -330,  0,   0);
setMoveKey(  SP_ATK_3+37,  0, -120,  0,   0);
setMoveKey(  SP_ATK_3+40,  0, -80,  0,   0);
...
setMoveKey(  SP_dodge+8, 1,  180,    0,  0);
setMoveKey(  SP_dodge+8,  0,  -250,  0,   0);
...
kamehame_beam = entryEffectLife( SP_ATK_2+1, SP_03, 90, 0x40+0x80,  0,  0,  0,  0);   -- 伸びるかめはめ波
...
setEffScaleKey(SP_ATK_3, kamehame_beam3, 1, 1);
setEffScaleKey(SP_ATK_3+1, kamehame_beam3, 2, 2);
setEffScaleKey(SP_ATK_3+37, kamehame_beam3, 1.5, 1.5);
setEffScaleKey(SP_ATK_3+40, kamehame_beam3, 3, 3);
