...
kamehame_beam2 = entryEffect( 370, SP_03,   0, -1,  0,  -30,  0);   -- 迫るかめはめ波
...
setEffScaleKey(430, kamehame_beam2, 1, 1);
setEffScaleKey(431, kamehame_beam2, 1.5, 1.5);
...
playSe( 432, SE_09);
-- 敵吹っ飛ぶモーション
entryFade( 425, 0,  7, 0, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
------------------------------------------------------
setDisp( 469-5, 1, 1);
setMoveKey(  469-5,    1,  500,  0,   0);
setScaleKey( 469-5,    1,  1.0, 1.0);
setMoveKey(  470-5,    1,    0,   0,   128);
setScaleKey( 470-5,    1,  0.1, 0.1);

changeAnime( 470-5, 1, 107);                         -- 手前ダメージ
entryEffect( 478-5, 1509,  0x80,  -1,  0,  0,  0);   -- 爆発
playSe( 478-5, SE_10);

setMoveKey(  478-5,   1,    0,   0,   128);
setMoveKey(  485-5,   1,  -60,  -200,  -100);
--setMoveKey(  486,   1,  -60,  -200,  -100);
setDamage( 486-5, 1, 0);  -- ダメージ振動等
setShake(477-5,6,15);
setShake(483-5,15,10);

setRotateKey( 470-5,  1,  30 );
setRotateKey( 472-5,  1,  80 );
setRotateKey( 474-5,  1, 120 );
setRotateKey( 476-5,  1, 160 );
setRotateKey( 478-5,  1, 200 );
setRotateKey( 480-5,  1, 260 );
setRotateKey( 482-5,  1, 320 );
setRotateKey( 484-5,  1,   0 );

setShakeChara( 485-5, 1, 5,  10);
setShakeChara( 490-5, 1, 10, 20);

-- 書き文字エントリー
ct = entryEffectLife( 485-5, 10005, 100, 0, -1, 0, -50, 230); -- ガッ
setEffShake(485-5, ct, 30, 10);
setEffRotateKey( 485-5, ct, -40);
setEffScaleKey( 485-5, ct, 4.0, 4.0);
setEffScaleKey( 486-5, ct, 2.0, 2.0);
setEffScaleKey( 487-5, ct, 2.6, 2.6);
setEffScaleKey( 488-5, ct, 4.0, 4.0);
setEffScaleKey( 489-5, ct, 2.6, 2.6);
setEffScaleKey( 490-5, ct, 3.8, 3.8);
setEffScaleKey( 580-5, ct, 3.8, 3.8);
setEffAlphaKey( 485-5, ct, 255);
setEffAlphaKey( 575-5, ct, 255);
setEffAlphaKey( 585-5, ct, 0);

playSe( 473-5, SE_11);
shuchusen = entryEffectLife( 473-5, 906, 120, 0x00,  -1, 0,  0,  0);   -- 集中線
entryEffect( 473-5, 1600,  0x00,  -1,  0,30, -130);   -- ひび割れ

-- ダメージ表示
dealDamage(486-5);
entryFade( 570-5, 9,  10, 1, 8, 8, 8, 255);             -- black fade
endPhase(580-5);
