...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  -100,  50);   -- 手のカメハメ波部
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  200,  80);   -- 伸びるかめはめ波
setEffMoveKey( 291, kamehame_beam,   190, 80, 0);
setEffMoveKey( 298, kamehame_beam,   150, 80, 0);
setEffMoveKey( 303, kamehame_beam,   50, 80, 0);
playSe( 260, SE_07);
...
kame_hand = entryEffect( 70, SP_01, 0x40+0x80,  0,  300,  -50,  20);   -- 手のカメハメ波部
