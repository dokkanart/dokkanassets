...
playSe( 455, SE_09);
-- 敵吹っ飛ぶモーション
changeAnime( 434, 1, 108);
setMoveKey(  434, 1,  120,    0,  0);
setMoveKey(  448, 1,  400,    0,  0);
setScaleKey( 434, 1,  1.6, 1.6);
setScaleKey( 437, 1,  1.5, 1.5);
setScaleKey( 447, 1,  0.2, 0.2);
