...
setEffAlphaKey(70, aura, 200);

kame_hand = entryEffect( 70, SP_01, 0x40+0x100,      0,  300,  185,  75);   -- 手のカメハメ波部
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  50,  0);   -- 伸びるかめはめ波
setEffAlphaKey(260, kamehame_beam, 200);
...
-- ** エフェクト等 ** --
entryFadeBg( 260, 0, 109, 0, 10, 10, 10, 230);       -- ベース暗め　背景
