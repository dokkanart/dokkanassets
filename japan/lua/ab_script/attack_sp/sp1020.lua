...
entryEffectLife( 80, SP_01, 109, 0x40,  0,  0,  0,  0); 
--setEffScaleKey( 30, aura, 1.5, 1.5);
...
-- ** エフェクト等 ** --
entryFade(160, 4, 10, 4,fcolor_r,fcolor_g,fcolor_b,255);     -- whit_fe fade
------------------------------------------------------
-- カードカットイン(90F)
------------------------------------------------------
...
-- ** エフェクト等 ** --
entryFade(254, 4, 12, 4,fcolor_r,fcolor_g,fcolor_b,255);     -- whit_fe fade
------------------------------------------------------
-- カメハメハ発射(110F)
------------------------------------------------------
...
setEffRotateKey(SP_ATK_3, ryusenNanaeme, 153);
setEffScaleKey(SP_ATK_3, ryusenNanaeme, 1.4, 1.4);
...
setMoveKey(  SP_ATK_3,  0, -500,  -152,   100);
setMoveKey(  SP_ATK_3+18,  0, -500,  -152,   100);
setMoveKey(  SP_ATK_3+33,  0, 900,  76,   -200);
...
setMoveKey(  SP_dodge+5,  0,  900,  76,   -200);
setMoveKey(  SP_dodge+9,  0,  -2100,  0,  -200);
...
entryFade( SP_ATK_1+42, 4, 8, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
ryusenNanaeme = entryEffectLife( SP_ATK_3, 921, 34, 0x80,  -1,  0,  0,  0); -- 流線斜め
setEffRotateKey(SP_ATK_3, ryusenNanaeme, 153);
setEffScaleKey(SP_ATK_3, ryusenNanaeme, 1.5, 1.5);
