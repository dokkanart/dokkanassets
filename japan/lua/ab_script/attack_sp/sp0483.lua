--ミスター・サタン　1015090　チャンピオン最後の切り札(天津飯ver)
--sp_effect_b4_00067
...
--敵側
SP_01x=	152138	;--	構え	
SP_02x=	152136	;--	打つ〜放つ	(敵)
SP_03x=	152139	;--	迫る〜着弾	(敵)
...
setEffScaleKey( spep_2 + 142, ctzuo, 1.54, 1.54 );
setEffScaleKey( spep_2 + 144, ctzuo, 2.73, 2.73 );
...
-- ** エフェクト等 ** --
entryFade(spep_2+36,0,6,6,fcolor_r,fcolor_g,fcolor_b,255);     -- white fade
entryFade(spep_2+128,0,4,8,fcolor_r,fcolor_g,fcolor_b,255);     -- white fade
entryFade(spep_2+190,4,4,4,fcolor_r,fcolor_g,fcolor_b,255);     -- white fade

--SE
playSe( spep_2+40, 1025); --銃声
playSe( spep_2+94, 43); --瞬間移動
--playSe( spep_2+109, SE_02); --き演算を貯める
--SE1=playSe( spep_2+109, 17); --き演算を貯めるß
--playSe( spep_2+129, SE_02); --き演算を貯める
stopSe(spep_2+134,SE1,0);
...
--キャラクターの固定
setMoveKey(SP_dodge, 1, 152.8, 169.3, 0 );
setScaleKey(SP_dodge , 1, 1.06, 1.06 );
setRotateKey(SP_dodge,   1, 0);

--キャラクターの固定
setMoveKey(SP_dodge+8, 1, 152.8, 169.3, 0 );
setScaleKey(SP_dodge+8 , 1, 1.06, 1.06  );
...
setScaleKey(SP_dodge+9,  1 , 1.06, 1.06 );
setRotateKey(SP_dodge+9,   1, 0);

--setMoveKey(SP_dodge+10, 1, 0 , 0, 0);
setScaleKey(SP_dodge+10,  1 , 1.06, 1.06);
...
--文字エントリー
--[[
ctzan = entryEffectLife( spep_3 + 38,  10010, 16, 0x100, -1, 0, -140.5, 237.5 );--ザン
setEffMoveKey( spep_3 + 38, ctzan, -140.5, 237.5 , 0 );
...
setEffScaleKey( spep_3 + 38, ctzan, 1.54, 1.54 );
...
setEffRotateKey( spep_3 + 38, ctzan, -18.5 );
setEffRotateKey( spep_3 + 54, ctzan, -18.5 );

setEffAlphaKey( spep_3 + 38, ctzan, 255 );
...
ctdogon = entryEffectLife( spep_3 + 66,  10018, 192, 0x100, -1, 0, -49.5, 397.3 );--ドゴン
setEffMoveKey( spep_3 + 66, ctdogon, -49.5, 397.3 , 0 );
...
--setEffMoveKey( spep_3 + 264, ctdogon, -50.1, 397.2 , 0 );


-- ctdogon
setEffScaleKey( spep_3 +66, ctdogon, 1.78, 1.78 );
...
--setEffScaleKey( spep_3 + 264, ctdogon, 2.45, 2.45 );

setEffRotateKey( spep_3 + 66, ctdogon, -22.5 );
...
setEffRotateKey( spep_3 + 258, ctdogon, -22.3 );

setEffAlphaKey( spep_3 + 66, ctdogon, 255 );
...
setEffAlphaKey( spep_3 + 252, ctdogon, 73 );
setEffAlphaKey( spep_3 + 254, ctdogon, 55 );
setEffAlphaKey( spep_3 + 256, ctdogon, 36 );
setEffAlphaKey( spep_3 + 258, ctdogon, 0 );
--setEffAlphaKey( spep_3 + 264, ctdogon, 0 );
...
--SE
playSe( spep_3, SE_07); --気円斬を投げる
--playSe( spep_3+37, 1033); --気円斬が当たる
playSe( spep_3+30, 1068); --気円斬が当たる
playSe( spep_3+64, 1024); --爆発
...
--エフェクトの再生
tame=entryEffectLife(spep_0,SP_01x,123,0x100,-1,0,0,0);
...
setEffMoveKey( spep_2 + 130, ctzuo, 78.7, 260.5 , 0 );
setEffMoveKey( spep_2 + 142, ctzuo, 117.2, 303.7 , 0 );
setEffMoveKey( spep_2 + 144, ctzuo, 137.7, 364.8 , 0 );
setEffMoveKey( spep_2 + 136, ctzuo, 153.7, 348.8 , 0 );
setEffMoveKey( spep_2 + 138, ctzuo, 137.7, 364.8 , 0 );
setEffMoveKey( spep_2 + 140, ctzuo, 153.7, 348.8 , 0 );
setEffMoveKey( spep_2 + 142, ctzuo, 137.7, 364.8 , 0 );
...
-- ** エフェクト等 ** --
entryFade(spep_3+30,0,2,4,fcolor_r,fcolor_g,fcolor_b,180);     -- white 
entryFade(spep_3+48,6,8,4,fcolor_r,fcolor_g,fcolor_b,255);     -- white 

--SE
playSe( spep_3, SE_07); --気円斬を投げる
--playSe( spep_3+37, 1033); --気円斬が当たる
playSe( spep_3+36, 1068); --気円斬が当たる
playSe( spep_3+64, 1024); --爆発
