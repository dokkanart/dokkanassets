...
entryFade( 58, 6, 10, 8, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
kame_hand = entryEffect( 70, SP_01, 0x40+0x100,  0,  300,  -7,  -40);   -- 手のカメハメ波部
...
entryFade( 250, 2, 8, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
SP_dodge = 399; --エンドフェイズのフレーム数を置き換える
...
kame_hand = entryEffectLife( SP_ATK_0, SP_01, 72, 0x40+0x100, 0,  300,  -7,  -40);   -- 手のカメハメ波部
