...
-- ** エフェクト等 ** --
aura1 = entryEffectLife(  30,   311, 40, 0x40,  0,  1,  0,  0); -- オーラ
setEffMoveKey( 30, aura1, 0, 0 , 0 );
setEffMoveKey( 70, aura1, 0, 0 , 0 );
setEffScaleKey( 30, aura1, 1.5, 1.5 );
setEffScaleKey( 70, aura1, 1.5, 1.5 );
setEffAlphaKey( 30, aura1, 255 );
setEffAlphaKey( 70, aura1, 255 );
setEffRotateKey( 30, aura1, 0 );
setEffRotateKey( 70, aura1, 0 );

setShakeChara( 30, 0, 19, 5);

-- 書き文字エントリー
ct1 = entryEffectLife( 30, 10013, 40, 0, -1, 0, 0, 200); -- ズズンッ
setEffShake(30, ct1, 40, 7);
setEffMoveKey( 30, ct1, 0, 200 , 0 );
setEffMoveKey( 70, ct1, 0, 200 , 0 );
setEffAlphaKey(30, ct1, 255);
setEffAlphaKey(50, ct1, 255);
setEffAlphaKey(70, ct1, 0);
setEffScaleKey( 30, ct1, 0.1, 0.1);
setEffScaleKey( 40, ct1, 2.0, 2.0);
setEffScaleKey( 70, ct1, 2.0, 2.0);
setEffRotateKey( 30, ct1, 0 );
setEffRotateKey( 70, ct1, 0 );
...
kidame1 = entryEffectLife(  70,   1503,  100,   0x80,  -1,  0,  0,  0);   -- eff_004 (気)
kidame2 = entryEffectLife(  70,   1502,  100,   0,     -1,  0,  0,  0);   -- eff_003 (気)
setEffMoveKey( 70, kidame1, 0, 0 , 0 );
setEffMoveKey( 170, kidame1, 0, 0 , 0 );
setEffScaleKey( 70, kidame1, 1.0, 1.0 );
setEffScaleKey( 170, kidame1, 1.0, 1.0 );
setEffAlphaKey( 70, kidame1, 255 );
setEffAlphaKey( 170, kidame1, 255 );
setEffRotateKey( 70, kidame1, 0 );
setEffRotateKey( 170, kidame1, 0 );

setEffMoveKey( 70, kidame2, 0, 0 , 0 );
setEffMoveKey( 170, kidame2, 0, 0 , 0 );
setEffScaleKey( 70, kidame2, 1.0, 1.0 );
setEffScaleKey( 170, kidame2, 1.0, 1.0 );
setEffAlphaKey( 70, kidame2, 255 );
setEffAlphaKey( 170, kidame2, 255 );
setEffRotateKey( 70, kidame2, 0 );
setEffRotateKey( 170, kidame2, 0 );
...
setEffScaleKey( 100, aura2, 1.5, 1.5);
setEffMoveKey( 70, aura2, 0, 0 , 0 );
setEffMoveKey( 170, aura2, 0, 0 , 0 );
...
-- 書き文字エントリー
ct2 = entryEffectLife( 90, 10008, 39, 0x100, -1, 0, -190, 300);    -- ゴゴゴ・・・
setEffShake(90, ct2, 40, 8);
setEffScaleKey(90, ct2, 1.4, 1.4);
...
spep_1 = 260 ;
entryFade( spep_1 - 8, 6, 6, 6, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
kamehame_beam = entryEffectLife( spep_1, SP_02, 109, 0x40,  0, 300,  80, 100);   -- 伸びるかめはめ波
...
-- 書き文字エントリー
ct3 = entryEffectLife( spep_1+8, 10012, 32, 0, -1, 0, 200, 300); -- ズオッ
setEffShake(spep_1+8, ct3, 32, 5);
setEffAlphaKey(spep_1+8, ct3, 255);
setEffAlphaKey(spep_1+30, ct3, 255);
setEffAlphaKey(spep_1+40, ct3, 0);
setEffScaleKey(spep_1+8, ct3, 0.0, 0.0);
setEffScaleKey(spep_1+12, ct3, 1.3, 1.3);
setEffScaleKey(spep_1+32, ct3, 1.3, 1.3);
setEffScaleKey(spep_1+40, ct3, 6.0, 6.0);
...
-- 書き文字エントリー
ct4 = entryEffectLife( spep_2, 10014, 86, 0, -1, 0, -100, 255); -- ズドドッ
setEffShake(spep_2, ct4, 75, 20);
setEffScaleKey( spep_2, ct4, 2.4, 2.4);
setEffRotateKey(spep_2, ct4, 70);
setEffAlphaKey(spep_2, ct4, 255);
setEffAlphaKey(spep_2+60, ct4, 255);
setEffAlphaKey(spep_2+75, ct4, 0);
...
shuchusen5 = entryEffectLife( spep_5, 906, 140, 0x00,  -1, 0,  0,  0);   -- 集中線
...
-- ** エフェクト等 ** --
aura1 = entryEffectLife(  30,   311, 39, 0x40,  0,  1,  0,  0); -- オーラ
setEffMoveKey( 30, aura1, 0, 0 , 0 );
setEffMoveKey( 70, aura1, 0, 0 , 0 );
setEffScaleKey( 30, aura1, 1.5, 1.5 );
setEffScaleKey( 70, aura1, 1.5, 1.5 );
...
-- 書き文字エントリー
ct1 = entryEffectLife( 30, 10013, 39, 0, -1, 0, 0, 200); -- ズズンッ
setEffShake(30, ct1, 40, 7);
setEffMoveKey( 30, ct1, 0, 200 , 0 );
setEffMoveKey( 70, ct1, 0, 200 , 0 );
setEffAlphaKey(30, ct1, 255);
