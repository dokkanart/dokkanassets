...
setEffMoveKey( spep_2 + 868- 3, shuchusen_a, 0, 0 , 0 );
...
-- ** 書き文字エントリー ** --
ctgogo = entryEffectLife( spep_3 + 32,  190006, 72, 0x100, -1, 0, 20.5, 515.5 );  --ゴゴゴ
setEffShake( spep_3 + 32, ctgogo, 72, 10 );

setEffMoveKey( spep_3 + 32, ctgogo, 20.5, 515.5 , 0 );
setEffMoveKey( spep_3 + 104, ctgogo, 20.5, 515.5 , 0 );
...
setEffMoveKey( spep_4 + 250, last, 0, 0 , 0 );
setEffScaleKey( spep_4 + 0, last, 1.0, 1.0 );
setEffScaleKey( spep_4 + 250, last, 1.0, 1.0 );
setEffRotateKey( spep_4 + 0, last, 0 );
setEffRotateKey( spep_4 + 250, last, 0 );
setEffAlphaKey( spep_4 + 0, last, 255 );
setEffAlphaKey( spep_4 + 250, last, 255 );
...
setDisp( spep_4 + 70 - 3, 1, 0);  --消す
changeAnime( spep_4 + 0,  1,  6);
changeAnime( spep_4 + 40 -3,  1,  8);

setMoveKey( spep_4 + 0, 1, 1096.4, 2919.6 , 0 );
--setMoveKey( spep_4 - 3 + 2, 1, 956.8, 2645.1 , 0 );
setMoveKey( spep_4 - 3 + 4, 1, 817.2, 2361.9 , 0 );
setMoveKey( spep_4 - 3 + 6, 1, 677.5, 2072.7 , 0 );
setMoveKey( spep_4 - 3 + 8, 1, 537.9, 1780.5 , 0 );
setMoveKey( spep_4 - 3 + 10, 1, 398.3, 1488.3 , 0 );
setMoveKey( spep_4 - 3 + 12, 1, 258.7, 1198.9 , 0 );
setMoveKey( spep_4 - 3 + 14, 1, 247.4, 1137.2 , 0 );
setMoveKey( spep_4 - 3 + 16, 1, 236.7, 1075.5 , 0 );
setMoveKey( spep_4 - 3 + 18, 1, 225.9, 1009.2 , 0 );
setMoveKey( spep_4 - 3 + 20, 1, 215.2, 938.6 , 0 );
setMoveKey( spep_4 - 3 + 22, 1, 204.5, 863.8 , 0 );
setMoveKey( spep_4 - 3 + 24, 1, 193.8, 785.1 , 0 );
setMoveKey( spep_4 - 3 + 26, 1, 183, 702.8 , 0 );
setMoveKey( spep_4 - 3 + 28, 1, 172.3, 617 , 0 );
setMoveKey( spep_4 - 3 + 30, 1, 161.6, 528 , 0 );
setMoveKey( spep_4 - 3 + 32, 1, 150.9, 436 , 0 );
setMoveKey( spep_4 - 3 + 34, 1, 140.2, 341.2 , 0 );
setMoveKey( spep_4 - 3 + 36, 1, 129.4, 243.8 , 0 );
setMoveKey( spep_4 - 3 + 38, 1, 118.7, 144.1 , 0 );

setMoveKey( spep_4 - 3 + 40, 1, 223.6, 245.9 , 0 );
setMoveKey( spep_4 - 3 + 42, 1, 179.4, 206.5 , 0 );
setMoveKey( spep_4 - 3 + 44, 1, 119.3, 147.1 , 0 );
setMoveKey( spep_4 - 3 + 46, 1, 129.9, 149.5 , 0 );
setMoveKey( spep_4 - 3 + 48, 1, 120.5, 147.9 , 0 );
setMoveKey( spep_4 - 3 + 50, 1, 127.1, 146.3 , 0 );
setMoveKey( spep_4 - 3 + 52, 1, 125.7, 136.7 , 0 );
setMoveKey( spep_4 - 3 + 54, 1, 124.3, 143.1 , 0 );
setMoveKey( spep_4 - 3 + 56, 1, 119, 137.5 , 0 );
setMoveKey( spep_4 - 3 + 58, 1, 121.6, 139.9 , 0 );
setMoveKey( spep_4 - 3 + 60, 1, 112.2, 134.3 , 0 );
setMoveKey( spep_4 - 3 + 62, 1, 118.8, 136.7 , 0 );
setMoveKey( spep_4 - 3 + 64, 1, 104.2, 147.2 , 0 );
setMoveKey( spep_4 - 3 + 66, 1, 97.6, 173.8 , 0 );
setMoveKey( spep_4 - 3 + 68, 1, 79, 188.3 , 0 );
setMoveKey( spep_4 - 3 + 70, 1, 76.4, 210.8 , 0 );
...
setScaleKey( spep_4 - 3 + 14, 1, 1.89, 1.89 );
...
setScaleKey( spep_4 - 3 + 42, 1, 2.28, 2.28 );
setScaleKey( spep_4 - 3 + 44, 1, 1.67, 1.67 );
setScaleKey( spep_4 - 3 + 46, 1, 1.65, 1.65 );
setScaleKey( spep_4 - 3 + 48, 1, 1.63, 1.63 );
setScaleKey( spep_4 - 3 + 50, 1, 1.62, 1.62 );
setScaleKey( spep_4 - 3 + 52, 1, 1.6, 1.6 );
setScaleKey( spep_4 - 3 + 54, 1, 1.58, 1.58 );
setScaleKey( spep_4 - 3 + 56, 1, 1.56, 1.56 );
setScaleKey( spep_4 - 3 + 58, 1, 1.55, 1.55 );
setScaleKey( spep_4 - 3 + 60, 1, 1.53, 1.53 );
setScaleKey( spep_4 - 3 + 62, 1, 1.51, 1.51 );
setScaleKey( spep_4 - 3 + 64, 1, 3.12, 3.12 );
setScaleKey( spep_4 - 3 + 66, 1, 4.73, 4.73 );
setScaleKey( spep_4 - 3 + 68, 1, 6.34, 6.34 );
setScaleKey( spep_4 - 3 + 70, 1, 7.95, 7.95 );

setRotateKey( spep_4 + 0, 1, -124.2 );
setRotateKey( spep_4 - 3 + 39, 1, -124.2 );
setRotateKey( spep_4 - 3 + 40, 1, 154.8 );
setRotateKey( spep_4 - 3 + 70, 1, 154.8 );

-- ** 黒背景 ** --
entryFadeBg( spep_4 + 0, 0, 250, 0, 0, 0, 0, 220 );  --黒　背景

-- ** 音 ** 
SE = playSe( spep_4,  1050);  --くるくる
stopSe(spep_4 +38 -3,  SE,  0);
playSe( spep_4 +40 -3, 1010);  --突く
playSe( spep_4 + 40 , 1022 );  --発射
playSe(  spep_4 + 60,  1067);  --爆発

-- ダメージ表示
dealDamage(spep_4 + 140 );
