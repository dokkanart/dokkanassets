...
entryFade( SP_start+160, 2, 10, 2, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade

-- ** 黒背景 ** --
entryFadeBg( 0, 0, 60, 0, 0, 0, 0, 255 );  --黒　背景
...
entryFade( SP_start+ 257, 2, 6, 2, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
kamehame_beam = entryEffectLife( SP_start+ 257, SP_02, 115, 0x40,  0,  300,  0,  0);   -- 伸びるかめはめ波
playSe( SP_start+ 260, 1002);
...
spname = entryEffectLife( SP_start+ 257, 1508, 100,  0,  -1,  0,  0,  0);               -- かめはめ波文字
...
entryFade( SP_start2+ SP_start+ 360, 2, 10, 2, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
stop = playSe( SP_start2+ SP_start+ 390, 1002);
