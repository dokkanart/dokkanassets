...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  240,  55);   -- 手のカメハメ波部
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  590,  150);   -- 伸びるかめはめ波
...
kame_hand = entryEffect( SP_ATK_0, SP_01, 0x40, 0,  300,  240,  55);   -- 手のカメハメ波部
setEffScaleKey( SP_ATK_0, kame_hand, 0.5, 0.5);

-- ** エフェクト等 ** --
aura = entryEffectLife( SP_ATK_0,   311, 73, 0x40+0x80,  0,  1,  0,  0); -- オーラ
...
kamehame_beam = entryEffectLife( SP_ATK_2+1, SP_02, 90, 0x40,  0,  300,  590,  150);   -- 伸びるかめはめ波
