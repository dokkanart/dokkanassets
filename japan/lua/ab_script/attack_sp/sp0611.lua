...
--エフェクト登録(てき)
SP_01x=	154384	;--	ブルーから平常時
SP_02x=	154482	;--	ジャンプして岩山の頂上へ
SP_03x=	154486	;--	両手を広げて元気玉貯め開始
SP_04x=	154483	;--	元気玉が完成
SP_05x=	154484	;--	元気玉を投げる
SP_06x=	154389	;--	敵に迫る元気玉
SP_07x=	154390	;--	敵に迫る元気玉
SP_08x=	154391	;--	ブルーになる
SP_09x=	154392	;--	敵にさらに迫る元気玉
SP_10x=	154393	;--	敵にさらに迫る元気玉
SP_11x=	154485	;--	界王拳
SP_12x=	154395	;--	爆発
...
--エフェクト
natural=entryEffect(spep_0,SP_01x,0x80,-1,0,0,0);
...
------------------------------------------------------
--エフェクト
jump=entryEffect(spep_1,SP_02x,0x80,-1,0,0,0);
...
------------------------------------------------------
--エフェクト
tame=entryEffect(spep_2,SP_03x,0x100,-1,0,0,0);
...
--オラに元気分けてくれ！
--playVoice(spep_2+30,135);
--setVoiceVolume(spep_2+30,135,500);
...
------------------------------------------------------
--エフェクト
complete=entryEffect(spep_3,SP_04x,0x100,-1,0,0,0);
...
------------------------------------------------------
--エフェクト
throw=entryEffect(spep_4,SP_05x,0x100,-1,0,0,0);
...
------------------------------------------------------
--エフェクト
approach_f=entryEffect(spep_5,SP_06x,0x100,-1,0,0,0);
...
--エフェクト
approach_b=entryEffect(spep_5,SP_07x,0x80,-1,0,0,0);
...
------------------------------------------------------
--エフェクト
blue=entryEffect(spep_6,SP_08x,0x100,-1,0,0,0);
...
------------------------------------------------------
--エフェクト
approach2_f=entryEffect(spep_7,SP_09x,0x100,-1,0,0,0);
...
--エフェクト
approach2_b=entryEffect(spep_7,SP_10x,0x80,-1,0,0,0);
...
------------------------------------------------------
--エフェクト
kaioken=entryEffect(spep_8,SP_11x,0x100,-1,0,0,0);
...
--界王拳！
--playVoice(spep_8,137);
--setVoiceVolume(spep_8,137,500);

--はああ！
--playVoice(spep_8+178,138);
--setVoiceVolume(spep_8+178,138,500);
...
------------------------------------------------------
--エフェクト
explosion=entryEffect(spep_9,SP_12x,0x100,-1,0,0,0);
...
setEffRotateKey( spep_9 -3 + 28, ctzudodo, -55.4 );
setEffRotateKey( spep_9 -3 + 120, ctzudodo, -55.4 );
