...
-- 書き文字エントリー
ct = entryEffectLife( 90, 10008, 39, 0x100, -1, 0, 190, 250);    -- ゴゴゴ・・・
...
spname = entryEffect( 260, 1508,  0x100,  -1,  0,  0,  0);               -- かめはめ波文字
...
setScaleKey( SP_ATK01,    0,  0.1, 0.1);
...
setEffScaleKey( SP_ATK_0, aura, 1.0, 1.0);
