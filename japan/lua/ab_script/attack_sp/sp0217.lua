...
kame_hand = entryEffect( SP_start+ 70, SP_01, 0x40,      0,  300,  0,  300);   -- 手のカメハメ波部
setEffScaleKey( SP_start+ 70, kame_hand, -1, 1);
...
kamehame_beam = entryEffectLife( SP_start+ 260, SP_02, 109, 0x40,  0,  300,  50,  300);   -- 伸びるかめはめ波
