...
-- ** エフェクト等 ** --
entryFadeBg( SP_start+ 50, 0, 140, 0, 10, 10, 10, 180);       -- ベース暗め　背景
...
-- ** エフェクト等 ** --
--aura = entryEffectLife( SP_start+  70,   311, 95, 0x40,  0,  1,  0,  0); -- オーラ
--entryEffectLife( SP_start+ 70, SP_02, 109, 0x40,  0,  0,  0,  0); 
--setEffScaleKey( SP_start+ 30, aura, 1.5, 1.5);
--setShakeChara( SP_start+ 70, 0, 49, 5);

cte = entryEffectLife( SP_start+ 70, SP_02, 99, 0x40+0x100,  0,  300,  -10,  0);   -- バリア

--setEffAlphaKey( SP_start+73, SP_02, 255);
...
setMoveKey( SP_start+  270,    0,   -250,  0,   0);
setMoveKey( SP_start+  299,  0,   -250,  0,   0);
setMoveKey( SP_start+  305,  0,   -400,  0,   0);
setMoveKey( SP_start+  310,  0,   -250,  0,   0);
--setMoveKey( SP_start+  315,  0,   -300,  0,   0);
--setScaleKey( SP_start+ 300,0,1,1);
playSe( SP_start+ 305, SE_06);
--setScaleKey( SP_start+ 306,0,3,3);
...
kamehame_beam = entryEffectLife( SP_start+ 260, SP_02, 79, 0x100,  -1,  -600,  0,  0);   -- バリア
--kamehame_beam = entryEffectLife( SP_start+ 260, SP_02, 79, 0x40,  300,  0,  0,  0);   -- 伸びるかめはめ波
setEffScaleKey( SP_start+260,kamehame_beam,1.5,1.5);

--[[
setEffMoveKey( SP_start+  260,    kamehame_beam,   -600,  0,   0);
setEffMoveKey( SP_start+  261,    kamehame_beam,   -600,  0,   0);
setEffMoveKey( SP_start+  270,    kamehame_beam,   -250,  0,   0);
setEffMoveKey( SP_start+  299,  kamehame_beam,   -250,  0,   0);
setEffMoveKey( SP_start+  305,  kamehame_beam,   -400,  0,   0);
setEffMoveKey( SP_start+  310,  kamehame_beam,   -250,  0,   0);
--setEffMoveKey( SP_start+  315,  kamehame_beam,   -300,  0,   0);
...
setEffMoveKey( SP_start+  305,  kamehame_beam,   -400,  0,   0);
setEffMoveKey( SP_start+  310,  kamehame_beam,   -250,  0,   0);
setEffMoveKey( SP_start+  333,  kamehame_beam,   1700,  0,   0);
setEffMoveKey( SP_start+  334,  kamehame_beam,   -1700,  0,   0);
...
kamehame_beam3 = entryEffectLife( SP_start+ SP_ATK_3, SP_02, 46, 0x100, -1, -600, 0, 0);
--kamehame_beam3 = entryEffectLife( SP_start+ SP_ATK_3, SP_02, 46, 0x40, 300, -600, 0, 0);
...
setEffMoveKey( SP_start+  SP_ATK_3+35,  kamehame_beam3, 0,  0,   0);
--end
...
setScaleKey( SP_start+ SP_ATK_3+15,   1,   0.5,  0.5);
...
setMoveKey( SP_start+  SP_ATK_3+35,  0, 0,  0,   0);
...
playSe( SP_start+ SP_ATK_3+12, SE_01);

--entryFade( SP_start+ SP_ATK_3+27, 10,  3, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

playSe( SP_start+ SP_ATK_3+27, SE_09);
--playSe( SP_start+ SP_ATK_3+27, SE_45);
...
-- ヒットエフェクト
setEffAlphaKey( SP_start+ SP_ATK_3+26, kamehame_beam3, 255);
setEffAlphaKey( SP_start+ SP_ATK_3+34, kamehame_beam3, 0);

playSe( SP_start+ SP_ATK_3+32, SE_13);
entryEffect( SP_start+ SP_ATK_3+32, SP_03,  0x80,  -1,  0,  0,  0);   -- パリーン
--[[
hit_eff_1 = entryEffect( SP_start+ SP_ATK_3+32,  4,  0x40,  -1,  0,  300, 600);--HIT
hit_eff_2 = entryEffect( SP_start+ SP_ATK_3+32,  906,  0x40,  -1,  0,  300, 600);
hit_eff_3 = entryEffect( SP_start+ SP_ATK_3+32,  908,  0x40,  -1,  0,  300, 600);
...
entryEffectLife( SP_start+ SP_ATK_3+40, 906, 35, 0x00,  -1, 0,  0,  0);   -- 集中線
--entryEffectLife( SP_start+ SP_ATK_3+40, 920, 35, 0x80,  -1,  0,  0,  0); -- 流線
entryFade( SP_start+ SP_ATK_3+40, 5,  7, 2, 255, 255, 255, 255);     -- white fade
...
kamehame_beam = entryEffectLife( SP_ATK_0+5, SP_02, 79, 0x100,  -1,  -600,  -20,  -20);   -- バリア
...
setEffReplaceTexture(spname, 7, 4);                                  -- 技名テクスチャ差し替え
setEffScaleKey( SP_ATK_1+10, spname, 1.0, 1.0);
...
setEffAlphaKey( SP_ATK_1+6, spname, 255);
setEffAlphaKey( SP_ATK_1+46, spname, 255);
...
setEffAlphaKey( SP_ATK_2+35, spname, 0);
...
kamehame_beam = entryEffectLife( SP_ATK_2-1, SP_02, 79, 0x100,  -1,  0,  0,  0);   -- 伸びるかめはめ波
setEffScaleKey(SP_ATK_2+1,kamehame_beam,1.5,1.5);

setEffMoveKey(  SP_ATK_2,    kamehame_beam,   -600,  0,   0);
setEffMoveKey(  SP_ATK_2+1,    kamehame_beam,   -600,  0,   0);
...
kamehame_beam3 = entryEffectLife( SP_ATK_3, SP_02, 46, 0x80, -1, -600, 0, 0);
...
setEffMoveKey(  SP_ATK_3+35,  kamehame_beam3, 0,  0,   0);
--end
...
setMoveKey(  SP_ATK_3+35,  0, 0,  0,   0);
...
setEffRotateKey(SP_ATK_3, ct, 10);
...
setEffAlphaKey( SP_ATK_3+36, kamehame_beam3, 0);

-- ヒットエフェクト
playSe( SP_ATK_3+35, SE_13);
entryEffect( SP_ATK_3+35, SP_03,  0x80,  -1,  0,  0,  0);   -- パリーン
--[[
...
setScaleKey(   SP_ATK_4+2,   0, 0.5, 0.5);--追加
