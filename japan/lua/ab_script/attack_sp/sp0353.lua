...
kame_hand = entryEffect( 70, SP_01, 0x80,      0,  300,  -68,  130);   -- 手のカメハメ波部
setEffAlphaKey( 70, kame_hand, 180);
setEffScaleKey( 70, kame_hand, 0.5, 0.5);
setEffMoveKey( 70,  kame_hand, -68,  130);
...
setEffMoveKey( 169,  kame_hand, -68,  130);
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  460,  115);   -- 伸びるかめはめ波
