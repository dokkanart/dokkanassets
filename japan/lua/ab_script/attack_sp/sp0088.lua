...
entryEffect(  160,   1502,   0x80,     -1,  0,  0,  0);   -- eff_003 (気)
...
setEffAlphaKey(267, kamehame_beam, 0);
setEffAlphaKey(268, kamehame_beam, 255);
...
-- ** エフェクト等 ** --
entryFadeBg( 257, 0, 109, 0, 10, 10, 10, 180);       -- ベース暗め　背景
