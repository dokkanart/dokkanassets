...
setEffAlphaKey( (SP_ATK_1+36), kame_hand, 255);
setEffAlphaKey( (SP_ATK_1+36), speff, 255);
setEffAlphaKey( (SP_ATK_1+64), speff, 0);
setEffAlphaKey( (SP_ATK_1+60), aura, 0);
setEffAlphaKey( (SP_ATK_1+60), kame_hand, 0);
...
entryEffectLife( SP_ATK_2+21, 920, 70, 0x80,  -1,  0,  0,  0); -- 流線
...
kamehame_beam3 = entryEffect( SP_ATK_3, SP_03,   0x100, -1,  0,  0,  0);   -- 迫るかめはめ波
...
SP_dodge = SP_ATK_3+14; --エンドフェイズのフレーム数を置き換える
