...
--[[
changeAnime(  20, 0, 17);                       -- 溜め!
entryEffect(  20,   1501,   0x80, -1,  0,  0,  0);    -- eff_002
entryEffect(  20,   1500,   0,    -1,  0,  0,  0);    -- eff_001
]]
playSe( 20, SE_01);
entryFade( 15, 2, 1, 2, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade
entryFadeBg( 17, 0, 60-17, 0, 0, 0, 0, 255);       -- ベース暗め　背景
-- ** エフェクト等 ** --
tame = entryEffect(  0,   SP_00, 0x100,  -1,  0,  0,  0); -- オーラ
setEffScaleKey( 0, tame, 1.0, 1.0);
--setShakeChara( 30+tyousei, 0, 19, 5);
--[[
aura = entryEffectLife(  18,   352, 39, 0x80,  -1,  0,  0,  -200); -- オーラ
setEffScaleKey( 18, aura, 1.7, 1.7);
setEffMoveKey(18, aura,0,-200,0);
--setShakeChara( 30+tyousei, 0, 19, 5);
]]
shuchusen2 = entryEffectLife( 18, 906, 42, 0x100,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( 18, shuchusen2, 1.0, 1.0);
setEffScaleKey( 60, shuchusen2, 1.0, 1.0);

tyousei=-10;

-- 書き文字エントリー
ct = entryEffectLife( 30+tyousei, 10013, 39, 0, -1, 0, 0, 200); -- ズズンッ
setEffShake(30+tyousei, ct, 40, 7);
setEffAlphaKey(30+tyousei, ct, 255);
setEffAlphaKey(50+tyousei, ct, 255);
setEffAlphaKey(70+tyousei, ct, 0);
setEffScaleKey( 30+tyousei, ct, 0.1, 0.1);
setEffScaleKey( 40+tyousei, ct, 2.0, 2.0);
playSe( 30+tyousei, SE_02);
...
tametame = entryEffect( spep_1, SP_01 , 0x00, -1,  0,  0,  0);   -- ギニュー溜め
setEffScaleKey( spep_1, tametame, 1.0, 1.0);
...
-- ** 書き文字エントリ ** --
gogogo = entryEffectLife( spep_1, 190006, 65, 0x100, -1, 0, 200, 500); -- ゴゴゴゴゴ
setEffScaleKey( spep_1, gogogo, 0.8, 0.8);
setEffAlphaKey( spep_1, gogogo, 255);
setEffRotateKey( spep_1, gogogo, 20);
...
hassya=entryEffect( spep_3, SP_02 , 0x00, -1,  0,  0,  0);   -- ギニュー発射
...
ct3 = entryEffectLife( spep_3, 10012, 62, 0, -1, 0, 200, 300); -- ズオッ
setEffShake( spep_3, ct3, 62, 5);
setEffAlphaKey( spep_3, ct3, 255);
setEffAlphaKey( spep_3+52, ct3, 255);--290
setEffAlphaKey( spep_3+62, ct3, 0);--300
setEffScaleKey( spep_3, ct3, 0.0, 0.0);
setEffScaleKey( spep_3+12, ct3, 2.3, 2.3);
setEffScaleKey( spep_3+52, ct3, 2.3, 2.3);
setEffScaleKey( spep_3+62, ct3, 6.0, 6.0);
...
ct4 = entryEffectLife( spep_4+15, 10006, 45, 0x80, -1, 0, 0, 255); -- ギャン
setEffShake( spep_4+5, ct4, 99, 20);
setEffScaleKey( spep_4+5, ct4, 0.1, 0.1);
setEffScaleKey( spep_4+30, ct4, 2.4, 2.4);
setEffScaleKey( spep_4+57, ct4, 2.8, 2.8);
setEffAlphaKey( spep_4+5, ct4, 255);
setEffAlphaKey( spep_4+30, ct4, 255);
setEffAlphaKey( spep_4+47, ct4, 0);
...
entryFadeBg( 17, 0, 60-17, 0, 0, 0, 0, 255);       -- ベース暗め　背景
-- ** エフェクト等 ** --
tame = entryEffect(  0,   SP_00r, 0x100,  -1,  0,  0,  0); -- オーラ
setEffScaleKey( 0, tame, 1.0, 1.0);
--setShakeChara( 30+tyousei, 0, 19, 5);
--[[
aura = entryEffectLife(  18,   352, 39, 0x80,  -1,  0,  0,  -200); -- オーラ
