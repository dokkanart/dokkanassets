...
kame_hand = entryEffect( 70, SP_01, 0x40+0x80,      0,  300,  20,  110);   -- 手のカメハメ波部
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  280,  70);   -- 伸びるかめはめ波
...
kame_hand = entryEffect( 70, SP_01, 0x100,      0,  300,  -20,  80);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);
