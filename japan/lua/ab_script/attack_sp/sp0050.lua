...
-- 書き文字エントリー
ct1 = entryEffectLife( 90, 10008, 39, 0x100, -1, 0, -250, 250);    -- ゴゴゴ・・・
setEffShake(90, ct1, 40, 8);
setEffScaleKey(90, ct1, 1.4, 1.4);
...
kamehame_beam1 = entryEffectLife( 260, SP_02, 109,0x100,  -1,  0,  0,  0);
...
--setQuake(250,10,22);
--setEffShake(259,0,10,22);
--setEffShake(268,0,20,9);
setQuake(270,49,15);
...
setMoveKey(  369,    0,   -100,  0,   0);

-- ** エフェクト等 ** --
entryFadeBg( 260, 0, 109, 0, 10, 10, 10, 180);       -- ベース暗め　背景
entryFadeBg( 260, 0, 40, 20, 230, 230, 230, 255);    -- 最初だけ明るい　背景
entryFadeBg( 300, 0, 2, 8, 100, 140, 250, 250);     -- 青い　背景


--tate = entryEffectLife( 260, 920, 109, 0x80,  -1,  0,  0,  0); -- 流線
--setEffRotateKey( 260, tate, 90);--角度

setShakeChara( 305, 0, 54, 50);

shuchusen1 = entryEffectLife( 260, 906, 49, 0x00,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( 260, shuchusen1, 1.0, 1.0);
setEffScaleKey( 300, shuchusen1, 1.0, 1.0);
setEffScaleKey( 309, shuchusen1, 2.0, 2.0);
...
-- 書き文字エントリー
ct2 = entryEffectLife( 268, 10012, 32, 0, -1, 0, 200, 300); -- ズオッ
setEffShake(268, ct2, 32, 5);
setEffAlphaKey(268, ct2, 255);
setEffAlphaKey(290, ct2, 255);
setEffAlphaKey(300, ct2, 0);
setEffScaleKey(268, ct2, 0.0, 0.0);
setEffScaleKey(272, ct2, 1.3, 1.3);
setEffScaleKey(292, ct2, 1.3, 1.3);
setEffScaleKey(300, ct2, 6.0, 6.0);
playSe( 290, SE_07);
playSe( 300, SE_07);
...
kamehame_beam3 = entryEffect( 370, SP_03,   0x80, 0,  0,  0,  0);   -- 迫るかめはめ波
...
entryFade( 420, 40,  10, 15, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
--setEffShake(455,1,5,22);
--setEffShake(460,1,10,15);
...
-- 書き文字エントリー
ct3 = entryEffectLife( 370, 10014, 99, 0, -1, 0, -100, 255); -- ズドドッ
setEffShake(370, ct3, 99, 20);
setEffScaleKey( 370, ct3, 2.4, 2.4);
setEffRotateKey(370, ct3, 70);
setEffAlphaKey(370, ct3, 255);
setEffAlphaKey(430, ct3, 255);
setEffAlphaKey(450, ct3, 0);
...
setMoveKey(  SP_dodge+5,    0,   -1100,  0,   0);
...
-- 書き文字エントリー
ct4 = entryEffectLife( 485, 10005, 100, 0, -1, 0, -50, 230); -- ガッ
setEffShake(485, ct4, 30, 10);
setEffRotateKey( 485, ct4, -40);
setEffScaleKey( 485, ct4, 4.0, 4.0);
setEffScaleKey( 486, ct4, 2.0, 2.0);
setEffScaleKey( 487, ct4, 2.6, 2.6);
setEffScaleKey( 488, ct4, 4.0, 4.0);
setEffScaleKey( 489, ct4, 2.6, 2.6);
setEffScaleKey( 490, ct4, 3.8, 3.8);
setEffScaleKey( 580, ct4, 3.8, 3.8);
setEffAlphaKey( 485, ct4, 255);
setEffAlphaKey( 575, ct4, 255);
setEffAlphaKey( 585, ct4, 0);

playSe( 473, SE_11);
shuchusen4 = entryEffectLife( 473, 906, 120, 0x00,  -1, 0,  0,  0);   -- 集中線
