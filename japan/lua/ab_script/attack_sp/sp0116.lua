...
-- 途中からカメハメハが伸びる
setMoveKey(  299,    0,   -300,  0,   0);
setMoveKey(  300,    0,   -300,  0,   0);
...
setMoveKey(  459, 1,  400,    0,  0);
setScaleKey( 425, 1,  1.6, 1.6);
setScaleKey( 459, 1,  0.2, 0.2);
...
kame_hand = entryEffectLife( SP_ATK_0+2, SP_01, 70, 0x100,  0,  300,  0,  0);   -- 手のカメハメ波部
setEffScaleKey( SP_ATK_0+2, kame_hand, 0.5, 0.5);
setEffAlphaKey( SP_ATK_0+2, kame_hand, 255);
setEffAlphaKey( SP_ATK_0+50, kame_hand, 255);
setEffAlphaKey( SP_ATK_0+51, kame_hand, 0);
setEffAlphaKey( SP_ATK_0+62, kame_hand, 0);
setEffAlphaKey( SP_ATK_0+63, kame_hand, 255);
-- ** エフェクト等 ** --
...
kamehame_beam_st = entryEffectLife( SP_ATK_2+2, SP_02, 6, 0x40,  0,  300,  400,  0);   
kamehame_beam = entryEffectLife( SP_ATK_2+2, SP_02, 90, 0x40,  0,  300,  0,  0);   -- 伸びるかめはめ波
setEffAlphaKey( (SP_ATK_2+2), kamehame_beam, 0);
setEffAlphaKey( (SP_ATK_2+8), kamehame_beam, 255);
...
-- 途中からカメハメハが伸びる
setMoveKey(  SP_ATK_2+41,    0,   -300,  0,   0);
setMoveKey(  SP_ATK_2+42,    0,   -300,  0,   0);
setMoveKey(  SP_ATK_2+53,    0,   -1100,  0,   0);
...
-- かめはめは迫る(100F)
------------------------------------------------------
kamehame_beam3 = entryEffect( SP_ATK_3, SP_03,  0x80, -1,  0,  0,  0);   -- 迫るかめはめ波
...
SP_dodge = 185-6; --エンドフェイズのフレーム数を置き換える
...
setMoveKey(  SP_ATK_3+15,    1,   0,  0,   0);
setScaleKey( SP_ATK_3+15,   1,   1.6,  1.6);
playSe( SP_ATK_3+12, SE_01);

-- 敵吹っ飛ぶモーション
changeAnime( SP_ATK_3+27, 1, 108);
setMoveKey(  SP_ATK_3+27, 1,  0,    0,  0);
--entryFlash( (SP_ATK_3+25), 2, 0, 0, 0, 200);
setMoveKey(  SP_ATK_3+33, 1,  200,    0,  128);
setScaleKey( SP_ATK_3+27, 1,  1.6, 1.6);
setScaleKey( SP_ATK_3+27, 1,  1, 1);
