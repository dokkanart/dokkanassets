...
playSe( SP_start+ 76, SE_03);
--playSe( SP_start+ 80, SE_03);
playSe( SP_start+ 96, SE_03);
playSe( SP_start+ 106, SE_03);
--playSe( SP_start+ 119, SE_03);
playSe( SP_start+ 129, SE_03);
playSe( SP_start+ 136, SE_03);
playSe( SP_start+ 146, SE_03);
playSe( SP_start+ 162, SE_03);
...
-- ** エフェクト等 ** --
aura = entryEffectLife( SP_start+  70,   311, 99, 0x40,  0,  1,  0,  -60); -- オーラ
setEffScaleKey( SP_start+ 30, aura, 3.5, 3.5);
setShakeChara( SP_start+ 70, 0, 49, 5);

kame_hand = entryEffect( SP_start+ 70, SP_01, 0x40,      0,  300,  10,  20);   -- 手のカメハメ波部
...
setMoveKey(   SP_start+ 173,   0,    0, -54,   0);
...
entryFade( SP_start+ 255, 3, 7, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
kamehame_beam = entryEffectLife( SP_start+ 260, SP_02, 109, 0x40,  0,  300,  10,  0);   -- 伸びるかめはめ波
playSe( SP_start+ 260, SE_07);
setEffScaleKey( SP_start+ 260, kamehame_beam, 0.9, 0.9);

playSe( SP_start+ 260, SE_03);
playSe( SP_start+ 270, SE_03);
playSe( SP_start+ 280, SE_03);
playSe( SP_start+ 290, SE_03);
...
setMoveKey( SP_start+  300,    0,   -300,  200,   70);
setMoveKey( SP_start+  305,    0,   -450,  220,   120);
setMoveKey( SP_start+  308,    0,   -900,  0,   0);

setEffScaleKey( SP_start+ 310, kamehame_beam, 0.5, 0.5);

--setEffScaleKey( SP_start+ 300, kamehame_beam, 0.9, 0.9);
...
-- 書き文字エントリー
ct = entryEffectLife( SP_start+ 268, 10012, 32, 0, -1, 0, 200, 500); -- ズオッ
...
playSe( SP_start+ 370, 1014);
playSe( SP_start+ 380, 1014);
playSe( SP_start+ 390, 1014);
playSe( SP_start+ 400, 1014);
...
kamehame_beam2 = entryEffect( SP_start+ 370, SP_03,   0, -1,  0,  -130,  0);   -- 迫るかめはめ波
setEffScaleKey( SP_start+370, kamehame_beam2, 1, 1);
setEffScaleKey( SP_start+452, kamehame_beam2, 1, 1);
--setEffScaleKey( SP_start+454, kamehame_beam2, 2.0, 2.0);
...
-- 敵吹っ飛ぶモーション
changeAnime( SP_start+ 440, 1, 108);
setMoveKey( SP_start+  440, 1,  120,    0,  0);
setMoveKey( SP_start+  454, 1,  400,    0,  0);
setScaleKey( SP_start+ 440, 1,  1.6, 1.6);
setScaleKey( SP_start+ 444, 1,  1.5, 1.5);
setScaleKey( SP_start+ 454, 1,  0.2, 0.2);
...
playSe( SP_start+ 410, 1014);
playSe( SP_start+ 420, 1014);
------------------------------------------------------
-- 爆発 (110F)
------------------------------------------------------
