...
setMoveKey( 1, 0, 87, -346, 1); --味方位置
setMoveKey( 2, 0, 74, -293, 3); --味方位置
setMoveKey( 3, 0, 60, -240, 4); --味方位置
setMoveKey( 4, 0, 47, -187, 6); --味方位置
setMoveKey( 5, 0, 33, -133, 7); --味方位置

setScaleKey( 0, 0, 4.0, 4.0);
setScaleKey( 1, 0, 3.85, 3.85);
setScaleKey( 2, 0, 3.7, 3.7);
setScaleKey( 3, 0, 3.55, 3.55);
setScaleKey( 4, 0, 3.4, 3.4);
setScaleKey( 5, 0, 3.25, 3.25);


setMoveKey( 0, 1, 0, -54, 0); --味方位置
setMoveKey( 1, 1, 0, -54, 0); --味方位置
setMoveKey( 2, 1, 0, -54, 0); --味方位置
setMoveKey( 3, 1, 0, -54, 0); --味方位置
setMoveKey( 4, 1, 0, -54, 0); --味方位置
setMoveKey( 5, 1, 0, -54, 0); --味方位置
