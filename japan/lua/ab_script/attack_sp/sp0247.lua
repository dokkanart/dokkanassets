...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300, 95,  240);   -- 伸びるかめはめ波
...
setMoveKey(  465, 1,  400,    0,  0);
setScaleKey( 464, 1,  0.2, 0.2);
...
-- ** エフェクト等 ** --
aura = entryEffectLife( SP_ATK_0,   311, 70, 0x40,  0,  1,  0,  0); -- オーラ
...
kamehame_beam = entryEffectLife( SP_ATK_2+1, SP_02, 90, 0x40,  0,  300,  95,  240);   -- 伸びるかめはめ波
...
setMoveKey(  SP_ATK_2+75,    0,   -1000,  0,   0);
...
-- 敵吹っ飛ぶモーション
changeAnime( SP_ATK_3+27+5-11 ,1, 108);
setMoveKey(  SP_ATK_3+27+5-11, 1,  120,    0,  0);
--entryFlash( (SP_ATK_3+25), 2, 0, 0, 0, 200);
setMoveKey(  SP_ATK_3+38-11, 1,  200,    0,  128);
setScaleKey( SP_ATK_3+27+5-11, 1,  1.6, 1.6);
setScaleKey( SP_ATK_3+27+5-11, 1,  1, 1);
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  30,   311, 39, 0x40,  0,  1,  -30,  0); -- オーラ
setEffScaleKey( 30, aura, 1.5, 1.5);
setShakeChara( 30, 0, 19, 5);
