...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  250,  80);   -- 手のカメハメ波部
...
setMoveKey(  259,    0,      -250,  0,   0);
--setMoveKey(  260,    0,   -600,  0,   0);
--setMoveKey(  261,    0,   -600,  0,   0);
setMoveKey(  270,    0,   -250,  0,   0);

kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  650,  150);   -- 伸びるかめはめ波
...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  280,  65);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);
