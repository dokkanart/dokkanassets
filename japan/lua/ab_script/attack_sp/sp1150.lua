...
-- ** 集中線 ** --
shuchusenct2 = entryEffectLife( spep_2, 906, 100, 0x100,  -1, 0,  0,  0);   -- 集中線 
...
setScaleKey( spep_2+100, 1, 1.5, 1.5); --敵サイズ
...
ryusen2 = entryEffectLife( spep_2+51, 920, 49, 0x80,  -1,  0,  0,  0); -- 流線
setEffMoveKey( spep_2+51, ryusen2, 0, 0, 0);
setEffRotateKey( spep_2+51, ryusen2, 320);
setEffRotateKey( spep_2+51, ryusen2, 320);
setEffScaleKey( spep_2+51, ryusen2, 1.6, 1.6);
...
entryFadeBg( spep_4, 0, 120, 0, 0, 0, 0, 210); -- ベース暗め　背景
...
-- 放つ（90F）
------------------------------------------------------
entryFadeBg( spep_6, 0, 90, 0, 0, 0, 0, 210); -- ベース暗め　背景
changeAnime( spep_6-1, 1, 108); --敵モーション
setScaleKey( spep_6-1, 1, 2.2,2.2); --敵サイズ
setMoveKey( spep_6-1, 1, 0, 0, 0); --敵位置
-- ** 奥行き流線斜め ** --
ryuusen6 = entryEffectLife( spep_6, 921, 90, 0x80,  -1, 0,  0,  0);   -- 流線斜め
setEffScaleKey( spep_6, ryuusen6, 1.7, 1.7);
setEffAlphaKey( spep_6, ryuusen6, 255);
setEffRotateKey(spep_6, ryuusen6, 310);

-- ** エフェクト等 ** --
hassya6 = entryEffectLife(  spep_6,   SP_05, 90,  0x80,  -1,  0,  0,  0);   --気溜め
...
changeAnime( spep_6, 1, 108); --敵モーション
changeAnime( spep_6+24, 1, 106); --敵モーション
setScaleKey( spep_6, 1, 2.2, 2.2); --敵サイズ
setScaleKey( spep_6+23, 1, 2.2, 2.2); --敵サイズ
setScaleKey( spep_6+51, 1, 3.5, 3.5); --敵サイズ
setMoveKey( spep_6, 1, -50, -50, 0); --敵位置
setMoveKey( spep_6+23, 1, -80, -50, 0); --敵位置
setMoveKey( spep_6+24, 1, -200, -150, 0); --敵位置
setMoveKey( spep_6+44, 1, -900, -800, 0); --敵位置
setRotateKey( spep_6, 1, -20); --敵角度
setRotateKey( spep_6+23, 1, -20); --敵角度
setRotateKey( spep_6+24, 1, -80); --敵角度
setRotateKey( spep_6+51, 1, -80); --敵角度
setShakeChara( spep_6+3, 1, 120, 15);

setDisp( spep_6+50, 1,0); --敵非表示

-- ** 集中線 ** --
shuchusenct6 = entryEffectLife( spep_6+8, 906, 90, 0x100,  -1, 0,  0,  -0);   -- 集中線 
setEffScaleKey( spep_6+8, shuchusenct6, 2, 2);
setEffAlphaKey( spep_6+8, shuchusenct6, 255);

-- 書き文字エントリー
ctZuo6 = entryEffectLife( spep_6+24, 10012, 50, 0x100, -1, 0, -200, 350); -- ズオッ
setEffShake(spep_6+25, ctZuo6, 64, 25);
setEffRotateKey(spep_6+24, ctZuo6, -20);
setEffShake(spep_6+24, ctZuo6, 71, 30);
setEffAlphaKey(spep_6+24, ctZuo6, 255);
setEffAlphaKey(spep_6+90, ctZuo6, 255);
--setEffAlphaKey(spep_6+90, ctZuo6, 0);
setEffScaleKey(spep_6+24, ctZuo6, 0.0, 0.0);
setEffScaleKey(spep_6+25, ctZuo6, 2.9, 2.9);
...
-- ** ホワイトフェード ** --
entryFade( spep_6+22, 1, 3, 3, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- ** エフェクト等 ** --
hassya6 = entryEffectLife(  spep_6,   SP_05e, 90,  0x80,  -1,  0,  0,  0);   --気溜め
setEffScaleKey( spep_6, hassya6, 1, 1);
setEffAlphaKey( spep_6, hassya6, 255);
setEffShake(spep_6, hassya6, 140, 5);
