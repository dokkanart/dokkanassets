...
ctgogo = entryEffectLife( 90,  190006, 68, 0x100, -1, 0, -9.9, 515.5 ); --ゴゴゴ
setEffShake( 90, ctgogo, 68, 10 );

setEffMoveKey( 90, ctgogo, -9.9, 515.5 , 0 );
setEffMoveKey( 158, ctgogo, -9.9, 515.5 , 0 );

setEffScaleKey( 90, ctgogo, 0.7, 0.7 );
setEffScaleKey( 150, ctgogo, 0.7, 0.7 );
setEffScaleKey( 152, ctgogo, 1.0, 1.0 );
setEffScaleKey( 154, ctgogo, 1.09, 1.09 );
setEffScaleKey( 156, ctgogo, 1.39, 1.39 );
setEffScaleKey( 158, ctgogo, 1.69, 1.69 );

setEffRotateKey( 90, ctgogo, 0 );
setEffRotateKey( 158, ctgogo, 0 );

setEffAlphaKey( 90, ctgogo, 255 );
setEffAlphaKey( 158, ctgogo, 255 );
...
entryFade( 255, 2, 8, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
