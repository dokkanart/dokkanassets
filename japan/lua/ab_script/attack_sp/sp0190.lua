...
setMoveKey(   0,   0,    300, -264,   0);
setMoveKey(   1,   0,    300, -264,   0);
...
-- かめはめ波溜め！(100F)
------------------------------------------------------
setScaleKey(   0,   0, 3.9, 3.9);
setScaleKey(   15,   0, 1.3, 1.3);
setMoveKey(   15,   0,    100, -64,   0);
...
shuchusen = entryEffectLife( SP_start+ 69, 906, 101, 0x00,  -1, 0,  0,  0);   -- 集中線

kame_hand1 = entryEffect( SP_start+ 69, SP_01, 0x40+0x80,      0,  300,  0,  0);   -- 手のカメハメ波部
--kame_hand1 = entryEffectLife( SP_start+ 69, SP_01, 115, 0x40+0x80,  0,  300,  0,  0);   -- 手のカメハメ波部

--setEffScaleKey( SP_start+ 70, kame_hand1, 1.2, 1.2);
setEffScaleKey( SP_start+69, kame_hand1, 1.5, 1.5);
setEffScaleKey( SP_start+69+15, kame_hand1, 0.5, 0.5);

--setEffAlphaKey( SP_start+69, kame_hand1, 0);
--setEffAlphaKey( SP_start+71, kame_hand1, 0);
--setEffAlphaKey( SP_start+72, kame_hand1, 255);

setEffAlphaKey( SP_start+69, kame_hand1, 255);
...
kame_hand2 = entryEffect( 91, SP_01, 0x40+0x80,      0,  300,  0,  0);   -- 手のカメハメ波部
setEffScaleKey( 91, kame_hand2, 0.5, 0.5);
...
-- カメハメハ発射(110F)
------------------------------------------------------
setScaleKey( SP_start+ 259,   0, 0.8, 0.8);
changeAnime( SP_start+ 260, 0, 31);                                    -- かめはめ発射ポーズ
setMoveKey( SP_start+  260,    0,      -100,  0,   -20);
setMoveKey( SP_start+  270,    0,      -100,  0,   -10);
setMoveKey( SP_start+  290,    0,   -130,  0,   0);
...
kamehame_beam = entryEffectLife( SP_start+ 260, SP_02, 112, 0x40+0x80,  0,  300,  -250,  0);   -- 伸びるかめはめ波
playSe( SP_start+ 260, 1027);
...
setEffScaleKey( SP_start+ 260, kamehame_beam, 1.4, 1.4);
setEffMoveKey( SP_start+ 260, kamehame_beam, -200, 0);
...
setEffMoveKey( SP_start+ 300, kamehame_beam, -250, 0);
setMoveKey( SP_start+  300,    0,   -350,  40,   50);
setMoveKey( SP_start+  305,    0,   -650,  70,   80);
setDisp( SP_start+  305, 0, 0);
setMoveKey( SP_start+  308,    0,   -500,  70,   80);
...
entryFade( SP_start2+ SP_start+ 365, 3, 3, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
setEffScaleKey( SP_start2+ SP_start+ 370, kamehame_beam, 1.4, 1.4);
setScaleKey( SP_start2+ SP_start+ 370,   0, 0.8, 0.8);
...
setMoveKey( SP_start2+ SP_start+  369,    1,  235,  0,   0);
setMoveKey( SP_start2+ SP_start+  370,    1,  235,  0,   0);
setMoveKey( SP_start2+ SP_start+  371,    1,  235,  0,   0);
setScaleKey( SP_start2+ SP_start+ 369,    1,  0.7, 0.7);
setScaleKey( SP_start2+ SP_start+ 370,    1,  0.7, 0.7);

setMoveKey( SP_start2+ SP_start+  400,    1,   120,  0,   0);
setScaleKey( SP_start2+ SP_start+  400,   1,   1.6,  1.6);

playSe( SP_start2+ SP_start+ 370, 1027);

kamehame_beam2 = entryEffect( SP_start2+ SP_start+ 370, SP_03,   0, -1,  0,  0,  0);   -- 迫るかめはめ波
setEffScaleKey( SP_start2+ SP_start+370, kamehame_beam2, 1, 1);
setEffScaleKey( SP_start2+ SP_start+400, kamehame_beam2, 1.4, 1.4);
--setEffScaleKey( SP_start2+ SP_start+454, kamehame_beam2, 2.5, 2.5);
setDamage( SP_start2+ SP_start+ 452, 1, 0);  -- ダメージ振動等

playSe( SP_start2+ SP_start+ 430, SE_09);
-- 敵吹っ飛ぶモーション
...
entryEffectLife( SP_start2+ SP_start+ 370, 921, 99, 0x80,  -1,  0,  0,  0); -- 流線斜め
...
setEffAlphaKey( SP_start2+ SP_start+410, ct, 255);
setEffAlphaKey( SP_start2+ SP_start+430, ct, 0);

ct2 = entryEffectLife( SP_start2+ SP_start+ 430, 10018, 30, 0, -1, 0, 100, 255); -- ドゴォンッ
setEffShake( SP_start2+ SP_start+430, ct2, 99, 20);
setEffScaleKey( SP_start2+ SP_start+ 430, ct2, 2.4, 2.4);
setEffScaleKey( SP_start2+ SP_start+ 460, ct2, 2.8, 2.8);
setEffRotateKey( SP_start2+ SP_start+430, ct2, 30);
setEffAlphaKey( SP_start2+ SP_start+430, ct2, 255);
setEffAlphaKey( SP_start2+ SP_start+450, ct2, 255);
setEffAlphaKey( SP_start2+ SP_start+460, ct2, 0);
...
entryEffect( SP_start2+ SP_start+  spep_5+1, 1509,  0x80,  -1,  0,  0,  0);   -- 爆発
playSe( SP_start2+ SP_start+  spep_5+1, SE_10);

setMoveKey( SP_start2+ SP_start+   spep_5+8,    1,    0,   0,   128);
...
-- 書き文字エントリー
ct = entryEffectLife( SP_start2+ SP_start+  spep_5+14, 10005, 100, 0, -1, 0, -50, 230); -- ガッ
setEffShake( SP_start2+ SP_start+  spep_5+15, ct, 30, 10);
setEffRotateKey( SP_start2+ SP_start+  spep_5+15, ct, -40);
setEffScaleKey( SP_start2+ SP_start+  spep_5+15, ct, 4.0, 4.0);
setEffScaleKey( SP_start2+ SP_start+  spep_5+16, ct, 2.0, 2.0);
setEffScaleKey( SP_start2+ SP_start+  spep_5+17, ct, 2.6, 2.6);
setEffScaleKey( SP_start2+ SP_start+  spep_5+18, ct, 4.0, 4.0);
setEffScaleKey( SP_start2+ SP_start+  spep_5+19, ct, 2.6, 2.6);
setEffScaleKey( SP_start2+ SP_start+  spep_5+20, ct, 3.8, 3.8);
setEffScaleKey( SP_start2+ SP_start+  spep_5+110, ct, 3.8, 3.8);
setEffAlphaKey( SP_start2+ SP_start+  spep_5+15, ct, 255);
setEffAlphaKey( SP_start2+ SP_start+  spep_5+105, ct, 255);
setEffAlphaKey( SP_start2+ SP_start+  spep_5+115, ct, 0);

playSe( SP_start2+ SP_start+  spep_5+3, SE_11);
shuchusen = entryEffectLife( SP_start2+ SP_start+  spep_5, 906, 120, 0x00,  -1, 0,  0,  0);   -- 集中線
entryEffect( SP_start2+ SP_start+  spep_5+3, 1600,  0x00,  -1,  0,30, -130);   -- ひび割れ

-- ダメージ表示
dealDamage( SP_start2+ SP_start+ spep_5+15);

entryFade( SP_start2+ SP_start+  spep_5+100, 9,  10, 1, 8, 8, 8, 255);             -- black fade
