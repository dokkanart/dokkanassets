...
kintoun = entryEffectLife(  spep_6,   SP_04, 49, 0x40+0x80,  0,  300,  -10,  -137); -- キン斗雲
...
nyoibou2 = entryEffectLife( SP_start2+  spep_6+82,   SP_02, 48, 0x40+0x100,  0,  300,  0,  -113); -- 如意棒
...
setEffAlphaKey( SP_start2+spep_6+111+10, kintoun, 255);
setEffAlphaKey( SP_start2+spep_6+112+10, kintoun, 0);
...
setEffAlphaKey( SP_dodges, kaihi, 255);
...
nyoibou2 = entryEffectLife( SP_start2+  spep_6+82,   SP_02, 48, 0x40+0x100,  0,  300,  132,  -63); -- 如意棒
setEffRotateKey( SP_start2+ spep_6+82, nyoibou2, 30);
...
--setEffScaleKey( SP_start2+ spep_6+82, kintoun, 2.6, 1.2);
setEffAlphaKey( SP_start2+spep_6+82, kintoun2, 255);
setEffMoveKey(   SP_start2+ spep_6+82,  kintoun2,  -100,  -87);
...
hit_eff_1 = entryEffect( SP_start+ spep_6+155,  4,  0x40,  -1,  0,  -230, 600);--HIT
hit_eff_2 = entryEffect( SP_start+ spep_6+155,  906,  0x40,  -1,  0,  -230, 600);
hit_eff_3 = entryEffect( SP_start+ spep_6+155,  908,  0x40,  -1,  0,  -230, 600);
