...
spep_x = 80;
-- ** 書き文字エントリー ** --
ctgogo = entryEffectLife( spep_x + 16,  190006, 68, 0x100, -1, 0, 200, 515.5 ); --ゴゴゴ
setEffShake( spep_x + 16, ctgogo, 68, 10 );

setEffMoveKey( spep_x + 16, ctgogo, 200, 515.5 , 0 );
...
entryFade( 170 - 10, 4, 4, 2, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( 255, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
entryFade( 260 - 10, 6, 8, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
spep_x = 80;
-- ** 書き文字エントリー ** --
ctgogo = entryEffectLife( spep_x + 16,  190006, 68, 0x100, -1, 0, 0, 515.5 ); --ゴゴゴ
setEffShake( spep_x + 16, ctgogo, 68, 10 );
