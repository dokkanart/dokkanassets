...
entryFadeBg( 0, 2, 40, 10, 250, 250, 250, 255);       -- ベース暗め　背景
...
-- ** カード消し ** --
setEffAlphaKey( 75, speff, 255);
setEffAlphaKey( SP_ATK_2, speff, 0);

setEffAlphaKey( 75, eff02, 255);
setEffAlphaKey( SP_ATK_2, eff02, 0);

setEffAlphaKey( 75, eff01, 255);
setEffAlphaKey( SP_ATK_2, eff01, 0);
...
entryFade( SP_ATK_2+85, 5, 3, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
