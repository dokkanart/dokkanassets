...
-- ** エフェクト等 ** --
aura = entryEffectLife(  30,   311, 39, 0x40,  0,  1,  0,  -60); -- オーラ
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  70,   311, 99, 0x40,  0,  1,  0,  -60); -- オーラ
setEffScaleKey( 30, aura, 2.0, 2.0);
setShakeChara( 70, 0, 49, 5);

kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  -64,  -70);   -- 手のカメハメ波部
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  0,  -30);   -- 伸びるかめはめ波
playSe( 260, SE_07);
setEffScaleKey( 260, kamehame_beam, 0.9, 0.9);
...
setMoveKey(  300,    0,   -300,  200,   70);
setMoveKey(  305,    0,   -450,  220,   120);
setMoveKey(  308,    0,   -1100,  0,   0);
...
-- 書き文字エントリー
ct = entryEffectLife( 268, 10012, 32, 0, -1, 0, 200, 500); -- ズオッ
...
kamehame_beam2 = entryEffect( 370, SP_03,   0, -1,  0,  -60,  -60);   -- 迫るかめはめ波
...
-- ** エフェクト等 ** --
aura = entryEffectLife( tyo+70,   311, 99, 0x40+0x80,  0,  1,  0,  -60); -- オーラ
setEffScaleKey( tyo+30, aura, 2.0, 2.0);
setShakeChara( tyo+70, 0, 49, 5);

kame_hand = entryEffect( tyo+70, SP_01, 0x40+0x100,   0,  300,  -64,  -70);   -- 手のカメハメ波部
setEffScaleKey( tyo+70, kame_hand, 0.8, 0.8);
...
--[[
setMoveKey(  tyo2+259,    0,      -500,  250,   0);
setMoveKey(  tyo2+270,    0,   -150,  150,   0);
setMoveKey(  tyo2+290,    0,   -150,  150,   0);

--]]

kamehame_beam = entryEffectLife(tyo2+260, SP_02, 109, 0x40,  0,  300,  0,  -30);   -- 伸びるかめはめ波
playSe(tyo2+260, SE_07);
setEffScaleKey( tyo2+260, kamehame_beam, 0.9, 0.9);
...
setMoveKey(  tyo2+300,    0,   -300,  200,   70);
setMoveKey(  tyo2+305,    0,   -450,  220,   120);
setMoveKey(  tyo2+308,    0,   -1100,  0,   0);
...
-- 書き文字エントリー
ct = entryEffectLife(tyo2+268, 10012, 32, 0, -1, 0, 200, 500); -- ズオッ
...
kamehame_beam2 = entryEffect(tyo2+370, SP_03,   0, -1,  0,  -60,  -60);   -- 迫るかめはめ波
