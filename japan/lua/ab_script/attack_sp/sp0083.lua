...
kame_hand = entryEffect( 70, SP_01, 0x100,   -1,  0,  30,  10);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 1.1, 1.1);
...
--speff = entryEffect(  80,   1504,   0,     -1,  0,  0,  0);   -- eff_005 (カットイン)
--setEffReplaceTexture( speff, 3, 2);                           -- カットイン差し替え
--peff = entryEffect(  80,   1505,   0,     -1,  0,  0,  0);   -- eff_006 (セリフ)
