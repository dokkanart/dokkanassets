...
setAnimeLoop( SP_ATK01+92+diff01+7, 1, 1);
...
--eff01_2 = entryEffect( SP_ATK01+35, SP_05, 0, 1,  0,  -50,  0);   -- 爆破
--setEffScaleKey( SP_ATK01+35, eff01_2,0.2,0.2);--サイズ
setShake(SP_ATK01+35,10,16);
--entryFlashBg( (SP_ATK01+35), 1, fcolor_r, fcolor_g, fcolor_b, 200);
changeAnime( SP_ATK01+36, 1, 106);--やられ  
setAnimeLoop( SP_ATK01+36, 1, 1); 
...
setAnimeLoop( SP_ATK01+57+diff01, 1, 1);  
...
setAnimeLoop( SP_ATK01+65+diff01, 1, 1);  
...
setAnimeLoop( SP_ATK01+76+diff01, 1, 1);  
...
setAnimeLoop( SP_ATK01+80+diff01, 1, 1);  
...
eff8_2 = entryEffect( SP_ATK01+35, SP_05, 0, 1,  0,  0,  0);   -- ヒットエフェクト
setEffScaleKey( SP_ATK01+35, eff08_2,0.5,0.5);--サイズ
...
setMoveKey(  SP_dodge+10, 0, 1200,  0,  0);
...
entryFade( SP_ATK_1+45, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 100);     -- white fade
------------------------------------------------------
-- カメハメハ発射(110F)
------------------------------------------------------
changeAnime( SP_ATK_2, 0, 31); 
setAnimeLoop( SP_ATK_2, 0, 1);
--P移動
...
setMoveKey(  SP_ATK_2+50,  0, 1200,  0,   0);
...
changeAnime( SP_ATK01, 1, 104);                     -- ガード
setAnimeLoop( SP_ATK01, 1, 1);
setMoveKey(  SP_ATK01,    1,  1200,  0,   50);
setMoveKey(  SP_ATK01+30,  1,  0,  0,   -128);
...
--eff01_2 = entryEffect( SP_ATK01+35, SP_05, 0, 1,  0,  -50,  0);   -- 爆破
--setEffScaleKey( SP_ATK01+35, eff01_2,0.2,0.2);--サイズ
--setEffShake( SP_ATK01+35, eff01_2,14,12);--サイズ
setShake(SP_ATK01+35,10,16);
--entryFlashBg( (SP_ATK01+35), 1, fcolor_r, fcolor_g, fcolor_b, 200);
changeAnime( SP_ATK01+36, 1, 106);--やられ
setAnimeLoop( SP_ATK01+36, 1, 1);   
...
playSe( SP_ATK01+50+diff01, SE_08);
changeAnime( SP_ATK01+50+diff01, 1, 105);--やられ 
setAnimeLoop( SP_ATK01+50+diff01, 1, 1);   
setShake( SP_ATK01+50+diff01, 3, 14);
setMoveKey(  SP_ATK01+50+diff01, 1, 0,  0,  0);
setMoveKey(  SP_ATK01+51+diff01, 1, 50,  -50,  0);
