...
entryFade( 160, 6, 4, 2, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- 書き文字エントリー
ctgogo=entryEffectLife(90,190006,70,0x100,-1,100,520);--ゴゴゴ
setEffShake( 90, ctgogo, 64, 8);

setEffMoveKey(90,ctgogo,100,520,0);
setEffMoveKey(160,ctgogo,100,520,0);
...
entryFade( 252, 6, 4, 2, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryEffect( 390, SP_04,  0x80,  -1,  0,  0,  0);   -- 伸びるかめはめ波
playSe( 380,1023);
SE0=playSe( 380,1044);
