...
aurabg = entryEffectLife( spep_0 + 0,  9020, 388 + 40 + 20, 0x100, -1, 0, 0, 0 );  --気溜め大成功
...
aurabg2 = entryEffectLife( spep_0 + 192 + 40 + 20,  9017, 194 , 0x80, -1, 0, 0, 0 );  -- 大成功だけ
setEffMoveKey( spep_0 + 192 + 40 + 20,  aurabg2,  0,  0,  0);
setEffMoveKey( spep_0 + 386 + 40 + 20,  aurabg2,  0,  0,  0);
setEffScaleKey( spep_0 + 192 + 40 + 20,  aurabg2,  1.0,  1.0);
setEffScaleKey( spep_0 + 386 + 40 + 20,  aurabg2,  1.0,  1.0);
setEffRotateKey(  spep_0 + 192 + 40 + 20,  aurabg2,  0);
setEffRotateKey(  spep_0 + 386 + 40 + 20,  aurabg2,  0);
setEffAlphaKey(  spep_0 + 192 + 40 + 20,  aurabg2,  255);
setEffAlphaKey(  spep_0 + 386 + 40 + 20,  aurabg2,  255);
...
setSeVolume( spep_0 + 72,  1036,  71);
playSe( spep_0 + 72,  1072);
playSe( spep_0 + 96,  1036);
setSeVolume( spep_0 + 96,  1036,  71);
playSe( spep_0 + 120, 1036);
setSeVolume( spep_0 + 120,  1036,  71);
playSe( spep_0 + 130, 1018);
playSe( spep_0 + 144, 1036);
setSeVolume( spep_0 + 144,  1036,  71);
playSe( spep_0 + 168,  1036);
setSeVolume( spep_0 + 168,  1036,  71);
playSe( spep_0 + 192,  1036);
setSeVolume( spep_0 + 192,  1036,  71);
playSe( spep_0 + 207,  1035);
playSe( spep_0 + 207,  1043);
setSeVolume( spep_0 + 207,  1043,  89);
playSe( spep_0 + 207,  1024);
playSe( spep_0 + 207,  1044);
SE1 = setSeVolume( spep_0 + 207,  1044,  71);
stopSe( spep_0 + 383,  1044,  0);
playSe( spep_0 + 216,  SE1,  0);
setSeVolume( spep_0 + 216,  1036,  71);
playSe( spep_0 + 240,  1036);
setSeVolume( spep_0 + 240,  1036,  71);
playSe( spep_0 + 263,  1036);
setSeVolume( spep_0 + 263,  1036,  71);
playSe( spep_0 + 283,  1148);
setSeVolume( spep_0 + 283,  1148,  79);
playSe( spep_0 + 286,  1036);
setSeVolume( spep_0 + 286,  1036,  71);
playSe( spep_0 + 309,  1036);
setSeVolume( spep_0 + 309,  1036,  71);
playSe( spep_0 + 332,  1036);
setSeVolume( spep_0 + 332,  1036,  71);
playSe( spep_0 + 347,  1011);
setSeVolume( spep_0 + 347,  1011,  71);
playSe( spep_0 + 347,  1062);
setSeVolume( spep_0 + 347,  1062,  89);
playSe( spep_0 + 347,  1049);
playSe( spep_0 + 355,  1036);
setSeVolume( spep_0 + 355,  1036,  71);
playSe( spep_0 + 378,  1036);
setSeVolume( spep_0 + 378,  1036,  71);
