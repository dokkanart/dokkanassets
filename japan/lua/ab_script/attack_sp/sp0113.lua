...
kame_hand = entryEffect( 70, SP_01, 0x80,      0,  300,  0,  0);   -- 手のカメハメ波部
...
kame_hand = entryEffectLife( SP_ATK_0+2, SP_01, 70, 0x40+0x100,  0,  300,  0,  0);   -- 手のカメハメ波部
...
kamehame_beam = entryEffectLife( SP_ATK_2+2, SP_02, 90 -1, 0x40,  0,  300,  0,  0);   -- 伸びるかめはめ波
...
entryFade( SP_ATK_3 -4, 2, 4, 2, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
