...
SP_04 = 152854; --ビル破壊前
SP_05 = 152855; --ビル破壊奥
SP_06 = 152856; --敵がビルに激突前
SP_07 = 152857; --敵がビルに激突奥
SP_08 = 152858; --かめはめ波構え
SP_09 = 152859; --発射
SP_10 = 152860; --敵に迫る前
SP_11 = 152861; --敵に迫る奥
SP_12 = 190000; --ギャン
...
SP_04r = 152866; --ビル破壊前
SP_05r = 152867; --ビル破壊奥
SP_06r = 152868; --敵がビルに激突前
SP_07r = 152869; --敵がビルに激突奥
SP_08r = 152858; --かめはめ波構え
SP_09r = 152870; --発射
SP_10r = 152871; --敵に迫る前
SP_11r = 152872; --敵に迫る奥
SP_12r = 190000; --ギャン
...
setScaleKey(spep_1-3+87, 1, 2.01-a, 2.01-a );
setScaleKey(spep_1-3+89, 1, 2.02-a, 2.02-a );
setScaleKey(spep_1-4+90, 1, 2.02-a, 2.02-a );
...
setScaleKey(spep_1-3+118, 1, 2.08-a, 2.0-a );
setScaleKey(spep_1-3+119, 1, 2.08-a, 2.0-a );

setScaleKey(spep_1-3+120, 1, 0.8-b, 0.8-b );
setScaleKey(spep_1-3+122, 1, 0.85-b, 0.85-b );
setScaleKey(spep_1-3+128, 1, 0.85-b, 0.85-b );
setScaleKey(spep_1-3+130, 1, 0.86-b, 0.86-b );
setScaleKey(spep_1-3+132, 1, 0.8-b, 0.8-b );
setScaleKey(spep_1-3+138, 1, 0.8-b, 0.8-b );
setScaleKey(spep_1-3+140, 1, 0.85-b, 0.85-b );
setScaleKey(spep_1-3+146, 1, 0.85-b, 0.85-b );
setScaleKey(spep_1-3+148, 1, 0.8-b, 0.8-b );
setScaleKey(spep_1-3+154, 1, 0.8-b, 0.8-b );
setScaleKey(spep_1-3+156, 1, 0.85-b, 0.85-b );
setScaleKey(spep_1-3+166, 1, 0.85-b, 0.85-b );
setScaleKey(spep_1-3+168, 1, 0.8-b, 0.8-b );
setScaleKey(spep_1-3+174, 1, 0.8-b, 0.8-b );
setScaleKey(spep_1-3+176, 1, 0.85-b, 0.85-b );
setScaleKey(spep_1-3+180, 1, 0.85-b, 0.85-b );
setScaleKey(spep_1-3+182, 1, 0.86-b, 0.86-b );
setScaleKey(spep_1-3+184, 1, 0.86-b, 0.86-b );
setScaleKey(spep_1-3+186, 1, 0.85-b, 0.85-b );
setScaleKey(spep_1-3+190, 1, 0.85-b, 0.85-b );
setScaleKey(spep_1-3+192, 1, 0.8-b, 0.8-b );
setScaleKey(spep_1-3+198, 1, 0.8-b, 0.8-b );
setScaleKey(spep_1-3+200, 1, 0.85-b, 0.85-b );
setScaleKey(spep_1-3+206, 1, 0.85-b, 0.85-b );
setScaleKey(spep_1-3+208, 1, 0.86-b, 0.86-b );
setScaleKey(spep_1-3+210, 1, 0.8-b, 0.8-b );
setScaleKey(spep_1-3+218, 1, 0.85-b, 0.85-b );
...
--白フェード
entryFade( spep_1-6+47, 0, 2, 2, fcolor_r, fcolor_g, fcolor_b, 230);     -- white fade
...
--書き文字(ズオッ)
ctZuo2 = entryEffectLife( spep_4-2 + 30,  10012, 48, 0x100, -1, 0, 78.7, 260.5 );
setEffMoveKey( spep_4-2 + 30, ctZuo2, 78.7, 260.5 , 0 );
setEffMoveKey( spep_4-2 + 32, ctZuo2, 105, 288.6 , 0 );
setEffMoveKey( spep_4-2 + 34, ctZuo2, 117.9, 330.1 , 0 );
setEffMoveKey( spep_4-2 + 36, ctZuo2, 153.7, 348.8 , 0 );
setEffMoveKey( spep_4-2 + 38, ctZuo2, 137.7, 364.8 , 0 );
setEffMoveKey( spep_4-2 + 40, ctZuo2, 153.7, 348.8 , 0 );
setEffMoveKey( spep_4-2 + 42, ctZuo2, 137.7, 364.8 , 0 );
setEffMoveKey( spep_4-2 + 44, ctZuo2, 153.7, 348.8 , 0 );
setEffMoveKey( spep_4-2 + 46, ctZuo2, 137.7, 364.8 , 0 );
setEffMoveKey( spep_4-2 + 48, ctZuo2, 153.7, 348.8 , 0 );
setEffMoveKey( spep_4-2 + 50, ctZuo2, 137.7, 364.8 , 0 );
setEffMoveKey( spep_4-2 + 52, ctZuo2, 153.7, 348.8 , 0 );
setEffMoveKey( spep_4-2 + 54, ctZuo2, 137.7, 364.8 , 0 );
setEffMoveKey( spep_4-2 + 56, ctZuo2, 153.7, 348.8 , 0 );
setEffMoveKey( spep_4-2 + 58, ctZuo2, 137.7, 364.8 , 0 );
setEffMoveKey( spep_4-2 + 60, ctZuo2, 153.7, 348.8 , 0 );
setEffMoveKey( spep_4-2 + 62, ctZuo2, 137.7, 364.8 , 0 );
setEffMoveKey( spep_4-2 + 64, ctZuo2, 153.7, 348.8 , 0 );
setEffMoveKey( spep_4-2 + 66, ctZuo2, 137.7, 364.8 , 0 );
setEffMoveKey( spep_4-2 + 68, ctZuo2, 153.7, 348.8 , 0 );
setEffMoveKey( spep_4-2 + 70, ctZuo2, 137.7, 364.8 , 0 );
setEffMoveKey( spep_4-2 + 72, ctZuo2, 167.1, 345 , 0 );
setEffMoveKey( spep_4-2 + 74, ctZuo2, 153.1, 368.5 , 0 );
setEffMoveKey( spep_4-2 + 76, ctZuo2, 193.8, 337.2 , 0 );
setEffMoveKey( spep_4-2 + 78, ctZuo2, 207.3, 333.2 , 0 );

setEffScaleKey( spep_4-2 + 30, ctZuo2, 0.34, 0.34 );
setEffScaleKey( spep_4-2 + 32, ctZuo2, 1.13, 1.13 );
setEffScaleKey( spep_4-2 + 34, ctZuo2, 1.94, 1.94 );
setEffScaleKey( spep_4-2 + 36, ctZuo2, 2.73, 2.73 );
setEffScaleKey( spep_4-2 + 70, ctZuo2, 2.73, 2.73 );
setEffScaleKey( spep_4-2 + 72, ctZuo2, 3.68, 3.68 );
setEffScaleKey( spep_4-2 + 74, ctZuo2, 4.67, 4.67 );
setEffScaleKey( spep_4-2 + 76, ctZuo2, 5.63, 5.63 );
setEffScaleKey( spep_4-2 + 78, ctZuo2, 6.62, 6.62 );
...
setShakeChara(  spep_4-7+90,  1,  58,  10);  --揺れ
...
--顔カットイン
--speff=entryEffect(spep_2-330,1504,0x100,-1,0,0,0);  --カットイン(顔)
--setEffReplaceTexture(speff,3,2);  --カットイン差し替え
--speff1=entryEffect(spep_2-330,1505,0x100,-1,0,0,0);  --カットイン(セリフ)
--setEffReplaceTexture(speff1,4,5);  --セリフカットイン差し替え
