...
setMoveKey(   0,   0,    0, -34,   0);--プラス20
setMoveKey(   1,   0,    0, -34,   0);--プラス20
...
-- ** エフェクト等 ** --
aura = entryEffectLife(  30,   311, 39, 0x40,  0,  1,  24,  -60); -- オーラ
...
------------------------------------------------------
setVisibleUI(69, 0);
changeAnime( 70, 0, 30);                       -- 溜め! 　いらないかも？
playSe( 73, SE_03);


entryEffect(  70,   1503,   0x80,  -1,  0,  0,  0);   -- eff_004 (気)
entryEffect(  70,   1502,   0,     -1,  0,  0,  0);   -- eff_003 (気)
setEffScaleKey( 70, cte, 1.5, 1.5);
setShakeChara( 70, 0, 19, 5);
...
--kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  0,  0);   -- 手のカメハメ波部削除
--setEffScaleKey( 70, kame_hand, 0.5, 0.5);

entryFade( 165, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
aura = entryEffectLife(  70,   311, 99, 0x40+0x80,  0,  1,  20,  -60); -- オーラ
setEffScaleKey( 30, aura, 2.0, 2.0);
setShakeChara( 70, 0, 49, 5);

kame_hand = entryEffectLife(  70,   SP_01, 99, 0x40,  0,  300,  -80,  -100); -- 技溜めエフェクト
setEffScaleKey( 70, kame_hand, 0.8, 0.8);
...
--[[
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  -180,  -10);   -- 伸びるかめはめ波
setEffScaleKey( 260, kamehame_beam, 0.7, 0.7);
--]]
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  -200,  -45);   -- 伸びるかめはめ波
...
-- ** エフェクト等 ** --
--aura = entryEffectLife( SP_ATK_0,   311, 100, 0x40,  0,  1,  20,  -60); -- オーラ
aura = entryEffectLife(  SP_ATK_0,   311, 99, 0x40+0x80,  0,  1,  20,  -60); -- オーラ
setEffScaleKey( SP_ATK_0, aura, 2.0, 2.0);
setShakeChara( SP_ATK_0+40, 0, 49, 5);


kame_hand = entryEffect( SP_ATK_0, SP_01, 0x40+0x100, 0,  300,  -80,  -100);   -- - 技溜めエフェクト
setEffScaleKey( SP_ATK_0, kame_hand, 0.8, 0.8);
...
--setEffMoveKey(  SP_ATK_2-1,    kame_hand,      0,  -60,   0);
--setEffScaleKey( SP_ATK_2-1,   kame_hand, 1.5, 1.5);

setScaleKey( SP_ATK_2,   0, 1.0, 1.0);
--setEffScaleKey( SP_ATK_2,   kame_hand, 1.0, 1.0);

setMoveKey(  SP_ATK_2+5,    0,      0,  0,   0);
setMoveKey(  SP_ATK_2+10,   0,   -100,  0,   0);

--kamehame_beam = entryEffectLife( SP_ATK_2+1, SP_02, 90, 0x40,  0,  300,  -200,  -45);   -- 伸びるかめはめ波
--kamehame_beam = entryEffectLife( SP_ATK_2+1, SP_02, 90, 0x40,  0,  300,  200,  -45);   -- 伸びるかめはめ波
kamehame_beam = entryEffectLife( SP_ATK_2+1, SP_02, 90, 0x40,  0,  300,  -200,  -45);   -- 伸びるかめはめ波
setEffScaleKey( SP_ATK_2+1, kamehame_beam, 1.0, 1.0);
...
setMoveKey(  SP_ATK_2+26,    0,   -100,  0,   0);
