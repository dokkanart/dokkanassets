...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  200,  170);   -- 伸びるかめはめ波
...
HitEff1 = entryEffect( 453, 4,   0, -1,  0,  0,  0); 
setEffScaleKey(453 ,HitEff1 , 2 , 2);
setEffMoveKey(453, HitEff1 ,50 , 0  ,0);

--setEffMoveKey(446, kamehame_beam2 ,0 , 0  ,0);
--setEffMoveKey(450, kamehame_beam2 ,100 , 30,  0);
--setEffScaleKey(446 ,kamehame_beam2 , 1 ,1);
--setEffScaleKey(450 ,kamehame_beam2 , 0.6 ,0.6);
