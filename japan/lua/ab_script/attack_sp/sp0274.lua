...
setEffAlphaKey(364, kamehame_beam, 255);
setEffAlphaKey(365, kamehame_beam, 0);
playSe( 260, SE_07);
...
SP_dodge = 407; --エンドフェイズのフレーム数を置き換える
