...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  25,  -5);   -- 手のカメハメ波部
...
SP_dodge = 408; --エンドフェイズのフレーム数を置き換える
...
setEffMoveKey(  410, kamehame_beam2,  120,    0,  0);
setEffMoveKey(  452, kamehame_beam2,  160,    0,  0);
setEffMoveKey(  453, kamehame_beam2,  400,    0,  0);
setEffScaleKey(454, kamehame_beam2, 1.5, 1.5);
