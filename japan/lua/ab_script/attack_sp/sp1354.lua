--1018090:トランクス(青年期)_フラッシュブレード(ドッカン前)
--sp_effect_b2_00028
...
--敵側
SP_01x=	154503	;--	手前突進	(敵)
SP_02x=	154506	;--	ラッシュ	(敵)
SP_03x=	154507	;--	ラッシュ	(敵)
SP_04x=	154508	;--	抜刀	
SP_05x=	154511	;--	フィニッシュ	(敵)
SP_06x=	154512	;--	フィニッシュ	(敵)
------------------------------------------------------
-- テンプレ構文
------------------------------------------------------
multi_frm = 2;
...
setEffMoveKey( spep_3 + 118, espada, 0, 0 , 0 );
setEffScaleKey( spep_3 + 0, espada, 1.0, 1.0 );
setEffScaleKey( spep_3 + 118, espada, 1.0, 1.0 );
setEffRotateKey( spep_3 + 0, espada, 0 );
setEffRotateKey( spep_3 + 118, espada, 0 );
setEffAlphaKey( spep_3 + 0, espada, 255 );
setEffAlphaKey( spep_3 + 118, espada, 255 );
...
playSe( spep_3 + 103, 1032 );
se_1141 = playSe( spep_3 + 103, 1141 );
...
------------------------------------------------------
-- ** エフェクト等 ** --
finish_f = entryEffect( spep_5 + 0, SP_05, 0x100, -1, 0, 0, 0 );  --登場(ef_001)
...
-- ** エフェクト等 ** --
finish_b = entryEffect( spep_5 + 0, SP_06, 0x80, -1, 0, 0, 0 );  --登場(ef_001)
...
--SE
se_1023 = playSe( spep_5 + 64, 1023 );
playSe( spep_5 + 64, 1159 );

setSeVolume( spep_5 + 64, 1159, 50 );
