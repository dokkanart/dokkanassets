...
kamehame_beam = entryEffectLife( SP_Start+260, SP_01, 109, 0x40,  0,  300,  200,  80);   -- 伸びるかめはめ波
setEffMoveKey( 32+15, kamehame_beam,   190, 80, 0);
setEffMoveKey( 45+15, kamehame_beam,   150, 80, 0);
setEffMoveKey( 50+15, kamehame_beam,   50, 80, 0);
