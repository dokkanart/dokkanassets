...
aura = entryEffectLife(  spep_1,   353, 120, 0x40+0x80,  0,  1,  60,  -50); -- オーラ
setEffScaleKey( spep_1, aura, 2, 2);
setShakeChara( spep_1, 0, 120, 5);


kame_hand = entryEffect( spep_1, SP_01, 0x40+0x80,0, 300, 30,120);   -- 手のカメハメ波部
...
setEffScaleKey(spep_5+110,explosion,1.2,1.2);
...
setMoveKey( spep_1-1,   0,   0, 0,   0);
setMoveKey( spep_1,   0,   60, 0,   0);
setMoveKey( spep_1+100,   0, 60,   0,   0);
setMoveKey( spep_1+120,   0, 60,   0,   0);
...
aura = entryEffectLife(  spep_1,   353, 120, 0x40+0x80,  0,  1,  -40,  -75); -- オーラ
setEffScaleKey( spep_1, aura, 2, 2);
setShakeChara( spep_1, 0, 120, 5);


kame_hand = entryEffect( spep_1, SP_01, 0x40+0x100,0, 300, -80,60);   -- 手のカメハメ波部
setEffScaleKey( spep_1, kame_hand, 0.8, 0.8);
