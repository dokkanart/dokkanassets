...
-- 途中からカメハメハが伸びる
setMoveKey(  280,    0,   -100,  0,   0);
setMoveKey(  300,    0,   -350,  0,   0);
setMoveKey(  308,    0,   -800,  0,   0);
...
kamehame_beam2 = entryEffect( 370, SP_03,   0, -1,  0,  80,  0);   -- 迫るかめはめ波
...
entryFade( 62, 5, 8, 5, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade
