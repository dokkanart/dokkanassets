...
kame_hand = entryEffect( 70, SP_01, 0x40+0x80,      0,  300,  10,  40);   -- 手のカメハメ波部
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40,  0,  300,  260,  60);   -- 伸びるかめはめ波：：
setShakeChara( 260, 0, 48, 25);
...
kame_hand = entryEffect( SP_ATK_0, SP_01, 0x40, 0,  300,  -10,  40);   -- 手のカメハメ波部
setEffScaleKey( SP_ATK_0, kame_hand, 1, 1);
setShakeChara( SP_ATK_0, 0, 16, 5);

-- ** エフェクト等 ** --
--aura = entryEffectLife( SP_ATK_0,   311, 100, 0x40+0x80,   0,  1,  0,  -100); -- オーラ
...
kamehame_beam = entryEffectLife( SP_ATK_2+1, SP_02, 90, 0x40,  0,  300,  260,  60);   -- 伸びるかめはめ波
setShakeChara( SP_ATK_2+1, 0, 48, 25);
