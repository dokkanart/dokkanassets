...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  70,  0);   -- 手のカメハメ波部
...
kame_hand = entryEffect( SP_ATK_0, SP_01, 0x40+0x100, 0,  300,  70,  0);   -- 手のカメハメ波部
...
kamehame_beam = entryEffectLife( SP_ATK_2, SP_02, 90, 0x40,  0,  300,  100,  0);   -- 伸びるかめはめ波
