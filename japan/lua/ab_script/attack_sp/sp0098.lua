...
entryFade( 163, 3, 5, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40+0x80,  0,  300,  0,  0);   -- 伸びるかめはめ波
setEffScaleKey( 260, kamehame_beam, 1.05, 1.0);
...
setScaleKey( SP_ATK_2-1,   0, 2.5, 2.5);
setScaleKey( SP_ATK_2,   0, 1.0, 1.0);

setMoveKey(  SP_ATK_2+5,    0,      0,  0,   0);
setMoveKey(  SP_ATK_2+10,   0,   -100,  0,   0);

kamehame_beam = entryEffectLife( SP_ATK_2+1, SP_02, 90, 0x40+0x80,  0,  300,  0,  0);   -- 伸びるかめはめ波
setEffScaleKey( SP_ATK_2+1, shuchusen, 1.05, 1.0);
...
setMoveKey(  SP_ATK_2+33,    0,   -550,  0,   0);
setDisp( SP_ATK_2+33, 0, 0);

setMoveKey(  SP_ATK_2+75,    0,   -600,  0,   0);
setMoveKey(  SP_ATK_2+80,    0,   -650,  0,   0);
