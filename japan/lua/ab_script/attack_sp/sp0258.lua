...
kamehame_beam = entryEffectLife( SP_start+ 260, SP_02, 109, 0x40,  0,  300,  300,  50);   -- 伸びるかめはめ波
...
-- 書き文字エントリー
ct = entryEffectLife( SP_start+ 425-parX, 10018, 99-parX, 0, -1, 0, 0, 255); -- ドゴォン
