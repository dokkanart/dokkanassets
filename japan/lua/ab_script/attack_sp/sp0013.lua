...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  -105,  0);   -- 手のカメハメ波部
...
entryFade( 560, 9,  10, 1, 8, 8, 8, 255);             -- black fade
...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  -125,  30);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);
