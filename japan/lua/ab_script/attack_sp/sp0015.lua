...
-- ** エフェクト等 ** --
aura = entryEffectLife(  30,   311, 39, 0x80,  -1,  0,  -30,  -200); -- オーラ
...
setMoveKey(  260,    0,   -600,  -35,   0);
setMoveKey(  261,    0,   -600,  -35,   0);
setMoveKey(  270,    0,   -120,  -35,   0);
...
-- 途中からカメハメハが伸びる
setMoveKey(  299,    0,   -120,  -20,   0);
setMoveKey(  300,    0,   -120,  -20,   0);
setMoveKey(  308,    0,   -1100,  -20,   0);
...
entryFade( 460, 6,  8, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
------------------------------------------------------
-- 回避
------------------------------------------------------
