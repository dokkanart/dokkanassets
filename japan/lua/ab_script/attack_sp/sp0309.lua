...
setShakeChara( 69, 0, 100, 10);

setMoveKey(   69,   0,    0, -54,   0);
setMoveKey(   70,   0,    20, -54,   0);
setMoveKey(   169,   0,    20, -54,   0);
...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  5,  220);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);

--entryFade( 165, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
--aura = entryEffectLife(  70,   311, 99, 0x40,  0,  1,  -30,  -50); -- オーラ
--setEffScaleKey( 30, aura, 1.5, 1.5);
...
kamehame_beam = entryEffect( 260, SP_02, 0x40,  0,  300, 170, 310);   -- 伸びるかめはめ波
playSe( 260, SE_07);
setEffMoveKey(  287,  kamehame_beam,  150,290);
setEffMoveKey(  292,  kamehame_beam,  150,270);
setEffMoveKey(  303,  kamehame_beam,  80,170);
...
kame_hand = entryEffect( 70, SP_01, 0x40,      0,  300,  13,  220);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);
