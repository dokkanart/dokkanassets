...
entryEffect( 260, SP_02,  0x40,  0,  0,  0,  0); 

setScaleKey( 270, 0, 1.5, 1.5);
setScaleKey( 271, 0, 0.7, 0.7);
changeAnime( 271, 0, 31);                                    -- かめはめ発射ポーズ

--P移動
setMoveKey(  259,    0,      0,  0,   0);
setMoveKey(  305,  0,   0,  0,   0);
setMoveKey(  310,  0,   -100,  0,   0);
setMoveKey(  315,  0,   -150,  0,   0);

playSe( 305, SE_06);
--setScaleKey( 306,0,3,3);
setMoveKey(  325,  0, 1700,  0,   0);
setMoveKey(  329,  0, 1700,  0,   0);
setMoveKey(  330,  0, -1700,  0,   0);

setShakeChara( 274, 0, 20, 30);

kamehame_beam = entryEffectLife( 281, SP_03, 79, 0x80, 0,  -800,  0,  0);   -- 伸びるかめはめ波



setEffMoveKey(  281,    kamehame_beam,   -200,  0,   0);
setEffMoveKey(  305,  kamehame_beam,   -200,  0,   0);
setEffMoveKey(  310,  kamehame_beam,   -300,  0,   0);
setEffMoveKey(  315,  kamehame_beam,   -350,  0,   0);
setEffMoveKey(  325,  kamehame_beam, 1700,  0,   0);
...
-- 書き文字エントリー
ct = entryEffectLife( 263, 10012, 32, 0, -1, 0, 150, 350); -- ズオッ
setEffShake(263, ct, 32, 5);
setEffAlphaKey(263, ct, 255);
setEffAlphaKey(290, ct, 255);
setEffAlphaKey(295, ct, 0);
setEffScaleKey(263, ct, 0.0, 0.0);
setEffScaleKey(268, ct, 2.5, 2.5);
setEffScaleKey(290, ct, 2.5, 2.5);
...
kamehame_beam3 = entryEffectLife( SP_ATK_3+24, SP_03, 16, 0x40+0x80, 0, 0, 0, 0);
--setEffScaleKey(SP_ATK_3+24, kamehame_beam3, 1.5, 1.5);
--playSe( SP_ATK_3, SE_08);
--setMoveKey(  SP_ATK_3+24,  0, -700,  0,   0);
--setMoveKey(  SP_ATK_3+35,  0, 1000,  0,   0);

setEffMoveKey(  SP_ATK_3+24,  kamehame_beam3, -700,  0,   5);
setEffMoveKey(  SP_ATK_3+28,  kamehame_beam3, -400,  0,   5);
setEffMoveKey(  SP_ATK_3+30,  kamehame_beam3, -100,  0,   5);
setEffMoveKey(  SP_ATK_3+32,  kamehame_beam3, 300,  0,   5);
setEffMoveKey(  SP_ATK_3+35,  kamehame_beam3, 700,  0,   5);
...
spname = entryEffect( SP_ATK_1+10, 1508,  0x100,  -1,  0,  0,  0);               -- かめはめ波文字
setEffReplaceTexture(spname, 7, 4);                                  -- 技名テクスチャ差し替え
...
-- カメハメハ発射(110F)
------------------------------------------------------
entryEffect( SP_ATK_2, SP_02,  0x40,  0,  0,  0,  0); 

setScaleKey( SP_ATK_2+10, 0, 1.5, 1.5);
setScaleKey( SP_ATK_2+11, 0, 0.7, 0.7);
changeAnime( SP_ATK_2+11, 0, 31);                                    -- かめはめ発射ポーズ

--P移動
setMoveKey(  SP_ATK_2-1,    0,    0,  0,   0);
setMoveKey(  SP_ATK_2+45,  0,   0,  0,   0);
setMoveKey(  SP_ATK_2+50,  0,   -100,  0,   0);

SE0=playSe(  SP_ATK_2+45, SE_06);

setMoveKey(  SP_ATK_2+65,  0, 1700,  0,   0);
setMoveKey(  SP_ATK_2+68,  0, 1700,  0,   0);
setMoveKey(  SP_ATK_2+69,  0, -1700,  0,   0);

setShakeChara(  SP_ATK_2+14, 0, 20, 30);

kamehame_beam = entryEffectLife( SP_ATK_2+21, SP_03, 79, 0x80,  -1,  -800,  0,  0);   -- 伸びるかめはめ波
setEffMoveKey(  SP_ATK_2+21,    kamehame_beam,   -200,  0,   0);
setEffMoveKey(  SP_ATK_2+45,  kamehame_beam,   -200,  0,   0);
setEffMoveKey(  SP_ATK_2+50,  kamehame_beam,   -300,  0,   0);
setEffMoveKey(  SP_ATK_2+52,  kamehame_beam,   -160,  0,   0);
setEffMoveKey(  SP_ATK_2+54,  kamehame_beam,   100,  0,   0);
setEffMoveKey(  SP_ATK_2+56,  kamehame_beam,   400,  0,   0);
setEffMoveKey(  SP_ATK_2+58,  kamehame_beam,   700,  0,   0);
setEffMoveKey(  SP_ATK_2+65,  kamehame_beam, 1500,  0,   0);
...
-- 書き文字エントリー
ct = entryEffectLife( SP_ATK_2+3, 10012, 32, 0, -1, 0, 150, 300); -- ズオッ
setEffShake(SP_ATK_2+3, ct, 32, 5);
setEffAlphaKey(SP_ATK_2+3, ct, 255);
setEffAlphaKey(SP_ATK_2+30, ct, 255);
setEffAlphaKey(SP_ATK_2+40, ct, 0);
setEffScaleKey(SP_ATK_2+3, ct, 0.0, 0.0);
setEffScaleKey(SP_ATK_2+8, ct, 2.5, 2.5);
setEffScaleKey(SP_ATK_2+32, ct, 2.5, 2.5);
...
SP_dodge = 199; --エンドフェイズのフレーム数を置き換える
...
entryFade( SP_dodge+5, 4,  7, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
setMoveKey(  SP_dodge,  0, -1700,  0,   0);
setMoveKey(  SP_dodge+9,  0, -1700,  0,   0);
...
setEffMoveKey(  SP_ATK_3+24,  kamehame_beam3, -700,  0,   5);
setEffMoveKey(  SP_ATK_3+28,  kamehame_beam3, -400,  0,   5);
setEffMoveKey(  SP_ATK_3+30,  kamehame_beam3, -150,  0,   5);
setEffMoveKey(  SP_ATK_3+32,  kamehame_beam3, -100,  0,   5);
setEffMoveKey(  SP_ATK_3+35,  kamehame_beam3, 700,  0,   5);
