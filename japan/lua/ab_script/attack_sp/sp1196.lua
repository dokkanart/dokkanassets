...
setEffScaleKey( spep_3 , ctzuo, 0.37, 0.37 );
setEffScaleKey( spep_3+2, ctzuo, 1.23, 1.23 );
setEffScaleKey( spep_3+4, ctzuo, 2.12, 2.12 );
setEffScaleKey( spep_3+6, ctzuo, 2.98, 2.98 );
setEffScaleKey( spep_3+50, ctzuo, 2.98, 2.98 );
setEffScaleKey( spep_3+52, ctzuo, 3.87, 3.87 );
setEffScaleKey( spep_3+54, ctzuo, 4.76, 4.76 );
setEffScaleKey( spep_3+56, ctzuo, 5.65, 5.65 );
setEffScaleKey( spep_3+58, ctzuo, 6.55, 6.55 );
setEffScaleKey( spep_3+60, ctzuo, 7.44, 7.44 );
...
shuchusen6 = entryEffectLife( spep_9, 906, 120, 0x100,  -1, 0,  0,  0);

setEffMoveKey(  spep_9,  shuchusen6,  0,  0);
setEffScaleKey(  spep_9,  shuchusen6,  1.55,  1.55);
setEffRotateKey(  spep_9,  shuchusen6,  0);
setEffAlphaKey(  spep_9,  shuchusen6,  255);
setEffMoveKey(  spep_9+120,  shuchusen6,  0,  0);
setEffScaleKey(  spep_9+120,  shuchusen6,  1.55,  1.55);
setEffRotateKey(  spep_9+120,  shuchusen6,  0);
setEffAlphaKey(  spep_9+120,  shuchusen6,  255);
