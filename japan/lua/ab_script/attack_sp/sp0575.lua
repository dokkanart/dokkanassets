...
--エフェクト
SP_01=	154022	;--	登場して移動
SP_02=	154023	;--	移動から現れて3発気弾
SP_03=	154024	;--	地上に3回着弾(前面)
SP_04=	154025	;--	地上に3回着弾(背面)
SP_05=	154026	;--	溜め
SP_06=	154027	;--	正面斜め下へかめはめ波
SP_07=	154028	;--	遠方で爆発
...
--SE
playSe( spep_2, 1023);--爆発
playSe( spep_2+44, 1023);--爆発
playSe( spep_2+78, 1023);--爆発
...
--SE
SE1=playSe( spep_5+12, 1021);--ビームを放つ
stopSe( spep_5+100, SE1, 30 );

-- ** ホワイトフェード ** --
entryFade( spep_5 + 8, 0, 4, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  -- white fade
...
-----------------------------------------------------
-- ** エフェクト等 ** --
gyan = entryEffect( spep_6 + 0, 190000,  0x100, -1, 0, 0, 0 ); 
...
--SE
SE1=playSe( spep_5 -10+22, 1021);--ビームを放つ
...
setEffRotateKey( spep_7 + 0, ctzudododo, -34.9 );
setEffRotateKey( spep_7 + 36, ctzudododo, -34.9 );
setEffRotateKey( spep_7 + 38, ctzudododo, -35 );
setEffRotateKey( spep_7 + 108, ctzudododo, -35 );
setEffRotateKey( spep_7 + 110, ctzudododo, -35.1 );
setEffRotateKey( spep_7 + 148, ctzudododo, -35.1 );
setEffRotateKey( spep_7 + 150, ctzudododo, -35 );
setEffRotateKey( spep_7 + 156, ctzudododo, -35 );
setEffRotateKey( spep_7 + 158, ctzudododo, -34.9 );
setEffRotateKey( spep_7 + 160, ctzudododo, -34.9 );
