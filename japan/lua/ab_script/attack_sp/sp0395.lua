...
kame_hand = entryEffect( 70, SP_01, 0x100,      0,  300,  0,  100);   -- 手のカメハメ波部
...
-- 書き文字エントリー
ctgogo = entryEffectLife( 90, 190006, 85, 0x100, -1, 0,00, 500);    -- ゴゴゴゴ
setEffScaleKey(90, ctgogo, 0.7, 0.7);
setEffRotateKey(90, ctgogo, 10);
...
entryFade( 255, 3, 8, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
kamehame_beam = entryEffect( 260, SP_02, 0x100,  0,  300, 100,  0);   -- 伸びるかめはめ波
playSe( 268, SE_07);

--setEffMoveKey( 260,kamehame_beam, 0, 100, 0 );
--setEffMoveKey( 270,kamehame_beam, 0, 100, 0 );
--setEffMoveKey( 290,kamehame_beam, -30, 100, 0 );


setEffMoveKey( 260, kamehame_beam, 200, 50, 0 );
setEffMoveKey( 270, kamehame_beam, 190, 50, 0 );
setEffMoveKey( 290, kamehame_beam, 120, 50, 0 );

setEffScaleKey(260, kamehame_beam, 1.0, 1.0);
setEffScaleKey(280, kamehame_beam, 1.0, 1.0);
...
setEffMoveKey( 300,kamehame_beam, -70, 50, 0 );

setEffMoveKey( 305,kamehame_beam, -570, 50, 0 );


setEffScaleKey(300, kamehame_beam, 0.5, 0.5);

setEffScaleKey(305, kamehame_beam, 0.5, 0.5);
...
hibi = entryEffect( spep_5+3, 1600,  0x100,  -1,  0,30, -130);   -- ひび割れ
