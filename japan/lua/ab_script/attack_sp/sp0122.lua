...
-- 書き文字エントリー
ct = entryEffectLife( 90, 10008, 39, 0x100, -1, 0, -210, 230);    -- ゴゴゴ・・・
...
------------------------------------------------------
-- 極限Z覚醒カードカットイン　(290〜380F)
------------------------------------------------------
spep5=170;

entryFade( spep5-7,4,6,4,fcolor_r, fcolor_g, fcolor_b, 255);
...
setMoveKey(  259,    0,      1000,  0,   0);
--setMoveKey(  270,    0,      0,  0,   0);
--setMoveKey(  290,    0,   -30,  0,   20);

kamehame_beam = entryEffect( 260, SP_02, 0x100,  0,  0,  0,  0);   -- 伸びるかめはめ波
playSe( 260, SE_07);
...
SP_dodge = 401; --エンドフェイズのフレーム数を置き換える
...
setMoveKey(  SP_dodge+5,    0,      3000,  0,   0);
...
-- 書き文字エントリー
ct = entryEffectLife( tyo2+90, 10008, 39, 0x100, -1, 0, -210, 230);    -- ゴゴゴ・・・
