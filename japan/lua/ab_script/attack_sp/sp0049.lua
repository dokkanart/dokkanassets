...
entryFade( 160, 3, 7, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- 書き文字エントリー
ct = entryEffectLife( 90, 10008, 44, 0x100, -1, 0, -210, 300);    -- ゴゴゴ・・・
...
setEffMoveKey(306,kamehame_beam,0,0,0);
setEffMoveKey(307,kamehame_beam,0,-100,0);
setEffMoveKey(378,kamehame_beam,0,-100,0);
...
entryFade( 364, 4, 10, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
kamehame_beam2 = entryEffect( 370, SP_03,   0, -1,  0,  0,  -250);   -- 迫るかめはめ波
