...
kame_hand = entryEffect( 70, SP_01, 0x40+kame_flag,      0,  300,  0,  0);   -- 手のカメハメ波部
...
setMoveKey(  260,    0,   -600,  0,   16);
setMoveKey(  261,    0,   -600,  0,   16);
setMoveKey(  270,    0,   -250,  0,   16);

kamehame_beam = entryEffectLife( 260, SP_02, 109, 0x40+0x100,  0,  300,  0,  0);   -- 伸びるかめはめ波
...
-- 途中からカメハメハが伸びる
setMoveKey(  299,    0,   -250,  0,   16);
setMoveKey(  300,    0,   -250,  0,   16);
...
-- 敵吹っ飛ぶモーション
--[[
changeAnime( 400, 1, 108);
--entryFlash( (400), 2, 222, 94, 250);
changeAnime( 410, 1, 106);
--entryFlashBg( (410), 2, 222, 94, 250);
setMoveKey(  409,    1,   120,  0,   -128);
setMoveKey(  410,    1,   120,  -50,   -100);
changeAnime( 425, 1, 108);
--entryFlash( (425), 1, 0, 0, 0);
setMoveKey(  425,    1,   120,  -50,   -90);
setMoveKey(  426,    1,   110,  40,    -78);
changeAnime( 436, 1, 105);
--entryFlash( (436), 2, 222, 94, 250);
setMoveKey(  435,    1,   120,  40,    -68);
setMoveKey(  436,    1,   110,  -55,   -50);
changeAnime( 444, 1, 106);
--entryFlashBg( (444), 1, 222, 94, 250);
setMoveKey(  443,    1,   120,  -55,   -45);
setMoveKey(  444,    1,   110,  0,    -20);
changeAnime( 455, 1, 108);
--entryFlash( (455), 3, 222, 94, 250);
setMoveKey(  455, 1,  120,    0,   -10);
...
changeAnime( 410, 1, 106);
--entryFlashBg( (410), 2, 222, 94, 250);
--setMoveKey(  409,    1,   120,  0,   -10);
setMoveKey(  410,    1,   120,  -50,   -40);
changeAnime( 425, 1, 108);
--entryFlash( (425), 1, 0, 0, 0);
--setMoveKey(  425,    1,   120,  -50,   -50);
setMoveKey(  426,    1,   110,  40,    -78);
changeAnime( 436, 1, 105);
--entryFlash( (436), 2, 222, 94, 250);
--setMoveKey(  435,    1,   120,  40,    -88);
setMoveKey(  436,    1,   110,  -55,   -100);
changeAnime( 444, 1, 106);
--entryFlashBg( (444), 1, 222, 94, 250);
--setMoveKey(  443,    1,   120,  -55,   -110);
setMoveKey(  444,    1,   110,  0,    -128);
changeAnime( 455, 1, 108);
--entryFlash( (455), 3, 222, 94, 250);
--setMoveKey(  455, 1,  120,    0,   -128);
setMoveKey(  469, 1,  400,    0,   0);

setScaleKey( 455, 1,  2, 2);
setScaleKey( 458, 1,  1.5, 1.5);
setScaleKey( 468, 1,  0.2, 0.2);
setShake(436, 30, 16);
--setEffShake(386, 40,15);
playSe( 386, SE_08);
playSe( 400, SE_09);
playSe( 410, SE_09);
playSe( 425, SE_09);
...
entryFade(444,5, 10, 8, 222, 94, 250, 255);
...
entryFade( SP_ATK_1, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
setScaleKey( SP_ATK_2,   0, 0.6, 0.6);
setScaleKey( SP_ATK_2+1,   0, 0.6, 0.6);
...
-- 途中からカメハメハが伸びる
setMoveKey(  SP_ATK_2+21,    0,   -250,  0,   0);
setMoveKey(  SP_ATK_2+22,    0,   -250,  0,   0);
setMoveKey(  SP_ATK_2+33,    0,   -1100,  0,   0);
setDisp( SP_ATK_2+34, 0, 0);
...
entryEffectLife( SP_ATK_2, 920, 109, 0x80,  -1,  0,  0,  0); -- 流線
...
--entryFlash( (SP_ATK_3+12), 5, 222, 94, 250, 100);
...
--entryFlash( (SP_ATK_3+10), 5,  222, 94, 250, 200);
...
entryFade((SP_ATK_3+30),5, 10, 8, 222, 94, 250, 255);
