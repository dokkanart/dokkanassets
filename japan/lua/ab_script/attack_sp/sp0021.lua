...
setMoveKey(   1,   1,    0, 800,   0);
setMoveKey(   2,   1,    0, 800,   0);
setMoveKey(   3,   1,    0, 800,   0);
setMoveKey(   4,   1,    0, 800,   0);
setMoveKey(   5,   1,    0, 800,   0);
...
entryFade( 162, 2, 6, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
aura = entryEffectLife(  70,   311, 99, 0x40+0x80,  0,  1,  0,  0); -- オーラ
setEffScaleKey( 30, aura, 1.5, 1.5);
...
entryFade( 252, 2, 10, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
setEffAlphaKey( 262, kamehame_beam, 255);
...
SP_dodge = 431; --エンドフェイズのフレーム数を置き換える
